...
HX_LOCAL_STACK_FRAME(_hx_pos_b3b993f62d801895_264___init__,"::ApplicationMain_obj","__init__",0x253d991d,"::ApplicationMain_obj.__init__","ApplicationMain.hx",264,0x0780ded5)
...
void ApplicationMain_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_b3b993f62d801895_264___init__)
HXDLIN( 264)		 ::Dynamic init = hx::ClassOf< ::lime::app::Application >();
            	}


void ApplicationMain_obj::main(){
            	HX_STACKFRAME(&_hx_pos_6fcf922b66429816_21_main)
HXLINE(  23)		::String projectName = HX_("VSCodeTest",7c,4c,47,58);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			...
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(22)
            				...
            				->setFixed(3,HX_("width",06,b6,62,ca),(int)640)
            				->setFixed(4,HX_("fullscreen",3b,3a,b4,f9),false)
            				->setFixed(5,HX_("colorDepth",a0,08,96,fb),(int)16)
            				->setFixed(6,HX_("maximized",18,0e,e1,fe),false)
            				->setFixed(7,HX_("x",78,00,00,00),null())
            				->setFixed(8,HX_("y",79,00,00,00),null())
            				->setFixed(9,HX_("height",e7,07,4c,02),(int)480)
            				->setFixed(10,HX_("title",98,15,3b,10),HX_("VSCodeTest",7c,4c,47,58))
            				...
            				->setFixed(20,HX_("depthBuffer",63,46,9e,52),false)
            			...
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("VSCodeTest",7c,4c,47,58))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("VSCodeTest",7c,4c,47,58))
...
HXLINE(  97)		 ::openfl::display::Preloader preloader =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::flixel::_hx_system::FlxPreloader_obj::__alloc( HX_CTX ,null(),null()));
