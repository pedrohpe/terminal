...
HX_DEFINE_STACK_FRAME(_hx_pos_7796e60414ea5cbd_345_new,"__ASSET__flixel_images_logo_default_png","new",0xe2ac399d,"__ASSET__flixel_images_logo_default_png.new","lime/_macros/AssetsMacro.hx",345,0xfe246b98)
...
void __ASSET__flixel_images_logo_default_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_7796e60414ea5cbd_345_new)
HXLINE( 382)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 387)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_logo_default_png_obj::resourceName),null());
            	}
