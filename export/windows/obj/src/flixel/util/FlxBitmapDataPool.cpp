...
HXDLIN(  79)			res =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,transparent,res1);
            		}
...
HXLINE( 125)			 ::openfl::display::BitmapData bmd = node->bmd;
...
HXLINE( 141)				 ::openfl::display::BitmapData bmd = node->bmd;
