...
HXLINE(  88)			_hx_tmp11 = (sourceRect->height <= (int)0);
            		}
            		else {
...
HXLINE( 184)				 ::openfl::display::BitmapData result =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0);
...
HXDLIN( 242)		return ((bitmapData->width * bitmapData->height) * (int)4);
            	}
...
HXLINE( 277)		columns = ::Std_obj::_hx_int(::Math_obj::max(columns,bitmapData->width));
HXLINE( 278)		rows = ::Std_obj::_hx_int(::Math_obj::max(rows,bitmapData->height));
...
HXLINE( 362)		 ::openfl::display::BitmapData result3 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,result1,::Std_obj::_hx_int((result2 + (((int)2 * numVerticalFrames) * borderY))),true,(int)0);
HXLINE( 368)		result3->lock();
HXLINE( 369)		 ::openfl::geom::Rectangle tempRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,frameWidth,frameHeight);
...
HXLINE( 411)		 ::openfl::geom::Rectangle tempRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)1,bitmapData->height);
...
HXLINE( 482)		 ::openfl::display::BitmapData result =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0);
