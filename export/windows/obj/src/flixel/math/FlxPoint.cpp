...
HXLINE( 238)		 ::openfl::geom::Point FlashPoint1 = FlashPoint;
HXDLIN( 238)		FlashPoint1->x = (FlashPoint1->x + this->x);
HXLINE( 239)		 ::openfl::geom::Point FlashPoint2 = FlashPoint;
...
HXLINE( 252)		 ::openfl::geom::Point FlashPoint1 = FlashPoint;
HXDLIN( 252)		FlashPoint1->x = (FlashPoint1->x - this->x);
HXLINE( 253)		 ::openfl::geom::Point FlashPoint2 = FlashPoint;
