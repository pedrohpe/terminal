...
HXLINE( 105)			this->_bgSprite->get_pixels()->setPixel32((int)0,(int)0,Value);
            		}
...
static hx::StorageInfo FlxSubState_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(FlxSubState_obj,openCallback),HX_HCSTRING("openCallback","\xaf","\x33","\x24","\xbd")},
...
static ::String FlxSubState_obj_sMemberFields[] = {
	HX_HCSTRING("openCallback","\xaf","\x33","\x24","\xbd"),
