...
HXLINE( 190)		 ::openfl::display::BitmapData data = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(Graphic);
...
HXLINE( 226)		int insertWidth = (data->width + this->border);
HXLINE( 227)		int insertHeight = (data->height + this->border);
HXLINE( 229)		bool rotateNode = false;
HXLINE( 230)		 ::flixel::graphics::atlas::FlxNode nodeToInsert = this->findNodeToInsert(insertWidth,insertHeight);
HXLINE( 232)		if (this->allowRotation) {
HXLINE( 234)			 ::flixel::graphics::atlas::FlxNode nodeToInsertWithRotation = this->findNodeToInsert(insertHeight,insertWidth);
...
HXLINE( 244)					int temp = insertWidth;
...
HXLINE( 253)			bool horizontally = this->needToDivideHorizontally(nodeToInsert,insertWidth,insertHeight);
...
HXLINE( 335)					 ::openfl::geom::Matrix _hx_tmp1 = ::flixel::graphics::atlas::FlxAtlas_obj::matrix;
HXDLIN( 335)					_hx_tmp1->rotate(((Float)::Math_obj::PI / (Float)(int)2));
HXLINE( 336)					 ::openfl::geom::Matrix _hx_tmp2 = ::flixel::graphics::atlas::FlxAtlas_obj::matrix;
HXDLIN( 336)					int firstGrandChildData1 = firstGrandChildData->height;
HXDLIN( 336)					int _hx_tmp3 = (firstGrandChildData1 + ::Std_obj::_hx_int(firstGrandChild->rect->x));
HXDLIN( 336)					_hx_tmp2->translate(_hx_tmp3,::Std_obj::_hx_int(firstGrandChild->rect->y));
HXLINE( 337)					this->bitmapData->draw(firstGrandChildData,::flixel::graphics::atlas::FlxAtlas_obj::matrix,null(),null(),null(),null());
            				}
            				else {
HXLINE( 341)					 ::openfl::geom::Point _hx_tmp4 = ::flixel::graphics::atlas::FlxAtlas_obj::point;
HXDLIN( 341)					int _hx_tmp5 = ::Std_obj::_hx_int(firstGrandChild->rect->x);
HXDLIN( 341)					_hx_tmp4->setTo(_hx_tmp5,::Std_obj::_hx_int(firstGrandChild->rect->y));
...
HXLINE( 359)			int insertWidth = (data->width + this->border);
HXLINE( 360)			int insertHeight = (data->height + this->border);
HXLINE( 362)			int rootWidth = insertWidth;
HXLINE( 363)			int rootHeight = insertHeight;
...
HXLINE( 383)				::String _hx_tmp2 = ((((((((((((HX_("Can't insert node ",5a,c7,4d,53) + key) + HX_(" with the size of (",b5,20,c2,55)) + data->width) + HX_("; ",85,33,00,00)) + data->height) + HX_(") in atlas ",99,70,14,d3)) + this->name) + HX_(" with the max size of (",b9,b3,66,74)) + this->maxWidth) + HX_("; ",85,33,00,00)) + this->maxHeight) + HX_(") and powerOfTwo: ",d6,69,4d,94));
HXDLIN( 383)				HX_STACK_DO_THROW((_hx_tmp2 + ::Std_obj::string(this->powerOfTwo)));
            			}
HXLINE( 390)			this->root->set_width(rootWidth);
HXLINE( 391)			this->root->set_height(rootHeight);
HXLINE( 393)			bool horizontally = this->needToDivideHorizontally(this->root,insertWidth,insertHeight);
...
HXLINE( 404)			int insertWidth = (data->width + this->border);
HXLINE( 405)			int insertHeight = (data->height + this->border);
HXLINE( 408)			int addRightWidth = (::Std_obj::_hx_int(this->root->rect->width) + insertWidth);
HXLINE( 409)			int addRightHeight = ::Std_obj::_hx_int(::Math_obj::max(::Std_obj::_hx_int(this->root->rect->height),insertHeight));
HXLINE( 411)			int addBottomWidth = ::Std_obj::_hx_int(::Math_obj::max(::Std_obj::_hx_int(this->root->rect->width),insertWidth));
HXLINE( 412)			int addBottomHeight = (::Std_obj::_hx_int(this->root->rect->height) + insertHeight);
...
HXLINE( 422)				addRightWidthRotate = (::Std_obj::_hx_int(this->root->rect->width) + insertHeight);
HXLINE( 423)				addRightHeightRotate = ::Std_obj::_hx_int(::Math_obj::max(::Std_obj::_hx_int(this->root->rect->height),insertWidth));
HXLINE( 425)				addBottomWidthRotate = ::Std_obj::_hx_int(::Math_obj::max(::Std_obj::_hx_int(this->root->rect->width),insertHeight));
HXLINE( 426)				addBottomHeightRotate = (::Std_obj::_hx_int(this->root->rect->height) + insertWidth);
            			}
...
HXLINE( 467)				::String _hx_tmp11 = ((((((((((((HX_("Can't insert node ",5a,c7,4d,53) + key) + HX_(" with the size of (",b5,20,c2,55)) + data->width) + HX_("; ",85,33,00,00)) + data->height) + HX_(") in atlas ",99,70,14,d3)) + this->name) + HX_(" with the max size of (",b9,b3,66,74)) + this->maxWidth) + HX_("; ",85,33,00,00)) + this->maxHeight) + HX_(") and powerOfTwo: ",d6,69,4d,94));
HXDLIN( 467)				HX_STACK_DO_THROW((_hx_tmp11 + ::Std_obj::string(this->powerOfTwo)));
            			}
...
HXLINE( 486)				_hx_tmp13 = (addRightArea > addRightAreaRotate);
            			}
            			else {
...
HXLINE( 486)					_hx_tmp12 = canExpandRightRotate;
            				}
            				else {
...
HXLINE( 496)				_hx_tmp16 = (addBottomArea > addBottomAreaRotate);
            			}
            			else {
...
HXLINE( 496)					_hx_tmp15 = canExpandBottomRotate;
            				}
            				else {
...
HXLINE( 506)				_hx_tmp18 = canExpandBottom;
            			}
            			else {
...
HXLINE( 511)				bool _hx_tmp19;
HXDLIN( 511)				if (canExpandRight) {
HXLINE( 511)					_hx_tmp19 = !(canExpandBottom);
            				}
            				else {
HXLINE( 511)					_hx_tmp19 = false;
            				}
HXDLIN( 511)				if (_hx_tmp19) {
...
HXLINE( 519)			int insertNodeWidth = insertWidth;
HXLINE( 520)			int insertNodeHeight = insertHeight;
...
HXLINE( 531)				int _hx_tmp20 = (::Std_obj::_hx_int(temp->rect->width) + insertNodeWidth);
HXDLIN( 531)				this->expandRoot(_hx_tmp20,::Math_obj::max(::Std_obj::_hx_int(temp->rect->height),insertNodeHeight),true,null());
...
HXLINE( 543)				Float _hx_tmp21 = ::Math_obj::max(::Std_obj::_hx_int(temp->rect->width),insertNodeWidth);
HXDLIN( 543)				this->expandRoot(_hx_tmp21,(::Std_obj::_hx_int(temp->rect->height) + insertNodeHeight),false,null());
...
HXLINE( 571)			int _hx_tmp2 = this->bitmapData->width;
...
HXLINE( 571)			int _hx_tmp3 = this->bitmapData->height;
...
HXDLIN( 576)		 ::openfl::display::BitmapData newBitmapData1 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,newBitmapData,::Std_obj::_hx_int(this->root->rect->height),true,(int)0);
HXLINE( 577)		if (hx::IsNotNull( this->bitmapData )) {
HXLINE( 579)			::flixel::graphics::atlas::FlxAtlas_obj::point->setTo((int)0,(int)0);
HXLINE( 580)			newBitmapData1->copyPixels(this->bitmapData,this->bitmapData->rect,::flixel::graphics::atlas::FlxAtlas_obj::point,null(),null(),null());
            		}
...
HXLINE( 630)		 ::openfl::display::BitmapData data = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(Graphic);
...
HXLINE( 641)		 ::openfl::display::BitmapData nodeData = ::flixel::util::FlxBitmapDataUtil_obj::addSpacesAndBorders(data,tileSize,tileSpacing,tileBorder,region);
...
HXLINE( 771)			int area1 = (( ( ::openfl::display::BitmapData)(obj1->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->width * ( ( ::openfl::display::BitmapData)(obj1->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->height);
HXLINE( 772)			int area2 = (( ( ::openfl::display::BitmapData)(obj2->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->width * ( ( ::openfl::display::BitmapData)(obj2->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->height);
HXLINE( 773)			return (area2 - area1);
            		}
