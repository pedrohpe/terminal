...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_409_dump,"flixel.graphics.FlxGraphic","dump",0xe78dc2db,"flixel.graphics.FlxGraphic.dump","flixel/graphics/FlxGraphic.hx",409,0xb3633517)
...
HXLINE( 400)		this->shader =  ::flixel::graphics::tile::FlxGraphicsShader_obj::__alloc( HX_CTX );
            	}
...
HXLINE( 424)		 ::openfl::display::BitmapData newBitmap = this->getBitmapFromSystem();
...
HXLINE( 568)		 ::openfl::display::BitmapData newBitmap = null();
HXLINE( 569)		if (hx::IsNotNull( this->assetsClass )) {
HXLINE( 570)			newBitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
            		}
            		else {
HXLINE( 571)			if (hx::IsNotNull( this->assetsKey )) {
HXLINE( 572)				::String id = this->assetsKey;
HXDLIN( 572)				if (::openfl::utils::Assets_obj::exists(id,null())) {
HXLINE( 572)					newBitmap = ::openfl::utils::Assets_obj::getBitmapData(id,false);
            				}
            				else {
HXLINE( 572)					::flixel::FlxG_obj::log->advanced(((HX_("Could not find a BitmapData asset with ID '",5f,79,a9,21) + id) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
...
HXLINE( 614)			Float Width = this->bitmap->width;
HXDLIN( 614)			Float Height = this->bitmap->height;
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_atlasFrames,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::display::BitmapData value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_625_set_bitmap)
HXLINE( 626)		if (hx::IsNotNull( value )) {
HXLINE( 628)			this->bitmap = value;
HXLINE( 629)			this->width = this->bitmap->width;
HXLINE( 630)			this->height = this->bitmap->height;
            		}
...
HXLINE(  43)		 ::openfl::display::BitmapData bitmap = null();
HXLINE(  45)		if (!(Cache)) {
HXLINE(  47)			 ::openfl::display::BitmapData bitmap1;
HXDLIN(  47)			if (::openfl::utils::Assets_obj::exists(Source,null())) {
HXLINE(  47)				bitmap1 = ::openfl::utils::Assets_obj::getBitmapData(Source,false);
            			}
            			else {
HXLINE(  47)				::flixel::FlxG_obj::log->advanced(((HX_("Could not find a BitmapData asset with ID '",5f,79,a9,21) + Source) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
...
HXDLIN(  58)		if (::openfl::utils::Assets_obj::exists(Source,null())) {
HXLINE(  58)			bitmap2 = ::openfl::utils::Assets_obj::getBitmapData(Source,false);
            		}
            		else {
...
HXLINE(  80)		 ::openfl::display::BitmapData bitmap = null();
HXLINE(  81)		if (!(Cache)) {
...
HXLINE(  93)		bitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(Source,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
...
HXLINE( 160)		 ::openfl::display::BitmapData bitmap = Source->paint(null(),null(),null(),null());
...
HXLINE( 225)		 ::openfl::display::BitmapData bitmap =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,Width,Height,true,Color);
