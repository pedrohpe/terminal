...
HXLINE( 427)		 ::openfl::display::BitmapData combined =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width1,height1,true,(int)0);
...
HXLINE( 430)		 ::openfl::geom::Point destPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,borderX,borderY);
...
HXLINE( 447)						 ::openfl::geom::Point destPoint1 = destPoint;
HXDLIN( 447)						destPoint1->x = (destPoint1->x + ((tileWidth + ((int)2 * borderX)) + spaceX));
HXLINE( 449)						if ((destPoint->x >= combined->width)) {
HXLINE( 451)							destPoint->x = borderX;
HXLINE( 452)							 ::openfl::geom::Point destPoint2 = destPoint;
HXDLIN( 452)							destPoint2->y = (destPoint2->y + ((tileHeight + ((int)2 * borderY)) + spaceY));
            						}
            					}
            				}
            			}
