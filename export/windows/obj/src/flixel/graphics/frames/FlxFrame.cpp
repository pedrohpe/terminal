...
HXLINE( 299)		 ::openfl::display::BitmapData bmd1 = bmd;
...
HXLINE( 299)				bmd1 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,(int)0);
            			}
            		}
HXDLIN( 299)		bmd = bmd1;
...
HXDLIN( 306)				 ::openfl::geom::Point FlashPoint = this->point2;
HXDLIN( 306)				if (hx::IsNull( FlashPoint )) {
HXLINE( 306)					FlashPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            				}
HXDLIN( 306)				FlashPoint->x = _this->x;
HXDLIN( 306)				FlashPoint->y = _this->y;
            			}
HXLINE( 307)			 ::openfl::geom::Point _hx_tmp = this->point2;
HXDLIN( 307)			_hx_tmp->x = (_hx_tmp->x + point->x);
HXLINE( 308)			 ::openfl::geom::Point _hx_tmp1 = this->point2;
HXDLIN( 308)			_hx_tmp1->y = (_hx_tmp1->y + point->y);
HXLINE( 309)			 ::openfl::display::BitmapData _hx_tmp2 = this->parent->bitmap;
HXDLIN( 309)			 ::flixel::math::FlxRect _this1 = this->frame;
HXDLIN( 309)			 ::openfl::geom::Rectangle FlashRect = this->rect;
HXDLIN( 309)			if (hx::IsNull( FlashRect )) {
HXLINE( 309)				FlashRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            			}
...
HXDLIN( 315)			{
HXLINE( 315)				 ::openfl::geom::Rectangle FlashRect1 = this->rect;
HXDLIN( 315)				if (hx::IsNull( FlashRect1 )) {
HXLINE( 315)					FlashRect1 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
...
HXDLIN( 315)			 ::openfl::geom::Rectangle rect1 = this->rect;
...
HXLINE( 350)		 ::openfl::display::BitmapData bmd1 = bmd;
...
HXLINE( 350)				bmd1 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,(int)0);
            			}
            		}
HXDLIN( 350)		bmd = bmd1;
...
HXDLIN( 360)		{
HXLINE( 360)			 ::openfl::geom::Rectangle FlashRect = this->rect;
...
HXDLIN( 360)		 ::openfl::geom::Rectangle rect1 = this->rect;
...
HXLINE( 402)				bmd =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,(int)0);
            			}
            		}
...
HXLINE( 424)		{
HXLINE( 424)			 ::openfl::geom::Rectangle FlashRect = this->rect;
HXDLIN( 424)			if (hx::IsNull( FlashRect )) {
HXLINE( 424)				FlashRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            			}
...
HXLINE( 504)				{
HXLINE( 504)					 ::openfl::geom::Matrix matrix = this->matrix;
...
HXLINE( 505)				{
HXLINE( 505)					 ::openfl::geom::Matrix matrix1 = this->matrix;
...
HXLINE( 606)				{
HXLINE( 606)					 ::openfl::geom::Matrix matrix = this->matrix;
...
HXLINE( 607)				{
HXLINE( 607)					 ::openfl::geom::Matrix matrix1 = this->matrix;
