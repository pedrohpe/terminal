...
HXLINE(  26)		this->justPressedTimeInTicks = (int)-1;
...
static hx::StorageInfo FlxMouseButton_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(FlxMouseButton_obj,justPressedTimeInTicks),HX_HCSTRING("justPressedTimeInTicks","\x8e","\xf9","\xc2","\x82")},
	{ hx::fsUnknown, 0, null()}
};
