...
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_69_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",69,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_70_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",70,0x2ce48920)
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_72_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",72,0x2ce48920)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ad6715070e6121e4_75_boot,"flixel.input.gamepad.id.PS4ID","boot",0xf48071a4,"flixel.input.gamepad.id.PS4ID.boot","flixel/input/gamepad/id/PS4ID.hx",75,0x2ce48920)
namespace flixel{
namespace input{
namespace gamepad{
namespace id{
...
HXDLIN(  64)		TOUCHPAD_CLICK = (int)21;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ad6715070e6121e4_66_boot)
HXDLIN(  66)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  67)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
