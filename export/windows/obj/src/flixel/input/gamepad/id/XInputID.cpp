...
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_54_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",54,0x9958eee3)
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_55_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",55,0x9958eee3)
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_56_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",56,0x9958eee3)
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_57_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",57,0x9958eee3)
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_59_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",59,0x9958eee3)
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_60_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",60,0x9958eee3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_69_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",69,0x9958eee3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_72_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",72,0x9958eee3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_75_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",75,0x9958eee3)
...
HXDLIN(  69)		DPAD_UP = (int)17;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_70_boot)
HXDLIN(  70)		DPAD_DOWN = (int)18;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_71_boot)
HXDLIN(  71)		DPAD_LEFT = (int)19;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_72_boot)
HXDLIN(  72)		DPAD_RIGHT = (int)20;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_559677d855d318da_74_boot)
HXDLIN(  74)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  75)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  77)		LEFT_TRIGGER = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_78_boot)
HXDLIN(  78)		RIGHT_TRIGGER = (int)5;
            	}
}
