...
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_326_onDeviceAdded,"flixel.input.gamepad.FlxGamepadManager","onDeviceAdded",0x0a66e6f8,"flixel.input.gamepad.FlxGamepadManager.onDeviceAdded","flixel/input/gamepad/FlxGamepadManager.hx",326,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_331_onDeviceRemoved,"flixel.input.gamepad.FlxGamepadManager","onDeviceRemoved",0xfdb62fd8,"flixel.input.gamepad.FlxGamepadManager.onDeviceRemoved","flixel/input/gamepad/FlxGamepadManager.hx",331,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_335_findGamepadIndex,"flixel.input.gamepad.FlxGamepadManager","findGamepadIndex",0xba70451d,"flixel.input.gamepad.FlxGamepadManager.findGamepadIndex","flixel/input/gamepad/FlxGamepadManager.hx",335,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_347_addGamepad,"flixel.input.gamepad.FlxGamepadManager","addGamepad",0xa73480d3,"flixel.input.gamepad.FlxGamepadManager.addGamepad","flixel/input/gamepad/FlxGamepadManager.hx",347,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_361_getModelFromDeviceName,"flixel.input.gamepad.FlxGamepadManager","getModelFromDeviceName",0x16d9cf71,"flixel.input.gamepad.FlxGamepadManager.getModelFromDeviceName","flixel/input/gamepad/FlxGamepadManager.hx",361,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_390_removeGamepad,"flixel.input.gamepad.FlxGamepadManager","removeGamepad",0xfe38fe4a,"flixel.input.gamepad.FlxGamepadManager.removeGamepad","flixel/input/gamepad/FlxGamepadManager.hx",390,0xccfee0a6)
...
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_53_boot,"flixel.input.gamepad.FlxGamepadManager","boot",0x70552845,"flixel.input.gamepad.FlxGamepadManager.boot","flixel/input/gamepad/FlxGamepadManager.hx",53,0xccfee0a6)
namespace flixel{
namespace input{
namespace gamepad{
...
HXDLIN( 318)			int _g = ::openfl::ui::GameInput_obj::numDevices;
HXDLIN( 318)			while((_g1 < _g)){
HXLINE( 318)				_g1 = (_g1 + (int)1);
HXDLIN( 318)				int i = (_g1 - (int)1);
HXLINE( 319)				this->addGamepad(::openfl::ui::GameInput_obj::getDeviceAt(i));
            			}
            		}
            	}
...
HXDLIN( 326)		this->addGamepad(Event->device);
            	}
...
HXDLIN( 331)		this->removeGamepad(Event->device);
            	}
...
HXDLIN( 339)			int _g = ::openfl::ui::GameInput_obj::numDevices;
...
HXLINE( 352)		int id = this->findGamepadIndex(Device);
HXLINE( 353)		if ((id < (int)0)) {
HXLINE( 354)			return;
            		}
HXLINE( 356)		 ::flixel::input::gamepad::FlxGamepad gamepad = this->createByID(id,this->getModelFromDeviceName(Device->name));
HXLINE( 357)		gamepad->_device = Device;
            	}
...
HXLINE( 378)				return ::flixel::input::gamepad::FlxGamepadModel_obj::PS4_dyn();
            			}
            			else {
HXLINE( 379)				if ((name.indexOf(HX_("logitech",3b,70,e5,19),null()) != (int)-1)) {
HXLINE( 379)					return ::flixel::input::gamepad::FlxGamepadModel_obj::LOGITECH_dyn();
            				}
            				else {
...
HXLINE( 380)						return ::flixel::input::gamepad::FlxGamepadModel_obj::XINPUT_dyn();
            					}
            					else {
HXLINE( 381)						if ((name.indexOf(HX_("xinput",92,10,f1,b8),null()) != (int)-1)) {
HXLINE( 381)							return ::flixel::input::gamepad::FlxGamepadModel_obj::XINPUT_dyn();
            						}
            						else {
HXLINE( 382)							if ((name.indexOf(HX_("nintendo rvlcnt01tr",cb,02,13,80),null()) != (int)-1)) {
HXLINE( 382)								return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            							}
            							else {
HXLINE( 383)								if ((name.indexOf(HX_("nintendo rvlcnt01",0d,c0,58,28),null()) != (int)-1)) {
HXLINE( 383)									return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            								}
            								else {
HXLINE( 384)									if ((name.indexOf(HX_("mayflash wiimote pc adapter",ed,5a,02,8e),null()) != (int)-1)) {
HXLINE( 384)										return ::flixel::input::gamepad::FlxGamepadModel_obj::MAYFLASH_WII_REMOTE_dyn();
            									}
            									else {
HXLINE( 385)										if ((name.indexOf(HX_("mfi",f0,0e,53,00),null()) != (int)-1)) {
HXLINE( 385)											return ::flixel::input::gamepad::FlxGamepadModel_obj::MFI_dyn();
            										}
            										else {
HXLINE( 386)											return ::flixel::input::gamepad::FlxGamepadModel_obj::UNKNOWN_dyn();
            										}
            									}
            								}
            							}
...
HXLINE( 394)		{
HXLINE( 394)			int _g1 = (int)0;
HXDLIN( 394)			int _g = this->_gamepads->length;
HXDLIN( 394)			while((_g1 < _g)){
HXLINE( 394)				_g1 = (_g1 + (int)1);
HXDLIN( 394)				int i = (_g1 - (int)1);
HXLINE( 396)				 ::flixel::input::gamepad::FlxGamepad gamepad = this->_gamepads->__get(i).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
...
HXDLIN(  53)		_gameInput =  ::openfl::ui::GameInput_obj::__alloc( HX_CTX );
            	}
}
