...
HXLINE(  53)		if (xVal) {
HXLINE(  55)			bool yReleased = this->gamepad->checkStatusRaw(stick->y,(int)0);
HXLINE(  56)			bool yJustReleased = this->gamepad->checkStatusRaw(stick->y,(int)-1);
...
HXLINE(  63)		if (yVal) {
HXLINE(  65)			bool xReleased = this->gamepad->checkStatusRaw(stick->x,(int)0);
HXLINE(  66)			bool xJustReleased = this->gamepad->checkStatusRaw(stick->x,(int)-1);
