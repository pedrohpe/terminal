...
HXDLIN(  58)		switch((int)(ID)){
            			case (int)0: {
HXLINE(  60)				return (int)6;
            			}
            			break;
            			case (int)1: {
HXLINE(  61)				return (int)7;
            			}
            			break;
            			case (int)2: {
HXLINE(  62)				return (int)8;
            			}
            			break;
            			case (int)3: {
HXLINE(  63)				return (int)9;
            			}
            			break;
            			case (int)4: {
HXLINE(  69)				return (int)15;
            			}
            			break;
            			case (int)5: {
