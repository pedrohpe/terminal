...
HXDLIN( 350)					emptyBar->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)1,(int)1,_hx_tmp,(this->barHeight - (int)2)),empty);
            				}
            				else {
...
HXLINE( 367)				 ::openfl::display::BitmapData _hx_tmp1 = this->_emptyBar;
HXDLIN( 367)				int _hx_tmp2 = (this->barWidth - (int)2);
HXDLIN( 367)				_hx_tmp1->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)1,(int)1,_hx_tmp2,(this->barHeight - (int)2)),empty);
            			}
            			else {
...
HXDLIN( 403)					filledBar->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)1,(int)1,_hx_tmp,(this->barHeight - (int)2)),fill);
            				}
            				else {
...
HXLINE( 420)				 ::openfl::display::BitmapData _hx_tmp1 = this->_filledBar;
HXDLIN( 420)				int _hx_tmp2 = (this->barWidth - (int)2);
HXDLIN( 420)				_hx_tmp1->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)1,(int)1,_hx_tmp2,(this->barHeight - (int)2)),fill);
            			}
            			else {
...
HXLINE( 502)				 ::openfl::display::BitmapData _hx_tmp1 = this->_emptyBar;
...
HXLINE( 566)				 ::openfl::display::BitmapData _hx_tmp1 = this->_filledBar;
