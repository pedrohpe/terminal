...
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_670_set_mouse,"flixel.FlxG","set_mouse",0x1e754261,"flixel.FlxG.set_mouse","flixel/FlxG.hx",670,0x8e176836)
...
HXDLIN( 329)		::openfl::Lib_obj::get_application()->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >()->resize(Width,Height);
            	}
...
HXLINE( 608)		if (!(( (bool)( ::Dynamic(::openfl::Lib_obj::get_application()->config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic))->__GetItem((int)0)->__Field(HX_("hardware",a8,e2,d3,75),hx::paccDynamic)) ))) {
HXLINE( 610)			::flixel::FlxG_obj::renderMethod = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
            		}
            		else {
HXLINE( 614)			 ::lime::graphics::RendererType _g = ::openfl::Lib_obj::get_current()->stage->window->renderer->type;
HXDLIN( 614)			 ::flixel::FlxRenderMethod _hx_tmp;
HXDLIN( 614)			switch((int)(_hx_getEnumValueIndex(_g))){
            				case (int)1: case (int)3: case (int)4: {
HXLINE( 614)					_hx_tmp = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
            				}
            				break;
            				case (int)0: case (int)5: {
HXLINE( 614)					_hx_tmp = ::flixel::FlxRenderMethod_obj::DRAW_TILES_dyn();
            				}
            				break;
            				default:{
HXLINE( 614)					_hx_tmp = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
...
HXDLIN( 614)			::flixel::FlxG_obj::renderMethod = _hx_tmp;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,set_scaleMode,return )
 ...
 ::flixel::input::mouse::FlxMouse FlxG_obj::set_mouse( ::flixel::input::mouse::FlxMouse NewMouse){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_670_set_mouse)
HXLINE( 671)		if (hx::IsNull( ::flixel::FlxG_obj::mouse )) {
HXLINE( 673)			::flixel::FlxG_obj::mouse = ::flixel::FlxG_obj::inputs->add_flixel_input_mouse_FlxMouse(NewMouse);
HXLINE( 674)			return ::flixel::FlxG_obj::mouse;
            		}
HXLINE( 676)		 ::flixel::input::mouse::FlxMouse oldMouse = ::flixel::FlxG_obj::mouse;
HXLINE( 677)		 ::flixel::input::mouse::FlxMouse result = ::flixel::FlxG_obj::inputs->replace_flixel_input_mouse_FlxMouse(oldMouse,NewMouse);
HXLINE( 678)		if (hx::IsNotNull( result )) {
HXLINE( 680)			::flixel::FlxG_obj::mouse = result;
HXLINE( 681)			oldMouse->destroy();
HXLINE( 682)			return NewMouse;
            		}
HXLINE( 684)		return oldMouse;
            	}
...
HXLINE( 691)			::flixel::FlxG_obj::log->advanced((HX_("FlxG.framerate: the game's framerate shouldn't be smaller than the flash framerate,",78,cb,ed,38) + HX_(" since it can stop your game from updating.",d2,3f,a2,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
...
HXLINE( 708)			::flixel::FlxG_obj::log->advanced((HX_("FlxG.drawFramerate: the update framerate shouldn't be smaller than the draw framerate,",b9,9c,3b,de) + HX_(" since it can stop your game from updating.",d2,3f,a2,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
HXLINE( 711)		::flixel::FlxG_obj::drawFramerate = ::Std_obj::_hx_int(::Math_obj::abs(Framerate));
HXLINE( 713)		if (hx::IsNotNull( ::flixel::FlxG_obj::game->stage )) {
HXLINE( 714)			::flixel::FlxG_obj::game->stage->set_frameRate(::flixel::FlxG_obj::drawFramerate);
            		}
...
HXDLIN( 726)		if (hx::IsNotEq( ::openfl::Lib_obj::get_current()->stage->get_displayState(),(int)0 )) {
HXLINE( 727)			return hx::IsEq( ::openfl::Lib_obj::get_current()->stage->get_displayState(),(int)1 );
            		}
            		else {
...
HXLINE( 732)		 ::Dynamic _hx_tmp;
HXDLIN( 732)		if (Value) {
HXLINE( 732)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 732)			_hx_tmp = (int)2;
            		}
HXDLIN( 732)		::openfl::Lib_obj::get_current()->stage->set_displayState(_hx_tmp);
...
HXDLIN( 738)		return ::openfl::Lib_obj::get_current()->stage;
            	}
