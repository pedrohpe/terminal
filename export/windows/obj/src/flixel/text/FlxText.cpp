...
HXLINE( 521)			 ::Dynamic _hx_tmp;
HXDLIN( 521)			if (value) {
HXLINE( 521)				_hx_tmp = (int)1;
            			}
            			else {
HXLINE( 521)				_hx_tmp = (int)2;
            			}
...
HXDLIN( 530)			return hx::IsNotEq( this->textField->get_autoSize(),(int)2 );
            		}
            		else {
...
HXLINE( 581)			if (::openfl::utils::Assets_obj::exists(Font,HX_("FONT",cf,25,81,2e))) {
HXLINE( 583)				newFontName = ::openfl::utils::Assets_obj::getFont(Font,null())->name;
            			}
...
HXLINE( 728)			this->colorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		}
