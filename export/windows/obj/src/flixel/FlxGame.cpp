...
HXLINE( 323)		int _hx_tmp1 = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN( 323)		this->debugger =  ::flixel::_hx_system::debug::FlxDebugger_obj::__alloc( HX_CTX ,_hx_tmp1,::openfl::Lib_obj::get_current()->stage->stageHeight);
...
HXLINE( 366)		int _hx_tmp3 = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN( 366)		this->resizeGame(_hx_tmp3,::openfl::Lib_obj::get_current()->stage->stageHeight);
...
HXLINE( 633)		this->debugger->console->registerObject(HX_("state",11,76,0b,84),this->_state);
            	}
...
HXLINE( 861)			this->debugger->stats->drawCalls(::flixel::graphics::tile::FlxDrawBaseItem_obj::drawCalls);
            		}
HXLINE( 865)		{
...
HXDLIN( 882)		return ::openfl::Lib_obj::getTimer();
            	}
