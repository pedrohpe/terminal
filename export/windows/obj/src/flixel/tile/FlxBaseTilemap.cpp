...
HXLINE( 177)		if (::openfl::utils::Assets_obj::exists(MapData,null())) {
HXLINE( 179)			MapData = ::openfl::utils::Assets_obj::getText(MapData);
            		}
...
HXLINE( 322)		 ::openfl::display::BitmapData mapBitmap = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(MapGraphic);
