...
HX_DEFINE_STACK_FRAME(_hx_pos_b78de1af414df357_51_new,"flixel.tile.GraphicAutoAlt","new",0x4e2c2272,"flixel.tile.GraphicAutoAlt.new","openfl/_internal/macros/AssetsMacro.hx",51,0xf7db08ab)
...
void GraphicAutoAlt_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_b78de1af414df357_51_new)
HXLINE(  83)		super::__construct((int)0,(int)0,transparent,fillRGBA);
HXLINE(  88)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAutoAlt_obj::resourceName));
HXLINE(  89)		{
