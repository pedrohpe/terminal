...
HXLINE( 109)		this->_flashRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 105)		this->_flashPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE(  92)		this->blend = null();
HXLINE(  87)		this->colorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 154)			this->_helperPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 323)			if ((tileBitmap->width == this->_tileWidth)) {
HXLINE( 323)				_hx_tmp1 = (tileBitmap->height != this->_tileHeight);
            			}
            			else {
...
HXLINE( 330)			tileBitmap->fillRect(tileBitmap->rect,(int)0);
...
HXLINE( 353)			this->_debugRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,this->_tileWidth,this->_tileHeight);
            		}
...
HXLINE( 419)							 ::openfl::display::Graphics _hx_tmp7 = Camera->debugLayer->get_graphics();
...
HXDLIN( 488)						 ::openfl::geom::Point FlashPoint = this->_flashPoint;
HXDLIN( 488)						if (hx::IsNull( FlashPoint )) {
HXLINE( 488)							FlashPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            						}
...
HXLINE( 894)		 ::flixel::graphics::tile::FlxDrawQuadsItem drawItem = null();
...
HXDLIN( 902)				 ::openfl::geom::Point FlashPoint = this->_helperPoint;
HXDLIN( 902)				if (hx::IsNull( FlashPoint )) {
HXLINE( 902)					FlashPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            				}
...
HXLINE( 934)		 ::openfl::display::BitmapData debugTile;
HXLINE( 937)		{
...
HXDLIN( 970)										 ::openfl::geom::Point FlashPoint1 = this->_flashPoint;
HXDLIN( 970)										 ::openfl::geom::Point FlashPoint2 = FlashPoint1;
HXDLIN( 970)										FlashPoint2->x = (FlashPoint2->x + _this1->x);
HXDLIN( 970)										 ::openfl::geom::Point FlashPoint3 = FlashPoint1;
...
HXDLIN( 972)										 ::openfl::geom::Point FlashPoint4 = this->_flashPoint;
HXDLIN( 972)										 ::openfl::geom::Point FlashPoint5 = FlashPoint4;
HXDLIN( 972)										FlashPoint5->x = (FlashPoint5->x - _this2->x);
HXDLIN( 972)										 ::openfl::geom::Point FlashPoint6 = FlashPoint4;
...
HXLINE(1005)							 ::openfl::geom::Point _hx_tmp7 = this->_flashPoint;
...
HXLINE(1011)					 ::openfl::geom::Point _hx_tmp8 = this->_flashPoint;
...
HXLINE(1038)		 ::openfl::display::BitmapData debugTile =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_tileWidth,this->_tileHeight,true,(int)0);
...
HXLINE(1047)			 ::openfl::display::Graphics gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
...
HXLINE(1145)			this->colorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		}
