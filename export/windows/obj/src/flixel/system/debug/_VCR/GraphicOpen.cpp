...
HX_DEFINE_STACK_FRAME(_hx_pos_d810408afd233251_51_new,"flixel.system.debug._VCR.GraphicOpen","new",0x5cfdc604,"flixel.system.debug._VCR.GraphicOpen.new","openfl/_internal/macros/AssetsMacro.hx",51,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_8d12d9b2de896b6c_1_boot,"flixel.system.debug._VCR.GraphicOpen","boot",0xf9287e0e,"flixel.system.debug._VCR.GraphicOpen.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicOpen_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_d810408afd233251_51_new)
HXLINE(  83)		super::__construct((int)0,(int)0,transparent,fillRGBA);
HXLINE(  88)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicOpen_obj::resourceName));
HXLINE(  89)		{
...
bool GraphicOpen_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x27824af0) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x27824af0;
	} else {
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicOpen",38,bb,f9,19);
            	}
}
