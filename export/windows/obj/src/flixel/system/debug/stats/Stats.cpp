...
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_187_start,"flixel.system.debug.stats.Stats","start",0x6e8a565c,"flixel.system.debug.stats.Stats.start","flixel/system/debug/stats/Stats.hx",187,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_200_stop,"flixel.system.debug.stats.Stats","stop",0x6338eb48,"flixel.system.debug.stats.Stats.stop","flixel/system/debug/stats/Stats.hx",200,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_207_destroy,"flixel.system.debug.stats.Stats","destroy",0xd5fd0174,"flixel.system.debug.stats.Stats.destroy","flixel/system/debug/stats/Stats.hx",207,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_247_update,"flixel.system.debug.stats.Stats","update",0xcb8c5ecf,"flixel.system.debug.stats.Stats.update","flixel/system/debug/stats/Stats.hx",247,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_322_updateTexts,"flixel.system.debug.stats.Stats","updateTexts",0xc9854dd7,"flixel.system.debug.stats.Stats.updateTexts","flixel/system/debug/stats/Stats.hx",322,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_338_divide,"flixel.system.debug.stats.Stats","divide",0x0399083f,"flixel.system.debug.stats.Stats.divide","flixel/system/debug/stats/Stats.hx",338,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_349_currentFps,"flixel.system.debug.stats.Stats","currentFps",0x555240f6,"flixel.system.debug.stats.Stats.currentFps","flixel/system/debug/stats/Stats.hx",349,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_357_intervalTime,"flixel.system.debug.stats.Stats","intervalTime",0x37fba938,"flixel.system.debug.stats.Stats.intervalTime","flixel/system/debug/stats/Stats.hx",357,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_365_currentMem,"flixel.system.debug.stats.Stats","currentMem",0x55578722,"flixel.system.debug.stats.Stats.currentMem","flixel/system/debug/stats/Stats.hx",365,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_374_flixelUpdate,"flixel.system.debug.stats.Stats","flixelUpdate",0xda311acb,"flixel.system.debug.stats.Stats.flixelUpdate","flixel/system/debug/stats/Stats.hx",374,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_386_flixelDraw,"flixel.system.debug.stats.Stats","flixelDraw",0xdc09ac46,"flixel.system.debug.stats.Stats.flixelDraw","flixel/system/debug/stats/Stats.hx",386,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_398_activeObjects,"flixel.system.debug.stats.Stats","activeObjects",0xffa11fa8,"flixel.system.debug.stats.Stats.activeObjects","flixel/system/debug/stats/Stats.hx",398,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_410_visibleObjects,"flixel.system.debug.stats.Stats","visibleObjects",0x48c7f948,"flixel.system.debug.stats.Stats.visibleObjects","flixel/system/debug/stats/Stats.hx",410,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_422_drawCalls,"flixel.system.debug.stats.Stats","drawCalls",0x25570e6b,"flixel.system.debug.stats.Stats.drawCalls","flixel/system/debug/stats/Stats.hx",422,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_433_onFocus,"flixel.system.debug.stats.Stats","onFocus",0x4c3dd2b3,"flixel.system.debug.stats.Stats.onFocus","flixel/system/debug/stats/Stats.hx",433,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_441_onFocusLost,"flixel.system.debug.stats.Stats","onFocusLost",0x17d97e37,"flixel.system.debug.stats.Stats.onFocusLost","flixel/system/debug/stats/Stats.hx",441,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_445_toggleSize,"flixel.system.debug.stats.Stats","toggleSize",0x72339a3b,"flixel.system.debug.stats.Stats.toggleSize","flixel/system/debug/stats/Stats.hx",445,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_468_updateSize,"flixel.system.debug.stats.Stats","updateSize",0x93323f30,"flixel.system.debug.stats.Stats.updateSize","flixel/system/debug/stats/Stats.hx",468,0xc15f23b8)
...
HXLINE( 156)		 ::openfl::text::TextField _hx_tmp = this->_leftTextField;
HXDLIN( 156)		_hx_tmp->set_multiline(this->_rightTextField->set_multiline(true));
HXLINE( 157)		 ::openfl::text::TextField _hx_tmp1 = this->_leftTextField;
HXDLIN( 157)		_hx_tmp1->set_wordWrap(this->_rightTextField->set_wordWrap(true));
HXLINE( 159)		::String drawMethod = HX_("",00,00,00,00);
HXLINE( 160)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 162)			drawMethod = HX_("DrawQuads",08,8b,c5,c7);
HXLINE( 170)			drawMethod = ((HX_("\n",0a,00,00,00) + drawMethod) + HX_(":",3a,00,00,00));
            		}
HXLINE( 173)		 ::openfl::text::TextField _hx_tmp2 = this->_leftTextField;
HXDLIN( 173)		_hx_tmp2->set_text(((HX_("Update: \nDraw:",9b,e1,5f,a0) + drawMethod) + HX_("\nQuadTrees: \nLists:",e5,f7,d0,58)));
HXLINE( 175)		this->_toggleSizeButton =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX , ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()),this->toggleSize_dyn(),null());
HXLINE( 176)		this->_toggleSizeButton->set_alpha(((Float)0.8));
HXLINE( 177)		this->addChild(this->_toggleSizeButton);
...
bool Stats_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1b123bf8) {
		...
		if (inClassId<=(int)0x619ca9b8) {
			return inClassId==(int)0x3f2b00af || inClassId==(int)0x619ca9b8;
		} else {
...
void Stats_obj::start(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_187_start)
HXDLIN( 187)		if (this->_paused) {
HXLINE( 189)			this->_paused = false;
HXLINE( 190)			this->_itvTime = ::flixel::FlxG_obj::game->ticks;
HXLINE( 191)			this->_frameCount = (int)0;
            		}
            	}
...
void Stats_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_200_stop)
HXDLIN( 200)		this->_paused = true;
            	}
...
void Stats_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_207_destroy)
HXLINE( 208)		if (hx::IsNotNull( this->fpsGraph )) {
HXLINE( 210)			this->fpsGraph->destroy();
HXLINE( 211)			this->removeChild(this->fpsGraph);
            		}
HXLINE( 213)		this->fpsGraph = null();
HXLINE( 215)		if (hx::IsNotNull( this->memoryGraph )) {
HXLINE( 217)			this->removeChild(this->memoryGraph);
            		}
HXLINE( 219)		this->memoryGraph = null();
HXLINE( 221)		if (hx::IsNotNull( this->_leftTextField )) {
HXLINE( 223)			this->removeChild(this->_leftTextField);
            		}
HXLINE( 225)		this->_leftTextField = null();
HXLINE( 227)		if (hx::IsNotNull( this->_rightTextField )) {
HXLINE( 229)			this->removeChild(this->_rightTextField);
            		}
HXLINE( 231)		this->_rightTextField = null();
HXLINE( 233)		this->_update = null();
HXLINE( 234)		this->_draw = null();
HXLINE( 235)		this->_activeObject = null();
HXLINE( 236)		this->_visibleObject = null();
HXLINE( 237)		this->_drawCalls = null();
HXLINE( 239)		this->super::destroy();
            	}


void Stats_obj::update(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_247_update)
HXLINE( 248)		if (this->_paused) {
HXLINE( 250)			return;
            		}
HXLINE( 252)		int time = (this->_currentTime = ::flixel::FlxG_obj::game->ticks);
HXLINE( 254)		int elapsed = (time - this->_lastTime);
HXLINE( 256)		if ((elapsed > (int)250)) {
HXLINE( 258)			elapsed = (int)250;
            		}
HXLINE( 260)		this->_lastTime = time;
HXLINE( 262)		 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 262)		_hx_tmp->_updateTimer = (_hx_tmp->_updateTimer + elapsed);
HXLINE( 264)		this->_frameCount++;
HXLINE( 266)		if ((this->_updateTimer > (int)250)) {
HXLINE( 268)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp1 = this->fpsGraph;
HXDLIN( 268)			int _hx_tmp2 = this->_frameCount;
HXDLIN( 268)			_hx_tmp1->update(((Float)_hx_tmp2 / (Float)((Float)(this->_currentTime - this->_itvTime) / (Float)(int)1000)));
HXLINE( 269)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp3 = this->memoryGraph;
HXDLIN( 269)			_hx_tmp3->update(((Float)((Float)::openfl::_hx_system::System_obj::get_totalMemory() / (Float)(int)1024) / (Float)(int)1000));
HXLINE( 270)			this->updateTexts();
HXLINE( 272)			this->_frameCount = (int)0;
HXLINE( 273)			this->_itvTime = this->_currentTime;
HXLINE( 275)			this->updateTime = (int)0;
HXLINE( 276)			{
HXLINE( 276)				int _g1 = (int)0;
HXDLIN( 276)				int _g = this->_updateMarker;
HXDLIN( 276)				while((_g1 < _g)){
HXLINE( 276)					_g1 = (_g1 + (int)1);
HXDLIN( 276)					int i = (_g1 - (int)1);
HXLINE( 278)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 278)					_hx_tmp4->updateTime = (_hx_tmp4->updateTime + this->_update->__get(i));
            				}
            			}
HXLINE( 281)			{
HXLINE( 281)				int _g11 = (int)0;
HXDLIN( 281)				int _g2 = this->_activeObjectMarker;
HXDLIN( 281)				while((_g11 < _g2)){
HXLINE( 281)					_g11 = (_g11 + (int)1);
HXDLIN( 281)					int i1 = (_g11 - (int)1);
HXLINE( 283)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp5 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 283)					_hx_tmp5->activeCount = (_hx_tmp5->activeCount + this->_activeObject->__get(i1));
            				}
            			}
HXLINE( 285)			this->activeCount = ::Std_obj::_hx_int(this->divide(this->activeCount,this->_activeObjectMarker));
HXLINE( 287)			this->drawTime = (int)0;
HXLINE( 288)			{
HXLINE( 288)				int _g12 = (int)0;
HXDLIN( 288)				int _g3 = this->_drawMarker;
HXDLIN( 288)				while((_g12 < _g3)){
HXLINE( 288)					_g12 = (_g12 + (int)1);
HXDLIN( 288)					int i2 = (_g12 - (int)1);
HXLINE( 290)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp6 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 290)					_hx_tmp6->drawTime = (_hx_tmp6->drawTime + this->_draw->__get(i2));
            				}
            			}
HXLINE( 293)			{
HXLINE( 293)				int _g13 = (int)0;
HXDLIN( 293)				int _g4 = this->_visibleObjectMarker;
HXDLIN( 293)				while((_g13 < _g4)){
HXLINE( 293)					_g13 = (_g13 + (int)1);
HXDLIN( 293)					int i3 = (_g13 - (int)1);
HXLINE( 295)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 295)					_hx_tmp7->visibleCount = (_hx_tmp7->visibleCount + this->_visibleObject->__get(i3));
            				}
            			}
HXLINE( 297)			this->visibleCount = ::Std_obj::_hx_int(this->divide(this->visibleCount,this->_visibleObjectMarker));
HXLINE( 299)			if (::flixel::FlxG_obj::renderTile) {
HXLINE( 301)				{
HXLINE( 301)					int _g14 = (int)0;
HXDLIN( 301)					int _g5 = this->_drawCallsMarker;
HXDLIN( 301)					while((_g14 < _g5)){
HXLINE( 301)						_g14 = (_g14 + (int)1);
HXDLIN( 301)						int i4 = (_g14 - (int)1);
HXLINE( 303)						 ::flixel::_hx_system::debug::stats::Stats _hx_tmp8 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 303)						_hx_tmp8->drawCallsCount = (_hx_tmp8->drawCallsCount + this->_drawCalls->__get(i4));
            					}
            				}
HXLINE( 305)				this->drawCallsCount = ::Std_obj::_hx_int(this->divide(this->drawCallsCount,this->_drawCallsMarker));
            			}
HXLINE( 308)			this->_updateMarker = (int)0;
HXLINE( 309)			this->_drawMarker = (int)0;
HXLINE( 310)			this->_activeObjectMarker = (int)0;
HXLINE( 311)			this->_visibleObjectMarker = (int)0;
HXLINE( 312)			if (::flixel::FlxG_obj::renderTile) {
HXLINE( 314)				this->_drawCallsMarker = (int)0;
            			}
HXLINE( 317)			 ::flixel::_hx_system::debug::stats::Stats _hx_tmp9 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 317)			_hx_tmp9->_updateTimer = (_hx_tmp9->_updateTimer - (int)250);
            		}
            	}


void Stats_obj::updateTexts(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_322_updateTexts)
HXLINE( 323)		Float updTime = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(this->updateTime,this->_updateMarker),(int)1);
HXLINE( 324)		Float drwTime = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(this->drawTime,this->_drawMarker),(int)1);
HXLINE( 326)		this->drawTimeGraph->update(drwTime);
HXLINE( 327)		this->updateTimeGraph->update(updTime);
HXLINE( 329)		 ::openfl::text::TextField _hx_tmp = this->_rightTextField;
HXLINE( 332)		::String _hx_tmp1;
HXDLIN( 332)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 332)			_hx_tmp1 = (this->drawCallsCount + HX_("\n",0a,00,00,00));
            		}
            		else {
HXLINE( 332)			_hx_tmp1 = HX_("",00,00,00,00);
            		}
HXLINE( 330)		::String _hx_tmp2 = ::lime::text::_UTF8String::UTF8String_Impl__obj::plus((((((((this->activeCount + HX_(" (",08,1c,00,00)) + updTime) + HX_("ms)\n",a7,a8,63,48)) + this->visibleCount) + HX_(" (",08,1c,00,00)) + drwTime) + HX_("ms)\n",a7,a8,63,48)),_hx_tmp1);
HXDLIN( 330)		::String _hx_tmp3 = ::lime::text::_UTF8String::UTF8String_Impl__obj::plus(::lime::text::_UTF8String::UTF8String_Impl__obj::plus(_hx_tmp2,::lime::text::_UTF8String::UTF8String_Impl__obj::fromDynamic(::flixel::_hx_system::FlxQuadTree_obj::_NUM_CACHED_QUAD_TREES)),HX_("\n",0a,00,00,00));
HXLINE( 329)		_hx_tmp->set_text(::lime::text::_UTF8String::UTF8String_Impl__obj::plus(_hx_tmp3,::lime::text::_UTF8String::UTF8String_Impl__obj::fromDynamic(::flixel::_hx_system::FlxLinkedList_obj::_NUM_CACHED_FLX_LIST)));
            	}
...
Float Stats_obj::divide(Float f1,Float f2){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_338_divide)
HXLINE( 339)		if ((f2 == (int)0)) {
HXLINE( 340)			return (int)0;
            		}
HXLINE( 341)		return ((Float)f1 / (Float)f2);
            	}
...
Float Stats_obj::currentFps(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_349_currentFps)
HXDLIN( 349)		int _hx_tmp = this->_frameCount;
HXDLIN( 349)		return ((Float)_hx_tmp / (Float)((Float)(this->_currentTime - this->_itvTime) / (Float)(int)1000));
            	}
...
Float Stats_obj::intervalTime(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_357_intervalTime)
HXDLIN( 357)		return ((Float)(this->_currentTime - this->_itvTime) / (Float)(int)1000);
            	}
...
Float Stats_obj::currentMem(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_365_currentMem)
HXDLIN( 365)		return ((Float)((Float)::openfl::_hx_system::System_obj::get_totalMemory() / (Float)(int)1024) / (Float)(int)1000);
            	}
...
void Stats_obj::flixelUpdate(int Time){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_374_flixelUpdate)
HXLINE( 375)		if (this->_paused) {
HXLINE( 376)			return;
            		}
HXLINE( 377)		::Array< int > _hx_tmp = this->_update;
HXDLIN( 377)		_hx_tmp[this->_updateMarker++] = Time;
            	}
...
void Stats_obj::flixelDraw(int Time){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_386_flixelDraw)
HXLINE( 387)		if (this->_paused) {
HXLINE( 388)			return;
            		}
HXLINE( 389)		::Array< int > _hx_tmp = this->_draw;
HXDLIN( 389)		_hx_tmp[this->_drawMarker++] = Time;
            	}
...
void Stats_obj::activeObjects(int Count){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_398_activeObjects)
HXLINE( 399)		if (this->_paused) {
HXLINE( 400)			return;
            		}
HXLINE( 401)		::Array< int > _hx_tmp = this->_activeObject;
HXDLIN( 401)		_hx_tmp[this->_activeObjectMarker++] = Count;
            	}
...
void Stats_obj::visibleObjects(int Count){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_410_visibleObjects)
HXLINE( 411)		if (this->_paused) {
HXLINE( 412)			return;
            		}
HXLINE( 413)		::Array< int > _hx_tmp = this->_visibleObject;
HXDLIN( 413)		_hx_tmp[this->_visibleObjectMarker++] = Count;
            	}
...
void Stats_obj::drawCalls(int Drawcalls){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_422_drawCalls)
HXLINE( 423)		if (this->_paused) {
HXLINE( 424)			return;
            		}
HXLINE( 425)		::Array< int > _hx_tmp = this->_drawCalls;
HXDLIN( 425)		_hx_tmp[this->_drawCallsMarker++] = Drawcalls;
            	}
...
void Stats_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_433_onFocus)
HXDLIN( 433)		this->_paused = false;
            	}
...
void Stats_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_441_onFocusLost)
HXDLIN( 441)		this->_paused = true;
            	}
...
void Stats_obj::toggleSize(){
            	HX_GC_STACKFRAME(&_hx_pos_a2cdb8120663480d_445_toggleSize)
HXLINE( 446)		if ((this->_width == (int)160)) {
HXLINE( 448)			this->resize((int)320,this->_height);
HXLINE( 449)			{
HXLINE( 449)				 ::flixel::_hx_system::debug::stats::Stats _g = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 449)				_g->set_x((_g->get_x() - (int)160));
            			}
HXLINE( 450)			this->drawTimeGraph->set_visible(true);
HXLINE( 451)			this->updateTimeGraph->set_visible(true);
HXLINE( 452)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->_toggleSizeButton;
HXDLIN( 452)			_hx_tmp->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMinimizeButton_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
            		}
            		else {
HXLINE( 456)			this->resize((int)160,this->_height);
HXLINE( 457)			{
HXLINE( 457)				 ::flixel::_hx_system::debug::stats::Stats _g1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 457)				_g1->set_x((_g1->get_x() + (int)160));
            			}
HXLINE( 458)			this->drawTimeGraph->set_visible(false);
HXLINE( 459)			this->updateTimeGraph->set_visible(false);
HXLINE( 460)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp1 = this->_toggleSizeButton;
HXDLIN( 460)			_hx_tmp1->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
            		}
HXLINE( 463)		this->updateSize();
HXLINE( 464)		this->bound();
            	}
...
void Stats_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_468_updateSize)
HXLINE( 469)		this->super::updateSize();
HXLINE( 470)		if (hx::IsNotNull( this->_toggleSizeButton )) {
HXLINE( 472)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->_toggleSizeButton;
HXDLIN( 472)			int _hx_tmp1 = this->_width;
HXDLIN( 472)			_hx_tmp->set_x(((_hx_tmp1 - this->_toggleSizeButton->get_width()) - (int)3));
HXLINE( 473)			this->_toggleSizeButton->set_y((int)3);
            		}
            	}
...
static hx::StorageInfo Stats_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(Stats_obj,_leftTextField),HX_HCSTRING("_leftTextField","\x07","\x34","\xbe","\x51")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(Stats_obj,_rightTextField),HX_HCSTRING("_rightTextField","\xf0","\xe5","\xf5","\xc1")},
