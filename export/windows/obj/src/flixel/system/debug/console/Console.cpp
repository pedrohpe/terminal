...
HXLINE( 123)				::openfl::Lib_obj::get_current()->stage->set_focus(_gthis->input);
            			}
            		}
...
HXLINE( 120)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("keyDown",a1,69,47,9c), ::Dynamic(new _hx_Closure_0(_gthis)),null(),null(),null());
HXLINE( 129)		this->input->addEventListener(HX_("mouseDown",27,b1,c2,ee), ::Dynamic(new _hx_Closure_1(_gthis)),null(),null(),null());
HXLINE( 133)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("mouseDown",27,b1,c2,ee), ::Dynamic(new _hx_Closure_2(_gthis)),null(),null(),null());
            	}
...
HXLINE( 171)		if (::lime::text::_UTF8String::UTF8String_Impl__obj::equals(this->input->get_text(),HX_("(Click here / press [Tab] to enter command. Type 'help' for help.)",f9,4e,c0,26))) {
...
HXLINE( 207)						this->processCommand();
            				...
            				break;
            				case (int)27: {
HXLINE( 210)					::openfl::Lib_obj::get_current()->stage->set_focus(null());
            				}
            				break;
            				case (int)38: {
...
HXLINE( 333)		this->input->removeEventListener(HX_("keyDown",a1,69,47,9c),this->onKeyDown_dyn(),null());
