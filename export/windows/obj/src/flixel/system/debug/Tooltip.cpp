...
HX_LOCAL_STACK_FRAME(_hx_pos_e11c5e295c1ca4dc_35_remove,"flixel.system.debug.Tooltip","remove",0x530196f7,"flixel.system.debug.Tooltip.remove","flixel/system/debug/Tooltip.hx",35,0x5d425da4)
...
bool Tooltip_obj::remove( ::openfl::display::Sprite element){
            	HX_STACKFRAME(&_hx_pos_e11c5e295c1ca4dc_35_remove)
HXLINE(  36)		bool removed = false;
HXLINE(  38)		{
HXLINE(  38)			int _g1 = (int)0;
HXDLIN(  38)			int _g = ::flixel::_hx_system::debug::Tooltip_obj::_tooltips->length;
HXDLIN(  38)			while((_g1 < _g)){
HXLINE(  38)				_g1 = (_g1 + (int)1);
HXDLIN(  38)				int i = (_g1 - (int)1);
HXLINE(  40)				bool _hx_tmp;
HXDLIN(  40)				if (hx::IsNotNull( ::flixel::_hx_system::debug::Tooltip_obj::_tooltips->__get(i).StaticCast<  ::flixel::_hx_system::debug::TooltipOverlay >() )) {
...
HXLINE(  42)					 ::flixel::_hx_system::debug::TooltipOverlay tooltip = ::flixel::_hx_system::debug::Tooltip_obj::_tooltips->splice(i,(int)1)->__get((int)0).StaticCast<  ::flixel::_hx_system::debug::TooltipOverlay >();
...
{
	hx::Object *dummy = new Tooltip_obj;
	Tooltip_obj::_hx_vtable = *(void **)dummy;
