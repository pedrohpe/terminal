...
HXDLIN( 128)		_hx_tmp->drawRect((int)0,(int)0,::openfl::Lib_obj::get_current()->stage->stageWidth,(int)20);
...
HXLINE( 138)		 ::openfl::text::TextFormat format =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 139)		txt->set_defaultTextFormat(format);
HXLINE( 140)		txt->set_autoSize((int)1);
...
HXDLIN( 327)		_hx_tmp->set_width(::openfl::Lib_obj::get_current()->stage->stageWidth);
...
HXDLIN( 337)		this->_screenBounds =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)2,((Float)21.),_hx_tmp,((this->_screen->y - (int)4) - (int)20));
HXLINE( 338)		{
...
HXLINE( 371)		Float offset = (::openfl::Lib_obj::get_current()->stage->stageWidth * ((Float)0.5));
...
HXLINE( 422)		 ::flixel::_hx_system::ui::FlxSystemButton button = this->addButton(::flixel::util::FlxHorizontalAlign_obj::RIGHT_dyn(),( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(icon,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) ),window->toggleVisible_dyn(),true,true);
...
HXDLIN( 503)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + HX_("http://www.haxeflixel.com",de,bc,02,e0))),HX_("_blank",95,26,d9,b0));
            	}
...
HXDLIN( 513)			::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + url)),HX_("_blank",95,26,d9,b0));
            		}
            	}
...
static hx::StorageInfo FlxDebugger_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::geom::Point*/ ,(int)offsetof(FlxDebugger_obj,_screen),HX_HCSTRING("_screen","\x0b","\x4d","\xd4","\xb5")},
	{hx::fsObject /*::openfl::geom::Rectangle*/ ,(int)offsetof(FlxDebugger_obj,_screenBounds),HX_HCSTRING("_screenBounds","\xe0","\x21","\xaa","\x25")},
	{hx::fsObject /*::haxe::ds::EnumValueMap*/ ,(int)offsetof(FlxDebugger_obj,_buttons),HX_HCSTRING("_buttons","\xc2","\xab","\x2d","\x04")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(FlxDebugger_obj,_topBar),HX_HCSTRING("_topBar","\xdd","\x9f","\x91","\x03")},
