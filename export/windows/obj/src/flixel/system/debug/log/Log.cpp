...
HXDLIN(  33)		_hx_tmp->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
...
HXLINE( 124)			 ::openfl::text::TextField _g4 = this->_text;
HXDLIN( 124)			::String _hx_tmp = _g4->get_htmlText();
HXDLIN( 124)			_g4->set_htmlText(::lime::text::_UTF8String::UTF8String_Impl__obj::plus(_hx_tmp,(text + HX_("<br>",b2,8d,f3,27))));
            		}
HXLINE( 130)		 ::openfl::text::TextField _hx_tmp1 = this->_text;
...
HXLINE( 150)		 ::openfl::text::TextField _hx_tmp = this->_text;
HXDLIN( 150)		_hx_tmp->set_width((this->_width - (int)10));
HXLINE( 151)		 ::openfl::text::TextField _hx_tmp1 = this->_text;
