...
HXDLIN(  58)		this->_canvasBitmap =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,_hx_tmp,::Std_obj::_hx_int((this->get_height() - (int)15)),true,(int)0),null(),null());
...
HXLINE( 118)		this->_footer =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)1,(int)15,true,(int)-1157627904),null(),null());
...
HXDLIN( 179)			_hx_tmp2->set_bitmapData( ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,newWidth1,newHeight2,true,(int)0));
...
HXLINE( 194)		 ::openfl::text::TextField _hx_tmp2 = this->_dimensionsText;
HXDLIN( 194)		_hx_tmp2->set_visible((this->_width > (int)200));
HXLINE( 196)		 ::openfl::text::TextField _hx_tmp3 = this->_footerText;
HXDLIN( 196)		int _hx_tmp4 = this->_height;
HXDLIN( 196)		_hx_tmp3->set_y((_hx_tmp4 - this->_footer->get_height()));
HXLINE( 197)		 ::openfl::text::TextField _hx_tmp5 = this->_footerText;
...
HXLINE( 198)		 ::openfl::text::TextField _hx_tmp7 = this->_footerText;
...
HXDLIN( 275)			_hx_tmp->fillRect(this->_canvasBitmap->get_bitmapData()->rect,(int)0);
            		}
...
HXDLIN( 294)		_hx_tmp1->fillRect(this->_canvasBitmap->get_bitmapData()->rect,(int)0);
...
HXDLIN( 308)		Float _hx_tmp3 = ((Float)this->_canvasBitmap->get_bitmapData()->width / (Float)(int)2);
HXDLIN( 308)		_hx_tmp2->set_x((_hx_tmp3 - ((Float)(( ( ::openfl::display::BitmapData)(this->_entries->__get(this->_curIndex)->__Field(HX_("bitmap",ef,0f,0c,f1),hx::paccDynamic)) )->width * this->zoom) / (Float)(int)2)));
HXLINE( 309)		 ::flixel::math::FlxPoint _hx_tmp4 = this->_point;
HXDLIN( 309)		Float _hx_tmp5 = ((Float)this->_canvasBitmap->get_bitmapData()->height / (Float)(int)2);
HXDLIN( 309)		_hx_tmp4->set_y((_hx_tmp5 - ((Float)(( ( ::openfl::display::BitmapData)(this->_entries->__get(this->_curIndex)->__Field(HX_("bitmap",ef,0f,0c,f1),hx::paccDynamic)) )->height * this->zoom) / (Float)(int)2)));
...
HXLINE( 329)		 ::openfl::text::TextField _hx_tmp = this->_dimensionsText;
HXDLIN( 329)		_hx_tmp->set_text(((( ( ::openfl::display::BitmapData)(this->_entries->__get(this->_curIndex)->__Field(HX_("bitmap",ef,0f,0c,f1),hx::paccDynamic)) )->width + HX_("x",78,00,00,00)) + ( ( ::openfl::display::BitmapData)(this->_entries->__get(this->_curIndex)->__Field(HX_("bitmap",ef,0f,0c,f1),hx::paccDynamic)) )->height));
HXLINE( 330)		 ::openfl::text::TextField _hx_tmp1 = this->_counterText;
HXDLIN( 330)		_hx_tmp1->set_text((((HX_("",00,00,00,00) + (this->_curIndex + (int)1)) + HX_("/",2f,00,00,00)) + this->_entries->length));
...
HXLINE( 334)		 ::openfl::text::TextField _hx_tmp2 = this->_footerText;
...
HXDLIN( 334)		_hx_tmp2->set_text((name + ::flixel::util::FlxStringUtil_obj::formatBytes(((bitmapData->width * bitmapData->height) * (int)4),null())));
...
HXDLIN( 345)		gfx->drawRect(-(offset),-(offset),_hx_tmp,(bitmap->height + offset));
            	}
