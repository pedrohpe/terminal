...
HXLINE( 119)		this->maxSize =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,width,height);
HXLINE( 121)		this->_shadow =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)1,(int)2,true,(int)-16777216),null(),null());
HXLINE( 122)		this->_background =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)1,(int)1,true,(int)-12961222),null(),null());
...
HXDLIN( 199)		this->parent->addChild(hx::ObjectPtr<OBJ_>(this));
            	}
...
HXDLIN( 227)		if ((offsetX2 >= ::openfl::Lib_obj::get_current()->stage->stageWidth)) {
HXLINE( 227)			int offsetX3 = ::openfl::Lib_obj::get_current()->stage->stageWidth;
...
HXDLIN( 228)		if ((offsetY2 >= ::openfl::Lib_obj::get_current()->stage->stageHeight)) {
HXLINE( 228)			int offsetY3 = ::openfl::Lib_obj::get_current()->stage->stageHeight;
