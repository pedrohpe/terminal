...
HXLINE(  27)		this->entriesContainer =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
...
static hx::StorageInfo Watch_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(Watch_obj,entriesContainer),HX_HCSTRING("entriesContainer","\xd1","\xfd","\x5e","\x72")},
