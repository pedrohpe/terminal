...
HXLINE(  35)			this->editFormat =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,defaultFormat->font,defaultFormat->size,(int)0,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE(  81)					this->cycleValue(modifier,(int)0);
            				...
            				break;
            				case (int)40: {
HXLINE(  82)					this->cycleValue(-(modifier),::lime::text::_UTF8String::UTF8String_Impl__obj::get_length(this->get_text()));
            				}
            				break;
            			}
            		}
...
HXDLIN(  94)				if (::lime::text::_UTF8String::UTF8String_Impl__obj::equals(this->get_text(),HX_("true",4e,a7,03,4d))) {
...
HXDLIN( 106)		int _hx_tmp = ::lime::text::_UTF8String::UTF8String_Impl__obj::get_length(this->get_text());
HXDLIN( 106)		this->setSelection(_hx_tmp,::lime::text::_UTF8String::UTF8String_Impl__obj::get_length(this->get_text()));
            	}
...
HXDLIN( 141)		switch((int)(_hx_getEnumValueIndex(_g))){
            			case (int)3: {
HXLINE( 147)				if (::lime::text::_UTF8String::UTF8String_Impl__obj::equals(this->get_text(),HX_("true",4e,a7,03,4d))) {
HXLINE( 141)					value = true;
            				}
            				else {
HXLINE( 148)					if (::lime::text::_UTF8String::UTF8String_Impl__obj::equals(this->get_text(),HX_("false",a3,35,4f,fb))) {
