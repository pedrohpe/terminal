...
HXDLIN(  41)		this->defaultFormat =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,_hx_tmp,(int)12,this->getTextColor(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  42)		this->nameText = ( ( ::openfl::text::TextField)(this->initTextField(::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField(null(),null(),null(),null()))) );
...
HXLINE( 106)		 ::openfl::text::TextField _hx_tmp = this->nameText;
