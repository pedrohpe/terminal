...
HXDLIN(  19)		return ( ( ::openfl::text::TextField)(::flixel::_hx_system::debug::DebuggerUtil_obj::initTextField( ::openfl::text::TextField_obj::__alloc( HX_CTX ),X,Y,Color,Size)) );
            	}
...
HXLINE(  24)		( ( ::openfl::text::TextField)(tf) )->set_x(X);
HXLINE(  25)		( ( ::openfl::text::TextField)(tf) )->set_y(Y);
HXLINE(  26)		( ( ::openfl::text::TextField)(tf) )->set_multiline(false);
HXLINE(  27)		( ( ::openfl::text::TextField)(tf) )->set_wordWrap(false);
HXLINE(  28)		( ( ::openfl::text::TextField)(tf) )->set_embedFonts(true);
HXLINE(  29)		( ( ::openfl::text::TextField)(tf) )->set_selectable(false);
HXLINE(  34)		( ( ::openfl::text::TextField)(tf) )->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,Size,((int)Color & (int)(int)16777215),null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE(  35)		( ( ::openfl::display::DisplayObject)(tf) )->set_alpha(((Float)((int)((int)Color >> (int)(int)24) & (int)(int)255) / (Float)(int)255));
HXLINE(  36)		( ( ::openfl::text::TextField)(tf) )->set_autoSize((int)1);
HXLINE(  37)		return tf;
            	}
