...
HXDLIN(  37)		return ::lime::text::_UTF8String::UTF8String_Impl__obj::substring(_hx_tmp,(int)0,this->getCaretIndex());
            	}
...
int CompletionHandler_obj::getCaretIndex(){
            	HX_STACKFRAME(&_hx_pos_d4c828664754b74a_46_getCaretIndex)
HXDLIN(  46)		return this->input->get_caretIndex();
            	}
...
HXLINE( 136)		 ::openfl::text::TextField _hx_tmp = this->input;
HXDLIN( 136)		::String _hx_tmp1 = this->input->get_text();
HXDLIN( 136)		_hx_tmp->set_text((insert + ::lime::text::_UTF8String::UTF8String_Impl__obj::substr(_hx_tmp1,this->getCaretIndex(),null())));
