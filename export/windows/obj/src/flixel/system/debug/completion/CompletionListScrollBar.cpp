...
HXLINE(  22)		this->addChild( ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)-12303292),null(),null()));
HXLINE(  23)		this->handle =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,(int)1,true,(int)-14540254),null(),null());
...
static hx::StorageInfo CompletionListScrollBar_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(CompletionListScrollBar_obj,handle),HX_HCSTRING("handle","\xa8","\x83","\xfd","\xb7")},
	{ hx::fsUnknown, 0, null()}
};
