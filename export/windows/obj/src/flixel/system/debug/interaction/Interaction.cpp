...
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_343_updateCustomCursors,"flixel.system.debug.interaction.Interaction","updateCustomCursors",0x218c1283,"flixel.system.debug.interaction.Interaction.updateCustomCursors","flixel/system/debug/interaction/Interaction.hx",343,0x4548a912)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_429_setSystemCursorVisibility,"flixel.system.debug.interaction.Interaction","setSystemCursorVisibility",0x3bad5fb9,"flixel.system.debug.interaction.Interaction.setSystemCursorVisibility","flixel/system/debug/interaction/Interaction.hx",429,0x4548a912)
...
HXLINE(  61)		this->_customCursor =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
...
HXLINE(  73)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("mouseMove",d6,9b,b5,f4),this->updateMouse_dyn(),null(),null(),null());
HXLINE(  74)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->handleMouseClick_dyn(),null(),null(),null());
HXLINE(  75)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->handleMouseClick_dyn(),null(),null(),null());
HXLINE(  76)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("keyDown",a1,69,47,9c),this->handleKeyEvent_dyn(),null(),null(),null());
HXLINE(  77)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("keyUp",da,b9,fe,de),this->handleKeyEvent_dyn(),null(),null(),null());
...
HXLINE( 105)			 ::openfl::display::BitmapData cursorIcon = this->activeTool->cursor;
...
HXLINE( 113)		 ::openfl::display::Sprite _hx_tmp = this->_customCursor;
HXDLIN( 113)		_hx_tmp->set_x((event->stageX + offsetX));
HXLINE( 114)		 ::openfl::display::Sprite _hx_tmp1 = this->_customCursor;
HXDLIN( 114)		_hx_tmp1->set_y((event->stageY + offsetY));
HXLINE( 118)		{
HXLINE( 118)			 ::flixel::input::FlxPointer _this = this->_flixelPointer;
HXDLIN( 118)			Float newY = event->stageY;
HXDLIN( 118)			_this->_globalScreenX = ::Std_obj::_hx_int(((Float)event->stageX / (Float)::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 118)			_this->_globalScreenY = ::Std_obj::_hx_int(((Float)newY / (Float)::flixel::FlxG_obj::scaleMode->scale->y));
HXDLIN( 118)			_this->updatePositions();
            		}
HXLINE( 122)		 ::flixel::math::FlxPoint _hx_tmp2 = this->flixelPointer;
HXDLIN( 122)		_hx_tmp2->set_x((this->_flixelPointer->x + offsetX));
HXLINE( 123)		 ::flixel::math::FlxPoint _hx_tmp3 = this->flixelPointer;
HXDLIN( 123)		_hx_tmp3->set_y((this->_flixelPointer->y + offsetY));
            	}
...
HXLINE( 131)			_hx_tmp = this->belongsToDebugger(( ( ::openfl::display::DisplayObject)(event->target) ));
            		}
            		else {
...
HXDLIN( 169)		if ((event->type == HX_("keyDown",a1,69,47,9c))) {
...
HXLINE( 203)		::openfl::Lib_obj::get_current()->stage->removeEventListener(HX_("mouseMove",d6,9b,b5,f4),this->updateMouse_dyn(),null());
HXLINE( 204)		::openfl::Lib_obj::get_current()->stage->removeEventListener(HX_("mouseDown",27,b1,c2,ee),this->handleMouseClick_dyn(),null());
HXLINE( 205)		::openfl::Lib_obj::get_current()->stage->removeEventListener(HX_("mouseUp",e0,f3,72,c0),this->handleMouseClick_dyn(),null());
HXLINE( 206)		::openfl::Lib_obj::get_current()->stage->removeEventListener(HX_("keyDown",a1,69,47,9c),this->handleKeyEvent_dyn(),null());
HXLINE( 207)		::openfl::Lib_obj::get_current()->stage->removeEventListener(HX_("keyUp",da,b9,fe,de),this->handleKeyEvent_dyn(),null());
...
HXLINE( 272)		return ::flixel::FlxG_obj::camera->debugLayer->get_graphics();
            	}
...
HXLINE( 280)		 ::openfl::display::Graphics gfx = this->getDebugGraphics();
...
HXLINE( 329)		 ::openfl::display::Sprite sprite =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXLINE( 330)		sprite->set_visible(false);
HXLINE( 331)		sprite->set_name(name);
HXLINE( 332)		sprite->addChild( ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,icon,null(),null()));
...
void Interaction_obj::updateCustomCursors(){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_343_updateCustomCursors)
HXDLIN( 343)		bool _hx_tmp;
HXDLIN( 343)		if (hx::IsNotNull( this->activeTool )) {
HXDLIN( 343)			_hx_tmp = !(this->_debuggerInteraction);
            		}
            		else {
HXDLIN( 343)			_hx_tmp = false;
            		}
HXDLIN( 343)		if (_hx_tmp) {
HXLINE( 346)			if (hx::IsNotNull( this->activeTool->cursor )) {
HXLINE( 356)				{
HXLINE( 356)					int _g1 = (int)0;
HXDLIN( 356)					int _g = this->_customCursor->get_numChildren();
HXDLIN( 356)					while((_g1 < _g)){
HXLINE( 356)						_g1 = (_g1 + (int)1);
HXDLIN( 356)						int i = (_g1 - (int)1);
HXLINE( 358)						 ::openfl::display::DisplayObject sprite = this->_customCursor->getChildAt(i);
HXLINE( 359)						::String _hx_tmp1 = sprite->get_name();
HXDLIN( 359)						sprite->set_visible((_hx_tmp1 == this->activeTool->getName()));
            					}
            				}
HXLINE( 361)				if (::flixel::FlxG_obj::mouse->visible) {
HXLINE( 362)					::flixel::FlxG_obj::mouse->set_visible(false);
            				}
            			}
            			else {
HXLINE( 369)				::flixel::FlxG_obj::mouse->set_useSystemCursor(true);
            			}
            		}
            		else {
HXLINE( 376)			::flixel::FlxG_obj::mouse->set_useSystemCursor(true);
            		}
            	}
...
HXLINE( 384)		this->_wasMouseVisible = ::flixel::FlxG_obj::mouse->visible;
HXLINE( 385)		this->_wasUsingSystemCursor = ::flixel::FlxG_obj::mouse->useSystemCursor;
            	}
...
HXLINE( 392)		::flixel::FlxG_obj::mouse->set_useSystemCursor(this->_wasUsingSystemCursor);
HXLINE( 393)		::flixel::FlxG_obj::mouse->set_visible(this->_wasMouseVisible);
HXLINE( 394)		this->_customCursor->set_visible(false);
            	}
...
void Interaction_obj::setSystemCursorVisibility(bool status){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_429_setSystemCursorVisibility)
HXLINE( 431)		::flixel::FlxG_obj::mouse->set_useSystemCursor(status);
HXLINE( 433)		this->_customCursor->set_visible(!(status));
            	}
...
HXLINE( 439)		::flixel::FlxG_obj::mouse->set_useSystemCursor(false);
