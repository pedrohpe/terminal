...
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_437_close,"flixel.system.debug.Window","close",0x8465b962,"flixel.system.debug.Window.close","flixel/system/debug/Window.hx",437,0xb8dfd4e5)
...
HXLINE( 112)		 ::openfl::display::Bitmap _hx_tmp = this->_background;
...
HXLINE( 126)			 ::openfl::display::Bitmap icon =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,Icon,null(),null());
HXLINE( 127)			icon->set_x((int)5);
HXLINE( 128)			icon->set_y((int)2);
HXLINE( 129)			icon->set_alpha(((Float)0.8));
HXLINE( 130)			 ::openfl::text::TextField _hx_tmp1 = this->_title;
...
HXLINE( 198)		 ::openfl::display::Stage stage = ::openfl::Lib_obj::get_current()->stage;
...
HXDLIN( 276)		this->parent->addChild(hx::ObjectPtr<OBJ_>(this));
            	}
...
HXLINE( 420)		 ::openfl::display::Bitmap _hx_tmp4 = this->_background;
...
void Window_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_437_close)
HXLINE( 438)		this->destroy();
HXLINE( 440)		{
HXLINE( 440)			 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 440)			if (_this->contains(hx::ObjectPtr<OBJ_>(this))) {
HXLINE( 440)				_this->removeChild(hx::ObjectPtr<OBJ_>(this));
            			}
HXDLIN( 440)			{
HXLINE( 440)				::Array< ::Dynamic> array = _this->_windows;
HXDLIN( 440)				int index = array->indexOf(hx::ObjectPtr<OBJ_>(this),null());
HXDLIN( 440)				if ((index != (int)-1)) {
HXLINE( 440)					array[index] = array->__get((array->length - (int)1)).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 440)					array->pop().StaticCast<  ::flixel::_hx_system::debug::Window >();
            				}
            			}
            		}
            	}
