...
HXLINE( 156)			if (::Std_obj::is(Graphic,hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE( 158)				return ::flixel::graphics::FlxGraphic_obj::fromBitmapData(( ( ::openfl::display::BitmapData)(Graphic) ),Unique,Key,null());
            			}
            		}
