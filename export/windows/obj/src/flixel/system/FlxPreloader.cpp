...
HXLINE(  60)			logoLight1->set_width(logoLight1->set_height(_gthis->_height));
HXLINE(  61)			int _gthis1 = _gthis->_width;
HXDLIN(  61)			logoLight1->set_x(((Float)(_gthis1 - logoLight1->get_width()) / (Float)(int)2));
            		}
...
HXDLIN(  52)		_hx_tmp->set_scaleX(this->_buffer->set_scaleY((int)2));
HXLINE(  53)		this->addChild(this->_buffer);
HXLINE(  54)		int _hx_tmp1 = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN(  54)		this->_width = ::Std_obj::_hx_int(((Float)_hx_tmp1 / (Float)this->_buffer->get_scaleX()));
HXLINE(  55)		int _hx_tmp2 = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXDLIN(  55)		this->_height = ::Std_obj::_hx_int(((Float)_hx_tmp2 / (Float)this->_buffer->get_scaleY()));
HXLINE(  56)		 ::openfl::display::Sprite _hx_tmp3 = this->_buffer;
HXDLIN(  56)		_hx_tmp3->addChild( ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,this->_height,false,(int)13406),null(),null()));
...
HXLINE(  65)		this->_bmpBar =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)1,(int)7,false,(int)6253311),null(),null());
HXLINE(  66)		this->_bmpBar->set_x((int)4);
HXLINE(  67)		 ::openfl::display::Bitmap _hx_tmp4 = this->_bmpBar;
HXDLIN(  67)		_hx_tmp4->set_y((this->_height - (int)11));
HXLINE(  68)		this->_buffer->addChild(this->_bmpBar);
HXLINE(  70)		this->_text =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
HXLINE(  71)		 ::openfl::text::TextField _hx_tmp5 = this->_text;
HXDLIN(  71)		_hx_tmp5->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)8,(int)6253311,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
...
HXLINE(  76)		 ::openfl::text::TextField _hx_tmp6 = this->_text;
HXDLIN(  76)		_hx_tmp6->set_y((this->_bmpBar->get_y() - (int)11));
...
HXLINE(  82)		 ::openfl::display::Sprite _hx_tmp7 = this->_logo;
HXDLIN(  82)		 ::openfl::display::Sprite _hx_tmp8 = this->_logo;
HXDLIN(  82)		_hx_tmp7->set_scaleX(_hx_tmp8->set_scaleY((((Float)this->_height / (Float)(int)8) * ((Float)0.04))));
HXLINE(  83)		 ::openfl::display::Sprite _hx_tmp9 = this->_logo;
HXDLIN(  83)		int _hx_tmp10 = this->_width;
HXDLIN(  83)		_hx_tmp9->set_x(((Float)(_hx_tmp10 - this->_logo->get_width()) / (Float)(int)2));
HXLINE(  84)		 ::openfl::display::Sprite _hx_tmp11 = this->_logo;
HXDLIN(  84)		int _hx_tmp12 = this->_height;
HXDLIN(  84)		_hx_tmp11->set_y(((Float)(_hx_tmp12 - this->_logo->get_height()) / (Float)(int)2));
...
HXLINE(  89)		 ::openfl::display::Sprite _hx_tmp13 = this->_logoGlow;
HXDLIN(  89)		 ::openfl::display::Sprite _hx_tmp14 = this->_logoGlow;
HXDLIN(  89)		_hx_tmp13->set_scaleX(_hx_tmp14->set_scaleY((((Float)this->_height / (Float)(int)8) * ((Float)0.04))));
HXLINE(  90)		 ::openfl::display::Sprite _hx_tmp15 = this->_logoGlow;
HXDLIN(  90)		int _hx_tmp16 = this->_width;
HXDLIN(  90)		_hx_tmp15->set_x(((Float)(_hx_tmp16 - this->_logoGlow->get_width()) / (Float)(int)2));
HXLINE(  91)		 ::openfl::display::Sprite _hx_tmp17 = this->_logoGlow;
HXDLIN(  91)		int _hx_tmp18 = this->_height;
HXDLIN(  91)		_hx_tmp17->set_y(((Float)(_hx_tmp18 - this->_logoGlow->get_height()) / (Float)(int)2));
...
HXLINE( 101)		 ::openfl::display::Bitmap bitmap =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,this->_height,false,(int)16777215),null(),null());
HXLINE( 102)		int i = (int)0;
HXLINE( 103)		int j = (int)0;
HXLINE( 104)		while((i < this->_height)){
HXLINE( 106)			j = (int)0;
HXLINE( 107)			while((j < this->_width)){
HXLINE( 109)				 ::openfl::display::BitmapData _hx_tmp19 = bitmap->get_bitmapData();
HXDLIN( 109)				j = (j + (int)1);
HXDLIN( 109)				_hx_tmp19->setPixel((j - (int)1),i,(int)0);
            			}
HXLINE( 111)			i = (i + (int)2);
            		}
...
HXLINE( 144)		 ::openfl::display::Bitmap _hx_tmp = this->_bmpBar;
HXDLIN( 144)		_hx_tmp->set_scaleX((Percent * (this->_width - (int)8)));
HXLINE( 145)		 ::openfl::text::TextField _hx_tmp1 = this->_text;
HXDLIN( 145)		::String _hx_tmp2 = (::Std_obj::string(::flixel::FlxG_obj::VERSION) + HX_(" ",20,00,00,00));
HXDLIN( 145)		_hx_tmp1->set_text(((_hx_tmp2 + ::Std_obj::_hx_int((Percent * (int)100))) + HX_("%",25,00,00,00)));
...
HXLINE( 154)				 ::openfl::display::Sprite _hx_tmp3 = this->_logoGlow;
HXDLIN( 154)				_hx_tmp3->set_alpha(::Math_obj::random());
...
HXLINE( 165)						 ::openfl::display::Sprite _hx_tmp4 = this->_logo;
HXDLIN( 165)						_hx_tmp4->set_alpha(::Math_obj::random());
            					}
            					else {
HXLINE( 167)						if ((Percent < ((Float)0.7))) {
HXLINE( 169)							 ::openfl::display::Sprite _hx_tmp5 = this->_logoGlow;
HXDLIN( 169)							_hx_tmp5->set_alpha(((Float)(Percent - ((Float)0.45)) / (Float)((Float)0.45)));
...
HXLINE( 174)								 ::openfl::display::Sprite _hx_tmp7 = this->_logoGlow;
HXDLIN( 174)								_hx_tmp7->set_alpha(((int)1 - ((Float)(Percent - ((Float)0.8)) / (Float)((Float)0.1))));
HXLINE( 175)								this->_logo->set_alpha((int)0);
            							}
            							else {
HXLINE( 177)								if ((Percent > ((Float)0.9))) {
HXLINE( 179)									 ::openfl::display::Sprite _hx_tmp8 = this->_buffer;
HXDLIN( 179)									_hx_tmp8->set_alpha(((int)1 - ((Float)(Percent - ((Float)0.9)) / (Float)((Float)0.1))));
            								}
            							}
            						}
            					}
...
{
	hx::Object *dummy = new FlxPreloader_obj;
	FlxPreloader_obj::_hx_vtable = *(void **)dummy;
