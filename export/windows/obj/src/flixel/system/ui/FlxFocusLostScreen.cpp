...
HXLINE(  33)		int screenWidth = ::Std_obj::_hx_int(::openfl::Lib_obj::get_current()->stage->stageWidth);
HXLINE(  34)		int screenHeight = ::Std_obj::_hx_int(::openfl::Lib_obj::get_current()->stage->stageHeight);
HXLINE(  37)		gfx->clear();
