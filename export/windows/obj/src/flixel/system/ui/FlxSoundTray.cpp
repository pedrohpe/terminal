...
HXLINE(  56)		 ::openfl::display::Bitmap tmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,(int)30,true,(int)2130706432),null(),null());
HXLINE(  57)		this->screenCenter();
HXLINE(  58)		this->addChild(tmp);
HXLINE(  60)		 ::openfl::text::TextField text =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
