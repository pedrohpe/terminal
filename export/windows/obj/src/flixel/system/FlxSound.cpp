...
HXLINE( 231)			this->_channel->removeEventListener(HX_("soundComplete",a8,30,e6,1c),this->stopped_dyn(),null());
HXLINE( 232)			this->_channel->stop();
HXLINE( 233)			this->_channel = null();
            		}
HXLINE( 236)		if (hx::IsNotNull( this->_sound )) {
HXLINE( 238)			this->_sound->removeEventListener(HX_("id3",f8,03,50,00),this->gotID3_dyn(),null());
...
HXLINE( 279)			this->amplitudeLeft = ((Float)this->_channel->leftPeak / (Float)this->_transform->volume);
HXLINE( 280)			this->amplitudeRight = ((Float)this->_channel->rightPeak / (Float)this->_transform->volume);
...
HXLINE( 290)			_hx_tmp1 = hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
...
HXLINE( 316)		if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::openfl::media::Sound >())) {
HXLINE( 318)			this->_sound = ( ( ::openfl::media::Sound)(EmbeddedSound) );
            		}
            		else {
HXLINE( 320)			if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::hx::Class >())) {
HXLINE( 322)				this->_sound = ( ( ::openfl::media::Sound)(::Type_obj::createInstance(EmbeddedSound,::cpp::VirtualArray_obj::__new(0))) );
            			}
            			else {
HXLINE( 324)				if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >())) {
HXLINE( 326)					bool _hx_tmp;
HXDLIN( 326)					if (!(::openfl::utils::Assets_obj::exists(( (::String)(EmbeddedSound) ),HX_("SOUND",af,c4,ba,fe)))) {
HXLINE( 326)						_hx_tmp = ::openfl::utils::Assets_obj::exists(( (::String)(EmbeddedSound) ),HX_("MUSIC",85,08,49,8e));
            					}
            					else {
HXLINE( 326)						_hx_tmp = true;
            					}
HXDLIN( 326)					if (_hx_tmp) {
HXLINE( 328)						this->_sound = ::openfl::utils::Assets_obj::getSound(( (::String)(EmbeddedSound) ),null());
            					}
            					else {
HXLINE( 330)						 ::Dynamic _hx_tmp1 = ::flixel::FlxG_obj::log->error_dyn();
HXDLIN( 330)						_hx_tmp1(((HX_("Could not find a Sound asset with an ID of '",6f,0e,1e,66) + EmbeddedSound) + HX_("'.",27,22,00,00)));
            					}
            				}
            			}
            		}
...
HXLINE( 350)		this->_sound =  ::openfl::media::Sound_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 351)		this->_sound->addEventListener(HX_("id3",f8,03,50,00),this->gotID3_dyn(),null(),null(),null());
HXLINE( 352)		 ::openfl::media::Sound _hx_tmp = this->_sound;
HXDLIN( 352)		_hx_tmp->load( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,SoundURL),null());
...
HXLINE( 570)			this->_channel->addEventListener(HX_("soundComplete",a8,30,e6,1c),this->stopped_dyn(),null(),null(),null());
...
HXLINE( 617)			this->_channel->removeEventListener(HX_("soundComplete",a8,30,e6,1c),this->stopped_dyn(),null());
...
HXLINE( 638)		this->_sound->removeEventListener(HX_("id3",f8,03,50,00),this->gotID3_dyn(),null());
            	}
