...
HX_DEFINE_STACK_FRAME(_hx_pos_f5ecb515261d8105_105_new,"flixel.system.VirtualInputData","new",0x4566b028,"flixel.system.VirtualInputData.new","lime/_macros/AssetsMacro.hx",105,0xfe246b98)
...
void VirtualInputData_obj::__construct( ::Dynamic __o_length){
 ::Dynamic length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_f5ecb515261d8105_105_new)
HXLINE( 107)		super::__construct(null());
HXLINE( 112)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::VirtualInputData_obj::resourceName);
HXLINE( 113)		this->_hx___fromBytes(bytes);
            	}
