...
HX_LOCAL_STACK_FRAME(_hx_pos_56a8ecc5c2b3800c_95_subarray,"lime.utils._UInt8Array.UInt8Array_Impl_","subarray",0x5b71e6e2,"lime.utils._UInt8Array.UInt8Array_Impl_.subarray","lime/utils/UInt8Array.hx",95,0x1e0ae96b)
HX_LOCAL_STACK_FRAME(_hx_pos_56a8ecc5c2b3800c_100_fromBytes,"lime.utils._UInt8Array.UInt8Array_Impl_","fromBytes",0x90b0cfb8,"lime.utils._UInt8Array.UInt8Array_Impl_.fromBytes","lime/utils/UInt8Array.hx",100,0x1e0ae96b)
HX_LOCAL_STACK_FRAME(_hx_pos_56a8ecc5c2b3800c_104_toBytes,"lime.utils._UInt8Array.UInt8Array_Impl_","toBytes",0xcd11ee47,"lime.utils._UInt8Array.UInt8Array_Impl_.toBytes","lime/utils/UInt8Array.hx",104,0x1e0ae96b)
HX_LOCAL_STACK_FRAME(_hx_pos_56a8ecc5c2b3800c_109_toString,"lime.utils._UInt8Array.UInt8Array_Impl_","toString",0x8c5f6375,"lime.utils._UInt8Array.UInt8Array_Impl_.toString","lime/utils/UInt8Array.hx",109,0x1e0ae96b)
HX_LOCAL_STACK_FRAME(_hx_pos_56a8ecc5c2b3800c_111_get_length,"lime.utils._UInt8Array.UInt8Array_Impl_","get_length",0x2ee09bb8,"lime.utils._UInt8Array.UInt8Array_Impl_.get_length","lime/utils/UInt8Array.hx",111,0x1e0ae96b)
HX_LOCAL_STACK_FRAME(_hx_pos_56a8ecc5c2b3800c_65_boot,"lime.utils._UInt8Array.UInt8Array_Impl_","boot",0xada6be7b,"lime.utils._UInt8Array.UInt8Array_Impl_.boot","lime/utils/UInt8Array.hx",65,0x1e0ae96b)
namespace lime{
namespace utils{
...
int UInt8Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView UInt8Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_56a8ecc5c2b3800c_95_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt8Array_Impl__obj,subarray,return )
 ...
 ::Dynamic byteOffset = __o_byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_56a8ecc5c2b3800c_100_fromBytes)
HXDLIN( 100)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 100)		if (hx::IsNotNull( bytes )) {
HXDLIN( 100)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN( 100)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt8Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes UInt8Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_56a8ecc5c2b3800c_104_toBytes)
...
::String UInt8Array_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_56a8ecc5c2b3800c_109_toString)
HXDLIN( 109)		if (hx::IsNotNull( this1 )) {
HXDLIN( 109)			return ((((HX_("UInt8Array [byteLength:",d6,2f,a0,d4) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
int UInt8Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_56a8ecc5c2b3800c_111_get_length)
HXDLIN( 111)		return this1->length;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_56a8ecc5c2b3800c_65_boot)
HXDLIN(  65)		BYTES_PER_ELEMENT = (int)1;
            	}
}
