...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b2b432f378b5e1_95_subarray,"lime.utils._UInt32Array.UInt32Array_Impl_","subarray",0x0de4225e,"lime.utils._UInt32Array.UInt32Array_Impl_.subarray","lime/utils/UInt32Array.hx",95,0x471a2476)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b2b432f378b5e1_100_fromBytes,"lime.utils._UInt32Array.UInt32Array_Impl_","fromBytes",0x0232a0bc,"lime.utils._UInt32Array.UInt32Array_Impl_.fromBytes","lime/utils/UInt32Array.hx",100,0x471a2476)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b2b432f378b5e1_104_toBytes,"lime.utils._UInt32Array.UInt32Array_Impl_","toBytes",0x7fceb64b,"lime.utils._UInt32Array.UInt32Array_Impl_.toBytes","lime/utils/UInt32Array.hx",104,0x471a2476)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b2b432f378b5e1_109_get_length,"lime.utils._UInt32Array.UInt32Array_Impl_","get_length",0x0ef5ae34,"lime.utils._UInt32Array.UInt32Array_Impl_.get_length","lime/utils/UInt32Array.hx",109,0x471a2476)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b2b432f378b5e1_125_toString,"lime.utils._UInt32Array.UInt32Array_Impl_","toString",0x3ed19ef1,"lime.utils._UInt32Array.UInt32Array_Impl_.toString","lime/utils/UInt32Array.hx",125,0x471a2476)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b2b432f378b5e1_65_boot,"lime.utils._UInt32Array.UInt32Array_Impl_","boot",0x5dfe8bf7,"lime.utils._UInt32Array.UInt32Array_Impl_.boot","lime/utils/UInt32Array.hx",65,0x471a2476)
namespace lime{
namespace utils{
...
int UInt32Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView UInt32Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_d6b2b432f378b5e1_95_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt32Array_Impl__obj,subarray,return )
 ...
 ::Dynamic byteOffset = __o_byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_d6b2b432f378b5e1_100_fromBytes)
HXDLIN( 100)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 100)		if (hx::IsNotNull( bytes )) {
HXDLIN( 100)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)7);
...
HXDLIN( 100)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt32Array",10,43,eb,8e));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt32Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes UInt32Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_d6b2b432f378b5e1_104_toBytes)
...
int UInt32Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_d6b2b432f378b5e1_109_get_length)
...
::String UInt32Array_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_d6b2b432f378b5e1_125_toString)
HXDLIN( 125)		if (hx::IsNotNull( this1 )) {
HXDLIN( 125)			return ((((HX_("UInt32Array [byteLength:",f1,11,ee,ed) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_d6b2b432f378b5e1_65_boot)
HXDLIN(  65)		BYTES_PER_ELEMENT = (int)4;
            	}
}
