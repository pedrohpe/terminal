...
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_95_subarray,"lime.utils._Float64Array.Float64Array_Impl_","subarray",0x21ecbb22,"lime.utils._Float64Array.Float64Array_Impl_.subarray","lime/utils/Float64Array.hx",95,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_100_fromBytes,"lime.utils._Float64Array.Float64Array_Impl_","fromBytes",0x75afb378,"lime.utils._Float64Array.Float64Array_Impl_.fromBytes","lime/utils/Float64Array.hx",100,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_104_toBytes,"lime.utils._Float64Array.Float64Array_Impl_","toBytes",0xdbbc6207,"lime.utils._Float64Array.Float64Array_Impl_.toBytes","lime/utils/Float64Array.hx",104,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_109_get_length,"lime.utils._Float64Array.Float64Array_Impl_","get_length",0xa8e8fff8,"lime.utils._Float64Array.Float64Array_Impl_.get_length","lime/utils/Float64Array.hx",109,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_125_toString,"lime.utils._Float64Array.Float64Array_Impl_","toString",0x52da37b5,"lime.utils._Float64Array.Float64Array_Impl_.toString","lime/utils/Float64Array.hx",125,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_65_boot,"lime.utils._Float64Array.Float64Array_Impl_","boot",0x289272bb,"lime.utils._Float64Array.Float64Array_Impl_.boot","lime/utils/Float64Array.hx",65,0x73d83bc7)
namespace lime{
namespace utils{
...
int Float64Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView Float64Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_8b7b048dadc59c63_95_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Float64Array_Impl__obj,subarray,return )
 ...
 ::Dynamic byteOffset = __o_byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_8b7b048dadc59c63_100_fromBytes)
HXDLIN( 100)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 100)		if (hx::IsNotNull( bytes )) {
HXDLIN( 100)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)9);
...
HXDLIN( 100)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float64Array",8f,de,6b,1e));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Float64Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes Float64Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_104_toBytes)
...
int Float64Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_109_get_length)
...
::String Float64Array_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_125_toString)
HXDLIN( 125)		if (hx::IsNotNull( this1 )) {
HXDLIN( 125)			return ((((HX_("Float64Array [byteLength:",32,73,38,ac) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_65_boot)
HXDLIN(  65)		BYTES_PER_ELEMENT = (int)8;
            	}
}
