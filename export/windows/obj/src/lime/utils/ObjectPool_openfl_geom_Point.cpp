...
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_60_add,"lime.utils.ObjectPool_openfl_geom_Point","add",0xd507e961,"lime.utils.ObjectPool_openfl_geom_Point.add","lime/utils/ObjectPool.hx",60,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_71___default_clean,"lime.utils.ObjectPool_openfl_geom_Point","__default_clean",0x374d286b,"lime.utils.ObjectPool_openfl_geom_Point.__default_clean","lime/utils/ObjectPool.hx",71,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_78_clear,"lime.utils.ObjectPool_openfl_geom_Point","clear",0x41f5b8cd,"lime.utils.ObjectPool_openfl_geom_Point.clear","lime/utils/ObjectPool.hx",78,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_94___default_create,"lime.utils.ObjectPool_openfl_geom_Point","__default_create",0xa09db5da,"lime.utils.ObjectPool_openfl_geom_Point.__default_create","lime/utils/ObjectPool.hx",94,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_99_get,"lime.utils.ObjectPool_openfl_geom_Point","get",0xd50c77d6,"lime.utils.ObjectPool_openfl_geom_Point.get","lime/utils/ObjectPool.hx",99,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_125_release,"lime.utils.ObjectPool_openfl_geom_Point","release",0xa3181d07,"lime.utils.ObjectPool_openfl_geom_Point.release","lime/utils/ObjectPool.hx",125,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_155___addInactive,"lime.utils.ObjectPool_openfl_geom_Point","__addInactive",0xb81816cc,"lime.utils.ObjectPool_openfl_geom_Point.__addInactive","lime/utils/ObjectPool.hx",155,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_180___getInactive,"lime.utils.ObjectPool_openfl_geom_Point","__getInactive",0xacafa241,"lime.utils.ObjectPool_openfl_geom_Point.__getInactive","lime/utils/ObjectPool.hx",180,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_224___removeInactive,"lime.utils.ObjectPool_openfl_geom_Point","__removeInactive",0x88ae5faf,"lime.utils.ObjectPool_openfl_geom_Point.__removeInactive","lime/utils/ObjectPool.hx",224,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_273_get_size,"lime.utils.ObjectPool_openfl_geom_Point","get_size",0x67281d0a,"lime.utils.ObjectPool_openfl_geom_Point.get_size","lime/utils/ObjectPool.hx",273,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_278_set_size,"lime.utils.ObjectPool_openfl_geom_Point","set_size",0x1585767e,"lime.utils.ObjectPool_openfl_geom_Point.set_size","lime/utils/ObjectPool.hx",278,0xc114d76b)
namespace lime{
namespace utils{
...
void ObjectPool_openfl_geom_Point_obj::add( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_60_add)
...
void _hx_run( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_71___default_clean)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

void ObjectPool_openfl_geom_Point_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_68de5308f7101ccb_78_clear)
...
HX_BEGIN_DEFAULT_FUNC(__default_create,ObjectPool_openfl_geom_Point_obj)
 ::openfl::geom::Point _hx_run(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_94___default_create)
...
HX_END_DEFAULT_FUNC
 ...
 ::openfl::geom::Point ObjectPool_openfl_geom_Point_obj::get(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_99_get)
HXLINE( 101)		 ::openfl::geom::Point object = null();
HXLINE( 103)		if ((this->inactiveObjects > (int)0)) {
HXLINE( 105)			 ::openfl::geom::Point object1 = null();
...
HXLINE( 105)					object1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
HXDLIN( 105)					if ((this->_hx___inactiveObjectList->length > (int)0)) {
HXLINE( 105)						this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
            					}
HXDLIN( 105)					if ((this->_hx___inactiveObjectList->length > (int)0)) {
HXLINE( 105)						this->_hx___inactiveObject1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
            					}
            				}
            			}
...
HXLINE( 109)				object = ( ( ::openfl::geom::Point)(this->create()) );
...
void ObjectPool_openfl_geom_Point_obj::release( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_125_release)
...
void ObjectPool_openfl_geom_Point_obj::_hx___addInactive( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_155___addInactive)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Point_obj,_hx___addInactive,(void))
 ...
 ::openfl::geom::Point ObjectPool_openfl_geom_Point_obj::_hx___getInactive(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_180___getInactive)
HXLINE( 182)		 ::openfl::geom::Point object = null();
...
HXLINE( 196)				object = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
HXLINE( 198)				if ((this->_hx___inactiveObjectList->length > (int)0)) {
HXLINE( 200)					this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
            				}
HXLINE( 204)				if ((this->_hx___inactiveObjectList->length > (int)0)) {
HXLINE( 206)					this->_hx___inactiveObject1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
            				}
            			}
            		}
...
void ObjectPool_openfl_geom_Point_obj::_hx___removeInactive(int count){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_224___removeInactive)
...
HXLINE( 250)				 ::openfl::geom::Point val = ( ( ::openfl::geom::Point)(_g_head->item) );
HXDLIN( 250)				_g_head = _g_head->next;
HXDLIN( 250)				 ::openfl::geom::Point object = val;
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Point_obj,_hx___removeInactive,(void))
 ...
 ::Dynamic ObjectPool_openfl_geom_Point_obj::get_size(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_273_get_size)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectPool_openfl_geom_Point_obj,get_size,return )
 ...
 ::Dynamic ObjectPool_openfl_geom_Point_obj::set_size( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_278_set_size)
...
HXLINE( 295)					 ::openfl::geom::Point object;
HXLINE( 297)					{
...
HXLINE( 299)							object = ( ( ::openfl::geom::Point)(this->create()) );
