...
HXLINE(  71)		this->backend =  ::lime::_backend::native::NativeHTTPRequest_obj::__alloc( HX_CTX );
HXLINE(  72)		this->backend->init(hx::ObjectPtr<OBJ_>(this));
            	}
