...
HX_DEFINE_STACK_FRAME(_hx_pos_cf7dae7cab1a2f06_161_new,"lime.net._HTTPRequest_String","new",0x883ccdf0,"lime.net._HTTPRequest_String.new","lime/net/HTTPRequest.hx",161,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_cf7dae7cab1a2f06_180_load,"lime.net._HTTPRequest_String","load",0xabac7a96,"lime.net._HTTPRequest_String.load","lime/net/HTTPRequest.hx",180,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_cf7dae7cab1a2f06_166_load,"lime.net._HTTPRequest_String","load",0xabac7a96,"lime.net._HTTPRequest_String.load","lime/net/HTTPRequest.hx",166,0x339db723)
namespace lime{
namespace net{

void _HTTPRequest_String_obj::__construct(::String uri){
            	HX_STACKFRAME(&_hx_pos_cf7dae7cab1a2f06_161_new)
HXDLIN( 161)		super::__construct(uri);
            	}
...
bool _HTTPRequest_String_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Future _HTTPRequest_String_obj::load(::String uri){
            		...
            		void _hx_run(::String text){
            			HX_GC_STACKFRAME(&_hx_pos_cf7dae7cab1a2f06_180_load)
HXLINE( 182)			_gthis->responseData = text;
HXLINE( 183)			promise->complete(_gthis->responseData);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_cf7dae7cab1a2f06_166_load)
HXDLIN( 166)		 ::lime::net::_HTTPRequest_String _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 168)		if (hx::IsNotNull( uri )) {
HXLINE( 170)			this->uri = uri;
            		}
HXLINE( 174)		 ::lime::app::Promise promise =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 175)		 ::lime::app::Future future = this->backend->loadText(this->uri);
HXLINE( 177)		future->onProgress(promise->progress_dyn());
HXLINE( 178)		future->onError(promise->error_dyn());
HXLINE( 180)		future->onComplete( ::Dynamic(new _hx_Closure_0(_gthis,promise)));
HXLINE( 187)		return promise->future;
            	}
