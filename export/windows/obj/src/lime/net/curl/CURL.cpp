...
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_71_escape,"lime.net.curl.CURL","escape",0x44306d6b,"lime.net.curl.CURL.escape","lime/net/curl/CURL.hx",71,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_93_getInfo,"lime.net.curl.CURL","getInfo",0xda4c6afa,"lime.net.curl.CURL.getInfo","lime/net/curl/CURL.hx",93,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_124_pause,"lime.net.curl.CURL","pause",0x95a2d84c,"lime.net.curl.CURL.pause","lime/net/curl/CURL.hx",124,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_135_perform,"lime.net.curl.CURL","perform",0x3cec6b77,"lime.net.curl.CURL.perform","lime/net/curl/CURL.hx",135,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_157_reset,"lime.net.curl.CURL","reset",0xbf134b25,"lime.net.curl.CURL.reset","lime/net/curl/CURL.hx",157,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_177_setOption,"lime.net.curl.CURL","setOption",0xcff7ad0d,"lime.net.curl.CURL.setOption","lime/net/curl/CURL.hx",177,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_213_unescape,"lime.net.curl.CURL","unescape",0xe7c56b04,"lime.net.curl.CURL.unescape","lime/net/curl/CURL.hx",213,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_82_getDate,"lime.net.curl.CURL","getDate",0xd6f488ba,"lime.net.curl.CURL.getDate","lime/net/curl/CURL.hx",82,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_104_globalCleanup,"lime.net.curl.CURL","globalCleanup",0x3b488c57,"lime.net.curl.CURL.globalCleanup","lime/net/curl/CURL.hx",104,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_113_globalInit,"lime.net.curl.CURL","globalInit",0x3240ecfd,"lime.net.curl.CURL.globalInit","lime/net/curl/CURL.hx",113,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_202_strerror,"lime.net.curl.CURL","strerror",0x9bdff9e1,"lime.net.curl.CURL.strerror","lime/net/curl/CURL.hx",202,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_224_version,"lime.net.curl.CURL","version",0x3f0069ee,"lime.net.curl.CURL.version","lime/net/curl/CURL.hx",224,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_235_versionInfo,"lime.net.curl.CURL","versionInfo",0x0bdb5d7c,"lime.net.curl.CURL.versionInfo","lime/net/curl/CURL.hx",235,0x82d3899b)
...
HXLINE(  40)			this->handle = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_init()) );
            		}
            	}
...
HXDLIN(  51)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_cleanup(hx::DynamicPtr(this->handle));
            	}
...
HXDLIN(  60)		return  ::lime::net::curl::CURL_obj::__alloc( HX_CTX ,( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_duphandle(hx::DynamicPtr(this->handle))) ));
            	}
...
::String CURL_obj::escape(::String url,int length){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_71_escape)
HXDLIN(  71)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_escape(hx::DynamicPtr(this->handle),url,length)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(CURL_obj,escape,return )
 ...
 ::Dynamic CURL_obj::getInfo(int info){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_93_getInfo)
HXDLIN(  93)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_getinfo(hx::DynamicPtr(this->handle),info)) );
            	}
...
int CURL_obj::pause(int bitMask){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_124_pause)
HXDLIN( 124)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_pause(hx::DynamicPtr(this->handle),bitMask);
            	}
...
int CURL_obj::perform(){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_135_perform)
HXDLIN( 135)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_perform(hx::DynamicPtr(this->handle));
            	}
...
void CURL_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_157_reset)
HXDLIN( 157)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_reset(hx::DynamicPtr(this->handle));
            	}
...
int CURL_obj::setOption(int option, ::Dynamic parameter){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_177_setOption)
HXDLIN( 177)		if ((option == (int)20011)) {
HXLINE( 179)			if (hx::IsNull( this->writeBytes )) {
HXLINE( 179)				this->writeBytes = ::haxe::io::Bytes_obj::alloc((int)1024);
            			}
HXLINE( 180)			return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_setopt(hx::DynamicPtr(this->handle),option,hx::DynamicPtr(parameter),hx::DynamicPtr(this->writeBytes));
            		}
            		else {
HXLINE( 182)			if ((option == (int)20079)) {
HXLINE( 184)				if (hx::IsNull( this->headerBytes )) {
HXLINE( 184)					this->headerBytes = ::haxe::io::Bytes_obj::alloc((int)1024);
            				}
HXLINE( 185)				return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_setopt(hx::DynamicPtr(this->handle),option,hx::DynamicPtr(parameter),hx::DynamicPtr(this->headerBytes));
            			}
            			else {
HXLINE( 189)				return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_setopt(hx::DynamicPtr(this->handle),option,hx::DynamicPtr(parameter),hx::DynamicPtr(null()));
            			}
            		}
...
::String CURL_obj::unescape(::String url,int inLength,int outLength){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_213_unescape)
HXDLIN( 213)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_unescape(hx::DynamicPtr(this->handle),url,inLength,outLength)) );
            	}
...
int CURL_obj::getDate(::String date,int now){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_82_getDate)
HXDLIN(  82)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_getdate(date,now);
            	}
...
void CURL_obj::globalCleanup(){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_104_globalCleanup)
HXDLIN( 104)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_global_cleanup();
            	}
...
int CURL_obj::globalInit(int flags){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_113_globalInit)
HXDLIN( 113)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_global_init(flags);
            	}
...
::String CURL_obj::strerror(int code){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_202_strerror)
HXDLIN( 202)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_strerror(code)) );
            	}
...
::String CURL_obj::version(){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_224_version)
HXDLIN( 224)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_version()) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(CURL_obj,version,return )
 ...
 ::Dynamic CURL_obj::versionInfo(int type){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_235_versionInfo)
HXDLIN( 235)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_version_info(type)) );
            	}
