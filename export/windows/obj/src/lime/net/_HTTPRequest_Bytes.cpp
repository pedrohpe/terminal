...
HX_DEFINE_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_110_new,"lime.net._HTTPRequest_Bytes","new",0xc45547d0,"lime.net._HTTPRequest_Bytes.new","lime/net/HTTPRequest.hx",110,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_117_fromBytes,"lime.net._HTTPRequest_Bytes","fromBytes",0x58799e11,"lime.net._HTTPRequest_Bytes.fromBytes","lime/net/HTTPRequest.hx",117,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_136_load,"lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",136,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_122_load,"lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",122,0x339db723)
namespace lime{
namespace net{

void _HTTPRequest_Bytes_obj::__construct(::String uri){
            	HX_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_110_new)
HXDLIN( 110)		super::__construct(uri);
            	}
...
bool _HTTPRequest_Bytes_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_Bytes_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_117_fromBytes)
HXDLIN( 117)		return bytes;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(_HTTPRequest_Bytes_obj,fromBytes,return )
 ...
 ::lime::app::Future _HTTPRequest_Bytes_obj::load(::String uri){
            		...
            		void _hx_run( ::haxe::io::Bytes bytes){
            			HX_GC_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_136_load)
HXLINE( 138)			_gthis->responseData = _gthis->fromBytes(bytes);
HXLINE( 139)			promise->complete(_gthis->responseData);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_122_load)
HXDLIN( 122)		 ::lime::net::_HTTPRequest_Bytes _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 124)		if (hx::IsNotNull( uri )) {
HXLINE( 126)			this->uri = uri;
            		}
HXLINE( 130)		 ::lime::app::Promise promise =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 131)		 ::lime::app::Future future = this->backend->loadData(this->uri,null());
HXLINE( 133)		future->onProgress(promise->progress_dyn());
HXLINE( 134)		future->onError(promise->error_dyn());
HXLINE( 136)		future->onComplete( ::Dynamic(new _hx_Closure_0(_gthis,promise)));
HXLINE( 143)		return promise->future;
            	}
