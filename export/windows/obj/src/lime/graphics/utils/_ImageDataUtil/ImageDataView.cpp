...
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1582_new,"lime.graphics.utils._ImageDataUtil.ImageDataView","new",0xaa0478bd,"lime.graphics.utils._ImageDataUtil.ImageDataView.new","lime/graphics/utils/ImageDataUtil.hx",1582,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1609_clip,"lime.graphics.utils._ImageDataUtil.ImageDataView","clip",0x12a517d3,"lime.graphics.utils._ImageDataUtil.ImageDataView.clip","lime/graphics/utils/ImageDataUtil.hx",1609,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1619_hasRow,"lime.graphics.utils._ImageDataUtil.ImageDataView","hasRow",0x88df1ea3,"lime.graphics.utils._ImageDataUtil.ImageDataView.hasRow","lime/graphics/utils/ImageDataUtil.hx",1619,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1624_offset,"lime.graphics.utils._ImageDataUtil.ImageDataView","offset",0x2de0c756,"lime.graphics.utils._ImageDataUtil.ImageDataView.offset","lime/graphics/utils/ImageDataUtil.hx",1624,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1657_row,"lime.graphics.utils._ImageDataUtil.ImageDataView","row",0xaa078a77,"lime.graphics.utils._ImageDataUtil.ImageDataView.row","lime/graphics/utils/ImageDataUtil.hx",1657,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1662___update,"lime.graphics.utils._ImageDataUtil.ImageDataView","__update",0x8b53d7ac,"lime.graphics.utils._ImageDataUtil.ImageDataView.__update","lime/graphics/utils/ImageDataUtil.hx",1662,0x494d921f)
namespace lime{
namespace graphics{
namespace utils{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1582_new)
HXLINE(1584)		this->image = image;
HXLINE(1586)		if (hx::IsNull( rect )) {
HXLINE(1588)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1592)			if ((rect->x < (int)0)) {
HXLINE(1592)				rect->x = (int)0;
            			}
HXLINE(1593)			if ((rect->y < (int)0)) {
HXLINE(1593)				rect->y = (int)0;
            			}
HXLINE(1594)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1594)				rect->width = (image->width - rect->x);
            			}
HXLINE(1595)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1595)				rect->height = (image->height - rect->y);
            			}
HXLINE(1596)			if ((rect->width < (int)0)) {
HXLINE(1596)				rect->width = (int)0;
            			}
HXLINE(1597)			if ((rect->height < (int)0)) {
HXLINE(1597)				rect->height = (int)0;
            			}
HXLINE(1598)			this->rect = rect;
            		}
HXLINE(1602)		this->stride = image->buffer->get_stride();
HXLINE(1604)		this->_hx___update();
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1609_clip)
HXLINE(1611)		this->rect->_hx___contract(x,y,width,height);
HXLINE(1612)		this->_hx___update();
            	}
...
bool ImageDataView_obj::hasRow(int y){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1619_hasRow)
HXDLIN(1619)		if ((y >= (int)0)) {
HXDLIN(1619)			return (y < this->height);
            		}
            		else {
HXDLIN(1619)			return false;
            		}
HXDLIN(1619)		return false;
            	}
...
void ImageDataView_obj::offset(int x,int y){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1624_offset)
HXLINE(1626)		if ((x < (int)0)) {
HXLINE(1628)			 ::lime::math::Rectangle _hx_tmp = this->rect;
HXDLIN(1628)			_hx_tmp->x = (_hx_tmp->x + x);
HXLINE(1629)			if ((this->rect->x < (int)0)) {
HXLINE(1629)				this->rect->x = (int)0;
            			}
            		}
            		else {
HXLINE(1633)			 ::lime::math::Rectangle _hx_tmp1 = this->rect;
HXDLIN(1633)			_hx_tmp1->x = (_hx_tmp1->x + x);
HXLINE(1634)			 ::lime::math::Rectangle _hx_tmp2 = this->rect;
HXDLIN(1634)			_hx_tmp2->width = (_hx_tmp2->width - x);
            		}
HXLINE(1638)		if ((y < (int)0)) {
HXLINE(1640)			 ::lime::math::Rectangle _hx_tmp3 = this->rect;
HXDLIN(1640)			_hx_tmp3->y = (_hx_tmp3->y + y);
HXLINE(1641)			if ((this->rect->y < (int)0)) {
HXLINE(1641)				this->rect->y = (int)0;
            			}
            		}
            		else {
HXLINE(1645)			 ::lime::math::Rectangle _hx_tmp4 = this->rect;
HXDLIN(1645)			_hx_tmp4->y = (_hx_tmp4->y + y);
HXLINE(1646)			 ::lime::math::Rectangle _hx_tmp5 = this->rect;
HXDLIN(1646)			_hx_tmp5->height = (_hx_tmp5->height - y);
            		}
HXLINE(1650)		this->_hx___update();
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1657_row)
HXDLIN(1657)		int _hx_tmp = this->byteOffset;
HXDLIN(1657)		return (_hx_tmp + (this->stride * y));
            	}
...
void ImageDataView_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1662___update)
HXLINE(1664)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1665)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1666)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1667)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1668)		int _hx_tmp = this->stride;
HXDLIN(1668)		int _hx_tmp1 = (_hx_tmp * (this->y + this->image->offsetY));
HXDLIN(1668)		this->byteOffset = (_hx_tmp1 + ((this->x + this->image->offsetX) * (int)4));
            	}
