...
HX_DEFINE_STACK_FRAME(_hx_pos_241b089bf20ccbef_267_new,"lime.system.JNIStaticField","new",0x799b0c1f,"lime.system.JNIStaticField.new","lime/system/JNI.hx",267,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_241b089bf20ccbef_277_get,"lime.system.JNIStaticField","get",0x7995bc55,"lime.system.JNIStaticField.get","lime/system/JNI.hx",277,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_241b089bf20ccbef_288_set,"lime.system.JNIStaticField","set",0x799ed761,"lime.system.JNIStaticField.set","lime/system/JNI.hx",288,0x21970b7f)
namespace lime{
namespace _hx_system{

void JNIStaticField_obj::__construct( ::Dynamic field){
            	HX_STACKFRAME(&_hx_pos_241b089bf20ccbef_267_new)
HXDLIN( 267)		this->field = field;
            	}
...
bool JNIStaticField_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIStaticField_obj::get(){
            	HX_STACKFRAME(&_hx_pos_241b089bf20ccbef_277_get)
...
HX_DEFINE_DYNAMIC_FUNC0(JNIStaticField_obj,get,return )
 ...
 ::Dynamic JNIStaticField_obj::set( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_241b089bf20ccbef_288_set)
HXDLIN( 288)		return value;
            	}
