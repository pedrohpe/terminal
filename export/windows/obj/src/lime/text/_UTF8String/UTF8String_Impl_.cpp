...
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_175_substr,"lime.text._UTF8String.UTF8String_Impl_","substr",0xdf55a5e8,"lime.text._UTF8String.UTF8String_Impl_.substr","lime/text/UTF8String.hx",175,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_203_substring,"lime.text._UTF8String.UTF8String_Impl_","substring",0x4da907fa,"lime.text._UTF8String.UTF8String_Impl_.substring","lime/text/UTF8String.hx",203,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_213_toLowerCase,"lime.text._UTF8String.UTF8String_Impl_","toLowerCase",0x25d4de3f,"lime.text._UTF8String.UTF8String_Impl_.toLowerCase","lime/text/UTF8String.hx",213,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_248_toString,"lime.text._UTF8String.UTF8String_Impl_","toString",0x6edde323,"lime.text._UTF8String.UTF8String_Impl_.toString","lime/text/UTF8String.hx",248,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_258_toUpperCase,"lime.text._UTF8String.UTF8String_Impl_","toUpperCase",0xa66dc220,"lime.text._UTF8String.UTF8String_Impl_.toUpperCase","lime/text/UTF8String.hx",258,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_288_equals,"lime.text._UTF8String.UTF8String_Impl_","equals",0x053da4f6,"lime.text._UTF8String.UTF8String_Impl_.equals","lime/text/UTF8String.hx",288,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_296_lt,"lime.text._UTF8String.UTF8String_Impl_","lt",0xf7edadbf,"lime.text._UTF8String.UTF8String_Impl_.lt","lime/text/UTF8String.hx",296,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_305_gt,"lime.text._UTF8String.UTF8String_Impl_","gt",0xf7eda964,"lime.text._UTF8String.UTF8String_Impl_.gt","lime/text/UTF8String.hx",305,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_314_lteq,"lime.text._UTF8String.UTF8String_Impl_","lteq",0x110433eb,"lime.text._UTF8String.UTF8String_Impl_.lteq","lime/text/UTF8String.hx",314,0xa2cd54d4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_332_plus,"lime.text._UTF8String.UTF8String_Impl_","plus",0x13a30a51,"lime.text._UTF8String.UTF8String_Impl_.plus","lime/text/UTF8String.hx",332,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_348_fromDynamic,"lime.text._UTF8String.UTF8String_Impl_","fromDynamic",0x3bc6951e,"lime.text._UTF8String.UTF8String_Impl_.fromDynamic","lime/text/UTF8String.hx",348,0xa2cd54d4)
HX_LOCAL_STACK_FRAME(_hx_pos_980e6fae9dc7df30_362_get_length,"lime.text._UTF8String.UTF8String_Impl_","get_length",0x8dc0e2e6,"lime.text._UTF8String.UTF8String_Impl_.get_length","lime/text/UTF8String.hx",362,0xa2cd54d4)
namespace lime{
namespace text{
...
::String UTF8String_Impl__obj::substr(::String this1,int pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_175_substr)
HXLINE( 177)		if (hx::IsNull( len )) {
HXLINE( 179)			len = (::lime::text::_UTF8String::UTF8String_Impl__obj::get_length(this1) - pos);
            		}
HXLINE( 183)		return ::haxe::Utf8_obj::sub(this1,pos,len);
            	}
...
::String UTF8String_Impl__obj::substring(::String this1,int startIndex, ::Dynamic endIndex){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_203_substring)
HXDLIN( 203)		int si;
HXDLIN( 203)		if ((startIndex < (int)0)) {
HXDLIN( 203)			si = (int)0;
            		}
            		else {
HXDLIN( 203)			::String this2 = this1;
HXDLIN( 203)			::String this3 = this2;
HXDLIN( 203)			::String this4 = this3;
HXDLIN( 203)			if ((startIndex >= (int)0)) {
HXDLIN( 203)				int index = (int)0;
HXDLIN( 203)				int len = this4.length;
HXDLIN( 203)				int i = (int)0;
HXDLIN( 203)				while(true){
HXDLIN( 203)					bool si1;
HXDLIN( 203)					if ((i < startIndex)) {
HXDLIN( 203)						si1 = (index < len);
            					}
            					else {
HXDLIN( 203)						si1 = false;
            					}
HXDLIN( 203)					if (!(si1)) {
HXDLIN( 203)						goto _hx_goto_15;
            					}
HXDLIN( 203)					int c = this4.cca(index);
HXDLIN( 203)					int index1;
HXDLIN( 203)					if ((c < (int)192)) {
HXDLIN( 203)						index1 = (int)1;
            					}
            					else {
HXDLIN( 203)						if ((c < (int)224)) {
HXDLIN( 203)							index1 = (int)2;
            						}
            						else {
HXDLIN( 203)							if ((c < (int)240)) {
HXDLIN( 203)								index1 = (int)3;
            							}
            							else {
HXDLIN( 203)								if ((c < (int)248)) {
HXDLIN( 203)									index1 = (int)4;
            								}
            								else {
HXDLIN( 203)									index1 = (int)1;
            								}
...
HXDLIN( 203)					index = (index + index1);
HXDLIN( 203)					i = (i + (int)1);
            				}
            				_hx_goto_15:;
HXDLIN( 203)				si = index;
            			}
            			else {
HXDLIN( 203)				int index2 = (int)0;
HXDLIN( 203)				int count = (int)0;
HXDLIN( 203)				while(true){
HXDLIN( 203)					bool si2;
HXDLIN( 203)					if ((count < -(startIndex))) {
HXDLIN( 203)						si2 = ((int)0 < index2);
            					}
            					else {
HXDLIN( 203)						si2 = false;
            					}
HXDLIN( 203)					if (!(si2)) {
HXDLIN( 203)						goto _hx_goto_16;
            					}
HXDLIN( 203)					::String this5 = this4;
HXDLIN( 203)					::String this6 = this5;
HXDLIN( 203)					int c1 = this6.cca((index2 - (int)1));
HXDLIN( 203)					int index3;
HXDLIN( 203)					bool index4;
HXDLIN( 203)					if ((c1 >= (int)128)) {
HXDLIN( 203)						index4 = (c1 >= (int)192);
            					}
            					else {
HXDLIN( 203)						index4 = true;
            					}
HXDLIN( 203)					if (index4) {
HXDLIN( 203)						index3 = (int)1;
            					}
            					else {
HXDLIN( 203)						::String this7 = this5;
HXDLIN( 203)						if ((((int)this7.cca((index2 - (int)2)) & (int)(int)224) == (int)192)) {
HXDLIN( 203)							index3 = (int)2;
            						}
            						else {
HXDLIN( 203)							::String this8 = this5;
HXDLIN( 203)							if ((((int)this8.cca((index2 - (int)3)) & (int)(int)240) == (int)224)) {
HXDLIN( 203)								index3 = (int)3;
            							}
            							else {
HXDLIN( 203)								::String this9 = this5;
HXDLIN( 203)								if ((((int)this9.cca((index2 - (int)4)) & (int)(int)248) == (int)240)) {
HXDLIN( 203)									index3 = (int)4;
            								}
            								else {
HXDLIN( 203)									index3 = (int)1;
            								}
...
HXDLIN( 203)					index2 = (index2 - index3);
HXDLIN( 203)					count = (count + (int)1);
            				}
            				_hx_goto_16:;
HXDLIN( 203)				si = index2;
            			}
            		}
HXDLIN( 203)		int ei;
HXDLIN( 203)		if (hx::IsNull( endIndex )) {
HXDLIN( 203)			ei = this1.length;
            		}
            		else {
HXDLIN( 203)			if (hx::IsLess( endIndex,(int)0 )) {
HXDLIN( 203)				ei = (int)0;
            			}
            			else {
HXDLIN( 203)				int codePointOffset = endIndex;
HXDLIN( 203)				::String this10 = this1;
HXDLIN( 203)				::String this11 = this10;
HXDLIN( 203)				::String this12 = this11;
HXDLIN( 203)				if ((codePointOffset >= (int)0)) {
HXDLIN( 203)					int index5 = (int)0;
HXDLIN( 203)					int len1 = this12.length;
HXDLIN( 203)					int i1 = (int)0;
HXDLIN( 203)					while(true){
HXDLIN( 203)						bool ei1;
HXDLIN( 203)						if ((i1 < codePointOffset)) {
HXDLIN( 203)							ei1 = (index5 < len1);
            						}
            						else {
HXDLIN( 203)							ei1 = false;
            						}
HXDLIN( 203)						if (!(ei1)) {
HXDLIN( 203)							goto _hx_goto_17;
            						}
HXDLIN( 203)						int c2 = this12.cca(index5);
HXDLIN( 203)						int index6;
HXDLIN( 203)						if ((c2 < (int)192)) {
HXDLIN( 203)							index6 = (int)1;
            						}
            						else {
HXDLIN( 203)							if ((c2 < (int)224)) {
HXDLIN( 203)								index6 = (int)2;
            							}
            							else {
HXDLIN( 203)								if ((c2 < (int)240)) {
HXDLIN( 203)									index6 = (int)3;
            								}
            								else {
HXDLIN( 203)									if ((c2 < (int)248)) {
HXDLIN( 203)										index6 = (int)4;
            									}
            									else {
HXDLIN( 203)										index6 = (int)1;
            									}
...
HXDLIN( 203)						index5 = (index5 + index6);
HXDLIN( 203)						i1 = (i1 + (int)1);
            					}
            					_hx_goto_17:;
HXDLIN( 203)					ei = index5;
            				}
            				else {
HXDLIN( 203)					int index7 = (int)0;
HXDLIN( 203)					int count1 = (int)0;
HXDLIN( 203)					while(true){
HXDLIN( 203)						bool ei2;
HXDLIN( 203)						if ((count1 < -(codePointOffset))) {
HXDLIN( 203)							ei2 = ((int)0 < index7);
            						}
            						else {
HXDLIN( 203)							ei2 = false;
            						}
HXDLIN( 203)						if (!(ei2)) {
HXDLIN( 203)							goto _hx_goto_18;
            						}
HXDLIN( 203)						::String this13 = this12;
HXDLIN( 203)						::String this14 = this13;
HXDLIN( 203)						int c11 = this14.cca((index7 - (int)1));
HXDLIN( 203)						int index8;
HXDLIN( 203)						bool index9;
HXDLIN( 203)						if ((c11 >= (int)128)) {
HXDLIN( 203)							index9 = (c11 >= (int)192);
            						}
            						else {
HXDLIN( 203)							index9 = true;
            						}
HXDLIN( 203)						if (index9) {
HXDLIN( 203)							index8 = (int)1;
            						}
            						else {
HXDLIN( 203)							::String this15 = this13;
HXDLIN( 203)							if ((((int)this15.cca((index7 - (int)2)) & (int)(int)224) == (int)192)) {
HXDLIN( 203)								index8 = (int)2;
            							}
            							else {
HXDLIN( 203)								::String this16 = this13;
HXDLIN( 203)								if ((((int)this16.cca((index7 - (int)3)) & (int)(int)240) == (int)224)) {
HXDLIN( 203)									index8 = (int)3;
            								}
            								else {
HXDLIN( 203)									::String this17 = this13;
HXDLIN( 203)									if ((((int)this17.cca((index7 - (int)4)) & (int)(int)248) == (int)240)) {
HXDLIN( 203)										index8 = (int)4;
            									}
            									else {
HXDLIN( 203)										index8 = (int)1;
            									}
...
HXDLIN( 203)						index7 = (index7 - index8);
HXDLIN( 203)						count1 = (count1 + (int)1);
            					}
            					_hx_goto_18:;
HXDLIN( 203)					ei = index7;
            				}
            			}
            		}
HXDLIN( 203)		return this1.substring(si,ei);
            	}
...
::String UTF8String_Impl__obj::toLowerCase(::String this1){
            	HX_GC_STACKFRAME(&_hx_pos_980e6fae9dc7df30_213_toLowerCase)
HXLINE( 217)		if (hx::IsNull( ::lime::text::_UTF8String::UTF8String_Impl__obj::lowercaseMap )) {
HXLINE( 219)			::lime::text::_UTF8String::UTF8String_Impl__obj::lowercaseMap =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 220)			::lime::text::_UTF8String::Utf8Ext_obj::fillUpperToLowerMap(::lime::text::_UTF8String::UTF8String_Impl__obj::uppercaseMap);
            		}
HXLINE( 224)		 ::haxe::Utf8 r =  ::haxe::Utf8_obj::__alloc( HX_CTX ,null());
HXLINE( 226)		{
HXLINE( 226)			::cpp::Pointer< char > src = cpp::Pointer_obj::fromPointer(this1.__s);
HXDLIN( 226)			::cpp::Pointer< char > end = src->add(this1.length);
HXDLIN( 226)			while(true){
HXLINE( 226)				::cpp::Pointer< char > tmp = end;
HXDLIN( 226)				if (!(src->lt(tmp))) {
HXLINE( 226)					goto _hx_goto_20;
            				}
HXLINE( 228)				int v = _hx_utf8_decode_advance(src->ptr);
HXDLIN( 228)				int _hx_tmp;
HXDLIN( 228)				if (::lime::text::_UTF8String::UTF8String_Impl__obj::lowercaseMap->exists(v)) {
HXLINE( 228)					_hx_tmp = ( (int)(::lime::text::_UTF8String::UTF8String_Impl__obj::lowercaseMap->get(v)) );
            				}
            				else {
HXLINE( 228)					_hx_tmp = v;
            				}
HXDLIN( 228)				r->addChar(_hx_tmp);
            			}
            			_hx_goto_20:;
            		}
HXLINE( 232)		return r->toString();
            	}
...
::String UTF8String_Impl__obj::toString(::String this1){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_248_toString)
...
::String UTF8String_Impl__obj::toUpperCase(::String this1){
            	HX_GC_STACKFRAME(&_hx_pos_980e6fae9dc7df30_258_toUpperCase)
HXLINE( 262)		if (hx::IsNull( ::lime::text::_UTF8String::UTF8String_Impl__obj::uppercaseMap )) {
HXLINE( 264)			::lime::text::_UTF8String::UTF8String_Impl__obj::uppercaseMap =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 265)			::lime::text::_UTF8String::Utf8Ext_obj::fillLowerToUpperMap(::lime::text::_UTF8String::UTF8String_Impl__obj::uppercaseMap);
            		}
HXLINE( 269)		 ::haxe::Utf8 r =  ::haxe::Utf8_obj::__alloc( HX_CTX ,null());
HXLINE( 271)		{
HXLINE( 271)			::cpp::Pointer< char > src = cpp::Pointer_obj::fromPointer(this1.__s);
HXDLIN( 271)			::cpp::Pointer< char > end = src->add(this1.length);
HXDLIN( 271)			while(true){
HXLINE( 271)				::cpp::Pointer< char > tmp = end;
HXDLIN( 271)				if (!(src->lt(tmp))) {
HXLINE( 271)					goto _hx_goto_23;
            				}
HXLINE( 273)				int v = _hx_utf8_decode_advance(src->ptr);
HXDLIN( 273)				int _hx_tmp;
HXDLIN( 273)				if (::lime::text::_UTF8String::UTF8String_Impl__obj::uppercaseMap->exists(v)) {
HXLINE( 273)					_hx_tmp = ( (int)(::lime::text::_UTF8String::UTF8String_Impl__obj::uppercaseMap->get(v)) );
            				}
            				else {
HXLINE( 273)					_hx_tmp = v;
            				}
HXDLIN( 273)				r->addChar(_hx_tmp);
            			}
            			_hx_goto_23:;
            		}
HXLINE( 277)		return r->toString();
            	}
...
bool UTF8String_Impl__obj::equals(::String a,::String b){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_288_equals)
HXLINE( 290)		bool _hx_tmp;
HXDLIN( 290)		if (hx::IsNotNull( a )) {
HXLINE( 290)			_hx_tmp = hx::IsNull( b );
            		}
            		else {
HXLINE( 290)			_hx_tmp = true;
            		}
HXDLIN( 290)		if (_hx_tmp) {
HXLINE( 290)			return (a == b);
            		}
HXLINE( 291)		return (::lime::text::unifill::Unifill_obj::uCompare(a,b) == (int)0);
            	}
...
bool UTF8String_Impl__obj::lt(::String a,::String b){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_296_lt)
HXLINE( 298)		if (hx::IsNull( b )) {
HXLINE( 298)			return false;
            		}
HXLINE( 299)		if (hx::IsNull( a )) {
HXLINE( 299)			return true;
            		}
HXLINE( 300)		return (::lime::text::unifill::Unifill_obj::uCompare(a,b) == (int)-1);
            	}
...
bool UTF8String_Impl__obj::gt(::String a,::String b){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_305_gt)
HXLINE( 307)		if (hx::IsNull( a )) {
HXLINE( 307)			return false;
            		}
HXLINE( 308)		if (hx::IsNull( b )) {
HXLINE( 308)			return true;
            		}
HXLINE( 309)		return (::lime::text::unifill::Unifill_obj::uCompare(a,b) == (int)1);
            	}
...
bool UTF8String_Impl__obj::lteq(::String a,::String b){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_314_lteq)
HXLINE( 316)		if (hx::IsNull( b )) {
HXLINE( 316)			return hx::IsNull( a );
            		}
HXLINE( 317)		if (hx::IsNull( a )) {
HXLINE( 317)			return true;
            		}
HXLINE( 318)		return (::lime::text::unifill::Unifill_obj::uCompare(a,b) != (int)1);
            	}
...
HXLINE( 325)			return hx::IsNull( b );
            		}
HXLINE( 326)		if (hx::IsNull( b )) {
HXLINE( 326)			return true;
            		}
HXLINE( 327)		return (::lime::text::unifill::Unifill_obj::uCompare(a,b) != (int)-1);
            	}
...
::String UTF8String_Impl__obj::plus(::String a,::String b){
            	HX_GC_STACKFRAME(&_hx_pos_980e6fae9dc7df30_332_plus)
HXLINE( 334)		bool _hx_tmp;
HXDLIN( 334)		if (hx::IsNull( a )) {
HXLINE( 334)			_hx_tmp = hx::IsNull( b );
            		}
            		else {
...
HXLINE( 336)		if (hx::IsNull( b )) {
HXLINE( 336)			return a;
            		}
HXLINE( 338)		 ::StringBuf sb =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 339)		{
HXLINE( 339)			::String x = ::lime::text::_UTF8String::UTF8String_Impl__obj::toString(a);
HXDLIN( 339)			if (hx::IsNotNull( sb->charBuf )) {
HXLINE( 339)				sb->flush();
            			}
HXDLIN( 339)			if (hx::IsNull( sb->b )) {
HXLINE( 339)				sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            			}
            			else {
HXLINE( 339)				::Array< ::String > sb1 = sb->b;
HXDLIN( 339)				sb1->push(::Std_obj::string(x));
            			}
            		}
HXLINE( 340)		{
HXLINE( 340)			::String x1 = ::lime::text::_UTF8String::UTF8String_Impl__obj::toString(b);
HXDLIN( 340)			if (hx::IsNotNull( sb->charBuf )) {
HXLINE( 340)				sb->flush();
            			}
HXDLIN( 340)			if (hx::IsNull( sb->b )) {
HXLINE( 340)				sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            			}
            			else {
HXLINE( 340)				::Array< ::String > sb2 = sb->b;
HXDLIN( 340)				sb2->push(::Std_obj::string(x1));
            			}
            		}
HXLINE( 341)		return sb->toString();
            	}
...
::String UTF8String_Impl__obj::fromDynamic( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_348_fromDynamic)
HXDLIN( 348)		return ::Std_obj::string(value);
            	}
...
int UTF8String_Impl__obj::get_length(::String this1){
            	HX_STACKFRAME(&_hx_pos_980e6fae9dc7df30_362_get_length)
HXDLIN( 362)		if (hx::IsNull( this1 )) {
HXDLIN( 362)			return (int)0;
            		}
            		else {
HXDLIN( 362)			return ::haxe::Utf8_obj::length(this1);
            		}
HXDLIN( 362)		return (int)0;
            	}
