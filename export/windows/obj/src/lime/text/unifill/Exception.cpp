...
HX_DEFINE_STACK_FRAME(_hx_pos_f81ce3e30a95fc23_9_new,"lime.text.unifill.Exception","new",0xb169e39e,"lime.text.unifill.Exception.new","lime/text/unifill/Exception.hx",9,0xf9ad4373)
HX_LOCAL_STACK_FRAME(_hx_pos_f81ce3e30a95fc23_12_toString,"lime.text.unifill.Exception","toString",0x69943cae,"lime.text.unifill.Exception.toString","lime/text/unifill/Exception.hx",12,0xf9ad4373)
namespace lime{
namespace text{
namespace unifill{

void Exception_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f81ce3e30a95fc23_9_new)
            	}
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_f81ce3e30a95fc23_12_toString)
