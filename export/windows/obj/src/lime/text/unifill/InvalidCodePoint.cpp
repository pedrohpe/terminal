...
HX_DEFINE_STACK_FRAME(_hx_pos_fba5c367fe37cebd_23_new,"lime.text.unifill.InvalidCodePoint","new",0x3a1e6ba1,"lime.text.unifill.InvalidCodePoint.new","lime/text/unifill/Exception.hx",23,0xf9ad4373)
HX_LOCAL_STACK_FRAME(_hx_pos_fba5c367fe37cebd_28_toString,"lime.text.unifill.InvalidCodePoint","toString",0x9084c9cb,"lime.text.unifill.InvalidCodePoint.toString","lime/text/unifill/Exception.hx",28,0xf9ad4373)
namespace lime{
namespace text{
namespace unifill{

void InvalidCodePoint_obj::__construct(int code){
            	HX_STACKFRAME(&_hx_pos_fba5c367fe37cebd_23_new)
HXLINE(  24)		super::__construct();
HXLINE(  25)		this->code = code;
            	}
...
::String InvalidCodePoint_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_fba5c367fe37cebd_28_toString)
HXDLIN(  28)		return ((HX_("InvalidCodePoint(code: ",af,16,52,d2) + this->code) + HX_(")",29,00,00,00));
            	}
