...
HX_DEFINE_STACK_FRAME(_hx_pos_1cd24162fee7d64d_8_new,"lime.text.unifill.InternalEncodingIter","new",0x7b35f79d,"lime.text.unifill.InternalEncodingIter.new","lime/text/unifill/InternalEncodingIter.hx",8,0xddcd5a32)
HX_LOCAL_STACK_FRAME(_hx_pos_1cd24162fee7d64d_21_hasNext,"lime.text.unifill.InternalEncodingIter","hasNext",0x6c39af2a,"lime.text.unifill.InternalEncodingIter.hasNext","lime/text/unifill/InternalEncodingIter.hx",21,0xddcd5a32)
HX_LOCAL_STACK_FRAME(_hx_pos_1cd24162fee7d64d_25_next,"lime.text.unifill.InternalEncodingIter","next",0x5402b316,"lime.text.unifill.InternalEncodingIter.next","lime/text/unifill/InternalEncodingIter.hx",25,0xddcd5a32)
namespace lime{
namespace text{
namespace unifill{

void InternalEncodingIter_obj::__construct(::String s,int beginIndex,int endIndex){
            	HX_STACKFRAME(&_hx_pos_1cd24162fee7d64d_8_new)
...
bool InternalEncodingIter_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_1cd24162fee7d64d_21_hasNext)
...
int InternalEncodingIter_obj::next(){
            	HX_STACKFRAME(&_hx_pos_1cd24162fee7d64d_25_next)
HXLINE(  26)		this->i = this->index;
HXLINE(  27)		 ::lime::text::unifill::InternalEncodingIter _hx_tmp = hx::ObjectPtr<OBJ_>(this);
