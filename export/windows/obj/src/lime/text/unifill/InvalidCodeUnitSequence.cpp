...
HX_DEFINE_STACK_FRAME(_hx_pos_f78860393d87b7db_39_new,"lime.text.unifill.InvalidCodeUnitSequence","new",0xbfceabd8,"lime.text.unifill.InvalidCodeUnitSequence.new","lime/text/unifill/Exception.hx",39,0xf9ad4373)
HX_LOCAL_STACK_FRAME(_hx_pos_f78860393d87b7db_44_toString,"lime.text.unifill.InvalidCodeUnitSequence","toString",0x418d6234,"lime.text.unifill.InvalidCodeUnitSequence.toString","lime/text/unifill/Exception.hx",44,0xf9ad4373)
namespace lime{
namespace text{
namespace unifill{

void InvalidCodeUnitSequence_obj::__construct(int index){
            	HX_STACKFRAME(&_hx_pos_f78860393d87b7db_39_new)
...
::String InvalidCodeUnitSequence_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_f78860393d87b7db_44_toString)
