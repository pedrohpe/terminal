...
HX_DEFINE_STACK_FRAME(_hx_pos_473079a63c41ab74_8_new,"lime.text.unifill.CodePointIter","new",0x07684a6a,"lime.text.unifill.CodePointIter.new","lime/text/unifill/CodePointIter.hx",8,0x2d77bea7)
HX_LOCAL_STACK_FRAME(_hx_pos_473079a63c41ab74_21_hasNext,"lime.text.unifill.CodePointIter","hasNext",0xde21ec77,"lime.text.unifill.CodePointIter.hasNext","lime/text/unifill/CodePointIter.hx",21,0x2d77bea7)
HX_LOCAL_STACK_FRAME(_hx_pos_473079a63c41ab74_25_next,"lime.text.unifill.CodePointIter","next",0x73d8d3a9,"lime.text.unifill.CodePointIter.next","lime/text/unifill/CodePointIter.hx",25,0x2d77bea7)
namespace lime{
namespace text{
namespace unifill{

void CodePointIter_obj::__construct(::String s){
            	HX_STACKFRAME(&_hx_pos_473079a63c41ab74_8_new)
HXLINE(  24)		this->i = (int)0;
...
bool CodePointIter_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_473079a63c41ab74_21_hasNext)
HXDLIN(  21)		return (this->index < this->endIndex);
            	}
...
int CodePointIter_obj::next(){
            	HX_STACKFRAME(&_hx_pos_473079a63c41ab74_25_next)
HXLINE(  26)		this->i = this->index;
HXLINE(  27)		 ::lime::text::unifill::CodePointIter _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  27)		int _hx_tmp1 = _hx_tmp->index;
HXDLIN(  27)		::String this1 = this->string;
HXDLIN(  27)		::String this2 = this1;
HXDLIN(  27)		int c = this2.cca(this->index);
HXDLIN(  27)		int _hx_tmp2;
HXDLIN(  27)		if ((c < (int)192)) {
HXLINE(  27)			_hx_tmp2 = (int)1;
            		}
            		else {
HXLINE(  27)			if ((c < (int)224)) {
HXLINE(  27)				_hx_tmp2 = (int)2;
            			}
            			else {
HXLINE(  27)				if ((c < (int)240)) {
HXLINE(  27)					_hx_tmp2 = (int)3;
            				}
            				else {
HXLINE(  27)					if ((c < (int)248)) {
HXLINE(  27)						_hx_tmp2 = (int)4;
            					}
            					else {
HXLINE(  27)						_hx_tmp2 = (int)1;
            					}
...
HXDLIN(  27)		_hx_tmp->index = (_hx_tmp1 + _hx_tmp2);
HXLINE(  28)		::String this3 = this->string;
HXDLIN(  28)		::String this4 = this3;
HXDLIN(  28)		return ::lime::text::unifill::_Utf8::Utf8_Impl__obj::codePointAt(this4,this->i);
            	}
