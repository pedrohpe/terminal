...
HX_DEFINE_STACK_FRAME(_hx_pos_9453f8fd92a21d0a_324_new,"DocumentClass","new",0x4aeb0a6f,"DocumentClass.new","ApplicationMain.hx",324,0x0780ded5)

void DocumentClass_obj::__construct( ::openfl::display::DisplayObjectContainer current){
            	HX_GC_STACKFRAME(&_hx_pos_9453f8fd92a21d0a_324_new)
HXLINE( 326)		current->addChild(hx::ObjectPtr<OBJ_>(this));
HXLINE( 327)		super::__construct();
HXLINE( 328)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("addedToStage",63,22,55,0c),false,false));
            	}
