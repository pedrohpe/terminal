...
static void Stop_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Stop_obj::SReturn,"SReturn");
};
...
static void Stop_obj_sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Stop_obj::SReturn,"SReturn");
};
#endif
...
SReturn = hx::CreateEnum< Stop_obj >(HX_HCSTRING("SReturn","\x63","\x99","\x37","\xb9"),2,0);
}
