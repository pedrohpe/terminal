...
HX_LOCAL_STACK_FRAME(_hx_pos_af23706db05c7feb_18_update,"PlayState","update",0x8d182efa,"PlayState.update","PlayState.hx",18,0xb30d7781)
...
HXLINE(  11)		 ::flixel::FlxSprite background =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(int)0,(int)0,null());
HXLINE(  12)		background->loadGraphic(HX_("assets/images/background.png",14,8d,6b,e2),null(),null(),null(),null(),null());
HXLINE(  13)		this->add(background);
            	}


void PlayState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_af23706db05c7feb_18_update)
