...
HX_DEFINE_STACK_FRAME(_hx_pos_cbeb021ed190252c_21_new,"openfl.net.NetConnection","new",0x5c5dd97e,"openfl.net.NetConnection.new","openfl/net/NetConnection.hx",21,0x3b599834)
HX_LOCAL_STACK_FRAME(_hx_pos_cbeb021ed190252c_26_connect,"openfl.net.NetConnection","connect",0x1fc82c08,"openfl.net.NetConnection.connect","openfl/net/NetConnection.hx",26,0x3b599834)
HX_LOCAL_STACK_FRAME(_hx_pos_cbeb021ed190252c_16_boot,"openfl.net.NetConnection","boot",0x6dd97554,"openfl.net.NetConnection.boot","openfl/net/NetConnection.hx",16,0x3b599834)
namespace openfl{
namespace net{

void NetConnection_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_cbeb021ed190252c_21_new)
HXDLIN(  21)		super::__construct(null());
            	}
...
void NetConnection_obj::connect(::String command, ::Dynamic _, ::Dynamic _1, ::Dynamic _2, ::Dynamic _3, ::Dynamic _4){
            	HX_GC_STACKFRAME(&_hx_pos_cbeb021ed190252c_26_connect)
HXLINE(  28)		if (hx::IsNotNull( command )) {
HXLINE(  30)			HX_STACK_DO_THROW(HX_("Error: Can only connect in \"HTTP streaming\" mode",fe,f3,67,57));
            		}
HXLINE(  34)		this->dispatchEvent( ::openfl::events::NetStatusEvent_obj::__alloc( HX_CTX ,HX_("netStatus",6f,4f,ec,46),false,true, ::Dynamic(hx::Anon_obj::Create(1)
...
{
{
            	HX_STACKFRAME(&_hx_pos_cbeb021ed190252c_16_boot)
HXDLIN(  16)		CONNECT_SUCCESS = HX_("NetConnection.Connect.Success",4c,91,a7,41);
            	}
}
