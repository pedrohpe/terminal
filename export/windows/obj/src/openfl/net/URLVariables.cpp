...
HX_DEFINE_STACK_FRAME(_hx_pos_ae98413ec59e2d36_15_new,"openfl.net.URLVariables","new",0x0e8c3f29,"openfl.net.URLVariables.new","openfl/net/URLVariables.hx",15,0x10f26625)
HX_LOCAL_STACK_FRAME(_hx_pos_ae98413ec59e2d36_24_decode,"openfl.net.URLVariables","decode",0x44099205,"openfl.net.URLVariables.decode","openfl/net/URLVariables.hx",24,0x10f26625)
HX_LOCAL_STACK_FRAME(_hx_pos_ae98413ec59e2d36_55_toString,"openfl.net.URLVariables","toString",0x3ea32943,"openfl.net.URLVariables.toString","openfl/net/URLVariables.hx",55,0x10f26625)
namespace openfl{
namespace net{

void URLVariables_obj::__construct(::String source){
            	HX_STACKFRAME(&_hx_pos_ae98413ec59e2d36_15_new)
HXDLIN(  15)		if (hx::IsNotNull( source )) {
HXLINE(  17)			this->decode(source);
            		}
            	}
...
void URLVariables_obj::decode(::String source){
            	HX_STACKFRAME(&_hx_pos_ae98413ec59e2d36_24_decode)
HXLINE(  26)		::Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
HXLINE(  28)		{
HXLINE(  28)			int _g = (int)0;
HXDLIN(  28)			while((_g < fields->length)){
HXLINE(  28)				::String f = fields->__get(_g);
HXDLIN(  28)				_g = (_g + (int)1);
HXLINE(  30)				::Reflect_obj::deleteField(hx::ObjectPtr<OBJ_>(this),f);
            			}
            		}
HXLINE(  34)		::Array< ::String > fields1 = source.split(HX_(";",3b,00,00,00))->join(HX_("&",26,00,00,00)).split(HX_("&",26,00,00,00));
HXLINE(  36)		{
HXLINE(  36)			int _g1 = (int)0;
HXDLIN(  36)			while((_g1 < fields1->length)){
HXLINE(  36)				::String f1 = fields1->__get(_g1);
HXDLIN(  36)				_g1 = (_g1 + (int)1);
HXLINE(  38)				int eq = f1.indexOf(HX_("=",3d,00,00,00),null());
HXLINE(  40)				if ((eq > (int)0)) {
HXLINE(  42)					::String _hx_tmp = ::StringTools_obj::urlDecode(f1.substr((int)0,eq));
HXDLIN(  42)					::Reflect_obj::setField(hx::ObjectPtr<OBJ_>(this),_hx_tmp,::StringTools_obj::urlDecode(f1.substr((eq + (int)1),null())));
            				}
            				else {
HXLINE(  44)					if ((eq != (int)0)) {
HXLINE(  46)						::Reflect_obj::setField(hx::ObjectPtr<OBJ_>(this),::StringTools_obj::urlDecode(f1),HX_("",00,00,00,00));
            					}
            				}
            			}
            		}
...
::String URLVariables_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_ae98413ec59e2d36_55_toString)
HXLINE(  57)		::Array< ::String > result = ::Array_obj< ::String >::__new();
HXLINE(  58)		::Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
HXLINE(  60)		{
HXLINE(  60)			int _g = (int)0;
HXDLIN(  60)			while((_g < fields->length)){
HXLINE(  60)				::String f = fields->__get(_g);
HXDLIN(  60)				_g = (_g + (int)1);
HXLINE(  62)				::String _hx_tmp = (::StringTools_obj::urlEncode(f) + HX_("=",3d,00,00,00));
HXDLIN(  62)				result->push((_hx_tmp + ::StringTools_obj::urlEncode(( (::String)(::Reflect_obj::field(hx::ObjectPtr<OBJ_>(this),f)) ))));
            			}
            		}
HXLINE(  66)		return result->join(HX_("&",26,00,00,00));
            	}
