...
HX_DEFINE_STACK_FRAME(_hx_pos_8cde7e51a6201b8b_17_new,"openfl.net.URLRequestHeader","new",0xe794452e,"openfl.net.URLRequestHeader.new","openfl/net/URLRequestHeader.hx",17,0xf4ac7ec0)
namespace openfl{
namespace net{
...
::String value = __o_value.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_8cde7e51a6201b8b_17_new)
