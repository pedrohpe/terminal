...
HX_DEFINE_STACK_FRAME(_hx_pos_d7a2132659cec934_26_new,"openfl.net.URLRequest","new",0xe13767c1,"openfl.net.URLRequest.new","openfl/net/URLRequest.hx",26,0xe997cd0d)
namespace openfl{
namespace net{

void URLRequest_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_d7a2132659cec934_26_new)
HXLINE(  28)		if (hx::IsNotNull( url )) {
HXLINE(  30)			this->url = url;
            		}
HXLINE(  34)		this->contentType = null();
HXLINE(  35)		this->followRedirects = ::openfl::net::URLRequestDefaults_obj::followRedirects;
HXLINE(  36)		Float _hx_tmp;
HXDLIN(  36)		if ((::openfl::net::URLRequestDefaults_obj::idleTimeout > (int)0)) {
HXLINE(  36)			_hx_tmp = ::openfl::net::URLRequestDefaults_obj::idleTimeout;
            		}
            		else {
HXLINE(  36)			_hx_tmp = (int)30000;
            		}
HXDLIN(  36)		this->idleTimeout = _hx_tmp;
HXLINE(  37)		this->manageCookies = ::openfl::net::URLRequestDefaults_obj::manageCookies;
HXLINE(  38)		this->method = HX_("GET",76,1c,36,00);
HXLINE(  39)		this->requestHeaders = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  40)		this->userAgent = ::openfl::net::URLRequestDefaults_obj::userAgent;
            	}
