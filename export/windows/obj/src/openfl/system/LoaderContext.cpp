...
HX_DEFINE_STACK_FRAME(_hx_pos_b514a9552a6ee0e8_20_new,"openfl.system.LoaderContext","new",0xca9b9c4d,"openfl.system.LoaderContext.new","openfl/system/LoaderContext.hx",20,0x3ddfdde3)
namespace openfl{
...
bool checkPolicyFile = __o_checkPolicyFile.Default(false);
            	HX_STACKFRAME(&_hx_pos_b514a9552a6ee0e8_20_new)
HXLINE(  22)		this->checkPolicyFile = checkPolicyFile;
HXLINE(  23)		this->securityDomain = securityDomain;
HXLINE(  24)		this->applicationDomain = applicationDomain;
HXLINE(  26)		this->allowCodeImport = true;
HXLINE(  27)		this->allowLoadBytesCodeExecution = true;
            	}
