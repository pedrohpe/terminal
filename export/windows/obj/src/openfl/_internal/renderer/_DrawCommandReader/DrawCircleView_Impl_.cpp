...
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_315__new,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","_new",0xd771db4e,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",315,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_316_get_x,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","get_x",0x417b0ec2,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",316,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_317_get_y,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","get_y",0x417b0ec3,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",317,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_318_get_radius,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","get_radius",0xc711b5c8,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_.get_radius","openfl/_internal/renderer/DrawCommandReader.hx",318,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool DrawCircleView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader DrawCircleView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_da30b9c34d98d85b_315__new)
HXDLIN( 315)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float DrawCircleView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_da30b9c34d98d85b_316_get_x)
HXDLIN( 316)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawCircleView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_da30b9c34d98d85b_317_get_y)
HXDLIN( 317)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 317)		return this2->__get((this1->fPos + (int)1));
            	}
...
Float DrawCircleView_Impl__obj::get_radius( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_da30b9c34d98d85b_318_get_radius)
HXDLIN( 318)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 318)		return this2->__get((this1->fPos + (int)2));
            	}
