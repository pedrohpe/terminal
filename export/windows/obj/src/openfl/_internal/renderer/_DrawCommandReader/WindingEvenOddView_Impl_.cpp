...
HX_LOCAL_STACK_FRAME(_hx_pos_8368c8805a35f20c_455__new,"openfl._internal.renderer._DrawCommandReader.WindingEvenOddView_Impl_","_new",0x241297a7,"openfl._internal.renderer._DrawCommandReader.WindingEvenOddView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",455,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool WindingEvenOddView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader WindingEvenOddView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_8368c8805a35f20c_455__new)
HXDLIN( 455)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
