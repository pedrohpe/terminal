...
HX_LOCAL_STACK_FRAME(_hx_pos_c497896f47a8f539_259__new,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","_new",0xff2dc446,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",259,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_c497896f47a8f539_260_get_color,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","get_color",0x83ba00b5,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_.get_color","openfl/_internal/renderer/DrawCommandReader.hx",260,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_c497896f47a8f539_261_get_alpha,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","get_alpha",0x5af436b0,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_.get_alpha","openfl/_internal/renderer/DrawCommandReader.hx",261,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool BeginFillView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader BeginFillView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_c497896f47a8f539_259__new)
HXDLIN( 259)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
HXDLIN( 259)		return this1;
            	}
...
int BeginFillView_Impl__obj::get_color( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c497896f47a8f539_260_get_color)
HXDLIN( 260)		return this1->buffer->i->__get(this1->iPos);
            	}
...
Float BeginFillView_Impl__obj::get_alpha( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c497896f47a8f539_261_get_alpha)
