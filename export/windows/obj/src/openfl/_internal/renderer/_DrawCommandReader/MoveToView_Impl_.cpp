...
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bac53584ced5e_438__new,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","_new",0x9bdb8896,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",438,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bac53584ced5e_439_get_x,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_x",0x5989007a,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",439,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bac53584ced5e_440_get_y,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_y",0x5989007b,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",440,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool MoveToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader MoveToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_cb6bac53584ced5e_438__new)
HXDLIN( 438)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float MoveToView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_cb6bac53584ced5e_439_get_x)
HXDLIN( 439)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float MoveToView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_cb6bac53584ced5e_440_get_y)
HXDLIN( 440)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 440)		return this2->__get((this1->fPos + (int)1));
            	}
