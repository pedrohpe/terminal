...
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_325__new,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","_new",0xc710ba18,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",325,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_326_get_x,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_x",0xfcdf20b8,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",326,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_327_get_y,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_y",0xfcdf20b9,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",327,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_328_get_width,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_width",0xcef6f646,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_width","openfl/_internal/renderer/DrawCommandReader.hx",328,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_329_get_height,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_height",0xff6fffa7,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_height","openfl/_internal/renderer/DrawCommandReader.hx",329,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool DrawEllipseView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader DrawEllipseView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_325__new)
HXDLIN( 325)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
HXDLIN( 325)		return this1;
            	}
...
Float DrawEllipseView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_326_get_x)
HXDLIN( 326)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawEllipseView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_327_get_y)
HXDLIN( 327)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 327)		return this2->__get((this1->fPos + (int)1));
            	}
...
Float DrawEllipseView_Impl__obj::get_width( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_328_get_width)
HXDLIN( 328)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 328)		return this2->__get((this1->fPos + (int)2));
            	}
...
Float DrawEllipseView_Impl__obj::get_height( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_329_get_height)
HXDLIN( 329)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 329)		return this2->__get((this1->fPos + (int)3));
            	}
