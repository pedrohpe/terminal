...
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_388__new,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","_new",0x6ec636a4,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",388,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_389_get_bitmap,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_bitmap",0xeee7753b,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_bitmap","openfl/_internal/renderer/DrawCommandReader.hx",389,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_390_get_matrix,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_matrix",0xb9a39b8d,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",390,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_391_get_repeat,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_repeat",0x0457fca7,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_repeat","openfl/_internal/renderer/DrawCommandReader.hx",391,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_392_get_smooth,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_smooth",0x05466d7a,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",392,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool LineBitmapStyleView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader LineBitmapStyleView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_388__new)
HXDLIN( 388)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineBitmapStyleView_Impl__obj,_new,return )
 ...
 ::openfl::display::BitmapData LineBitmapStyleView_Impl__obj::get_bitmap( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_389_get_bitmap)
HXDLIN( 389)		return ( ( ::openfl::display::BitmapData)(this1->buffer->o->__get(this1->oPos)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineBitmapStyleView_Impl__obj,get_bitmap,return )
 ...
 ::openfl::geom::Matrix LineBitmapStyleView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_390_get_matrix)
HXDLIN( 390)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 390)		return ( ( ::openfl::geom::Matrix)(this2->__get((this1->oPos + (int)1))) );
            	}
...
bool LineBitmapStyleView_Impl__obj::get_repeat( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_391_get_repeat)
HXDLIN( 391)		return this1->buffer->b->__get(this1->bPos);
            	}
...
bool LineBitmapStyleView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_392_get_smooth)
HXDLIN( 392)		::Array< bool > this2 = this1->buffer->b;
HXDLIN( 392)		return this2->__get((this1->bPos + (int)1));
            	}
