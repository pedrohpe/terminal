...
HX_LOCAL_STACK_FRAME(_hx_pos_3314eca9e5e9aad3_462__new,"openfl._internal.renderer._DrawCommandReader.WindingNonZeroView_Impl_","_new",0xb0a56387,"openfl._internal.renderer._DrawCommandReader.WindingNonZeroView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",462,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool WindingNonZeroView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader WindingNonZeroView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_3314eca9e5e9aad3_462__new)
HXDLIN( 462)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
