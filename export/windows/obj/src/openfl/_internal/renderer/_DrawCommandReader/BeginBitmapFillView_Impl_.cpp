...
HX_LOCAL_STACK_FRAME(_hx_pos_53ac15441f7ae261_248__new,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","_new",0x824c6ed7,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",248,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_53ac15441f7ae261_249_get_bitmap,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_bitmap",0x65ae55ae,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_bitmap","openfl/_internal/renderer/DrawCommandReader.hx",249,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_53ac15441f7ae261_250_get_matrix,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_matrix",0x306a7c00,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",250,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_53ac15441f7ae261_251_get_repeat,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_repeat",0x7b1edd1a,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_repeat","openfl/_internal/renderer/DrawCommandReader.hx",251,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_53ac15441f7ae261_252_get_smooth,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_smooth",0x7c0d4ded,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",252,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool BeginBitmapFillView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader BeginBitmapFillView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_53ac15441f7ae261_248__new)
HXDLIN( 248)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BeginBitmapFillView_Impl__obj,_new,return )
 ...
 ::openfl::display::BitmapData BeginBitmapFillView_Impl__obj::get_bitmap( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_53ac15441f7ae261_249_get_bitmap)
HXDLIN( 249)		return ( ( ::openfl::display::BitmapData)(this1->buffer->o->__get(this1->oPos)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BeginBitmapFillView_Impl__obj,get_bitmap,return )
 ...
 ::openfl::geom::Matrix BeginBitmapFillView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_53ac15441f7ae261_250_get_matrix)
HXDLIN( 250)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 250)		return ( ( ::openfl::geom::Matrix)(this2->__get((this1->oPos + (int)1))) );
            	}
...
bool BeginBitmapFillView_Impl__obj::get_repeat( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_53ac15441f7ae261_251_get_repeat)
HXDLIN( 251)		return this1->buffer->b->__get(this1->bPos);
            	}
...
bool BeginBitmapFillView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_53ac15441f7ae261_252_get_smooth)
HXDLIN( 252)		::Array< bool > this2 = this1->buffer->b;
HXDLIN( 252)		return this2->__get((this1->bPos + (int)1));
            	}
