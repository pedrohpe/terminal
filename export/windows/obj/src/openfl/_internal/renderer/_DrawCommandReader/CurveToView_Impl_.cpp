...
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_304__new,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","_new",0x02b6a548,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",304,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_305_get_controlX,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlX",0xd0ea894b,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlX","openfl/_internal/renderer/DrawCommandReader.hx",305,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_306_get_controlY,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlY",0xd0ea894c,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlY","openfl/_internal/renderer/DrawCommandReader.hx",306,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_307_get_anchorX,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorX",0x40299753,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorX","openfl/_internal/renderer/DrawCommandReader.hx",307,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_308_get_anchorY,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorY",0x40299754,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorY","openfl/_internal/renderer/DrawCommandReader.hx",308,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool CurveToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader CurveToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_304__new)
HXDLIN( 304)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float CurveToView_Impl__obj::get_controlX( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_305_get_controlX)
HXDLIN( 305)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float CurveToView_Impl__obj::get_controlY( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_306_get_controlY)
HXDLIN( 306)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 306)		return this2->__get((this1->fPos + (int)1));
            	}
...
Float CurveToView_Impl__obj::get_anchorX( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_307_get_anchorX)
HXDLIN( 307)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 307)		return this2->__get((this1->fPos + (int)2));
            	}
...
Float CurveToView_Impl__obj::get_anchorY( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_308_get_anchorY)
HXDLIN( 308)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 308)		return this2->__get((this1->fPos + (int)3));
            	}
