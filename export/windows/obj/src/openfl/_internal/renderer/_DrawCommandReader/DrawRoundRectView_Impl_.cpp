...
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_357__new,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","_new",0x282357e4,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",357,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_358_get_x,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_x",0x8c16956c,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",358,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_359_get_y,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_y",0x8c16956d,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",359,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_360_get_width,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_width",0xe518d4fa,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_width","openfl/_internal/renderer/DrawCommandReader.hx",360,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_361_get_height,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_height",0x46f0fe73,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_height","openfl/_internal/renderer/DrawCommandReader.hx",361,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_362_get_ellipseWidth,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_ellipseWidth",0x1c1a67d4,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_ellipseWidth","openfl/_internal/renderer/DrawCommandReader.hx",362,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_363_get_ellipseHeight,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_ellipseHeight",0x314fea59,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_ellipseHeight","openfl/_internal/renderer/DrawCommandReader.hx",363,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool DrawRoundRectView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader DrawRoundRectView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_357__new)
HXDLIN( 357)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float DrawRoundRectView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_358_get_x)
HXDLIN( 358)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawRoundRectView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_359_get_y)
HXDLIN( 359)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 359)		return this2->__get((this1->fPos + (int)1));
            	}
...
Float DrawRoundRectView_Impl__obj::get_width( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_360_get_width)
HXDLIN( 360)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 360)		return this2->__get((this1->fPos + (int)2));
            	}
...
Float DrawRoundRectView_Impl__obj::get_height( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_361_get_height)
HXDLIN( 361)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 361)		return this2->__get((this1->fPos + (int)3));
            	}
...
Float DrawRoundRectView_Impl__obj::get_ellipseWidth( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_362_get_ellipseWidth)
HXDLIN( 362)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 362)		return this2->__get((this1->fPos + (int)4));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DrawRoundRectView_Impl__obj,get_ellipseWidth,return )
 ...
 ::Dynamic DrawRoundRectView_Impl__obj::get_ellipseHeight( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_363_get_ellipseHeight)
HXDLIN( 363)		return this1->buffer->o->__get(this1->oPos);
            	}
