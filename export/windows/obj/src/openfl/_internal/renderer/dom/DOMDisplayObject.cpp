...
HX_LOCAL_STACK_FRAME(_hx_pos_861188b285f627bd_15_clear,"openfl._internal.renderer.dom.DOMDisplayObject","clear",0x6073f245,"openfl._internal.renderer.dom.DOMDisplayObject.clear","openfl/_internal/renderer/dom/DOMDisplayObject.hx",15,0xeb6cef58)
HX_LOCAL_STACK_FRAME(_hx_pos_861188b285f627bd_24_render,"openfl._internal.renderer.dom.DOMDisplayObject","render",0x02818b9e,"openfl._internal.renderer.dom.DOMDisplayObject.render","openfl/_internal/renderer/dom/DOMDisplayObject.hx",24,0xeb6cef58)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMDisplayObject_obj::clear( ::openfl::display::DisplayObject displayObject, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_861188b285f627bd_15_clear)
            	}
...
void DOMDisplayObject_obj::render( ::openfl::display::DisplayObject displayObject, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_861188b285f627bd_24_render)
            	}
