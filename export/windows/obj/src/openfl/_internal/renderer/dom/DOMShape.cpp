...
HX_LOCAL_STACK_FRAME(_hx_pos_108cf59222717320_23_clear,"openfl._internal.renderer.dom.DOMShape","clear",0x23edadc5,"openfl._internal.renderer.dom.DOMShape.clear","openfl/_internal/renderer/dom/DOMShape.hx",23,0xad9b03d8)
HX_LOCAL_STACK_FRAME(_hx_pos_108cf59222717320_38_render,"openfl._internal.renderer.dom.DOMShape","render",0x498be01e,"openfl._internal.renderer.dom.DOMShape.render","openfl/_internal/renderer/dom/DOMShape.hx",38,0xad9b03d8)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMShape_obj::clear( ::openfl::display::DisplayObject shape, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_108cf59222717320_23_clear)
            	}
...
void DOMShape_obj::render( ::openfl::display::DisplayObject shape, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_108cf59222717320_38_render)
            	}
