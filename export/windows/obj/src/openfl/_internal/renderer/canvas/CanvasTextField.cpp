...
HX_LOCAL_STACK_FRAME(_hx_pos_33c2fcb60c1e8950_42_render,"openfl._internal.renderer.canvas.CanvasTextField","render",0xbf0ed28a,"openfl._internal.renderer.canvas.CanvasTextField.render","openfl/_internal/renderer/canvas/CanvasTextField.hx",42,0xcdf61a26)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasTextField_obj::render( ::openfl::text::TextField textField, ::openfl::display::CanvasRenderer renderer, ::openfl::geom::Matrix transform){
            	HX_STACKFRAME(&_hx_pos_33c2fcb60c1e8950_42_render)
            	}
