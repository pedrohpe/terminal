...
HX_LOCAL_STACK_FRAME(_hx_pos_f609dc9640c6ad89_20_render,"openfl._internal.renderer.canvas.CanvasShape","render",0x1f16b136,"openfl._internal.renderer.canvas.CanvasShape.render","openfl/_internal/renderer/canvas/CanvasShape.hx",20,0x418319d2)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasShape_obj::render( ::openfl::display::DisplayObject shape, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_f609dc9640c6ad89_20_render)
            	}
