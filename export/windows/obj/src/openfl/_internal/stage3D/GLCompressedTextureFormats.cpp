...
HX_DEFINE_STACK_FRAME(_hx_pos_0594741cd2107140_15_new,"openfl._internal.stage3D.GLCompressedTextureFormats","new",0xe896a2a8,"openfl._internal.stage3D.GLCompressedTextureFormats.new","openfl/_internal/stage3D/GLCompressedTextureFormats.hx",15,0x2202e8a5)
HX_LOCAL_STACK_FRAME(_hx_pos_0594741cd2107140_31_checkDXT,"openfl._internal.stage3D.GLCompressedTextureFormats","checkDXT",0x50d4e330,"openfl._internal.stage3D.GLCompressedTextureFormats.checkDXT","openfl/_internal/stage3D/GLCompressedTextureFormats.hx",31,0x2202e8a5)
HX_LOCAL_STACK_FRAME(_hx_pos_0594741cd2107140_49_checkETC1,"openfl._internal.stage3D.GLCompressedTextureFormats","checkETC1",0x6a1805cd,"openfl._internal.stage3D.GLCompressedTextureFormats.checkETC1","openfl/_internal/stage3D/GLCompressedTextureFormats.hx",49,0x2202e8a5)
HX_LOCAL_STACK_FRAME(_hx_pos_0594741cd2107140_76_checkPVRTC,"openfl._internal.stage3D.GLCompressedTextureFormats","checkPVRTC",0xc1b35ceb,"openfl._internal.stage3D.GLCompressedTextureFormats.checkPVRTC","openfl/_internal/stage3D/GLCompressedTextureFormats.hx",76,0x2202e8a5)
HX_LOCAL_STACK_FRAME(_hx_pos_0594741cd2107140_97_toTextureFormat,"openfl._internal.stage3D.GLCompressedTextureFormats","toTextureFormat",0x8c1b5a3f,"openfl._internal.stage3D.GLCompressedTextureFormats.toTextureFormat","openfl/_internal/stage3D/GLCompressedTextureFormats.hx",97,0x2202e8a5)
namespace openfl{
namespace _internal{
namespace stage3D{

void GLCompressedTextureFormats_obj::__construct( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_GC_STACKFRAME(&_hx_pos_0594741cd2107140_15_new)
HXLINE(  19)		this->_hx___formatMapAlpha =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  18)		this->_hx___formatMap =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  24)		this->checkDXT(gl);
HXLINE(  25)		this->checkETC1(gl);
HXLINE(  26)		this->checkPVRTC(gl);
            	}
...
void GLCompressedTextureFormats_obj::checkDXT( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_STACKFRAME(&_hx_pos_0594741cd2107140_31_checkDXT)
HXLINE(  36)		 ::Dynamic compressedExtension = gl->getExtension(HX_("EXT_texture_compression_s3tc",6a,86,aa,80));
HXLINE(  39)		if (hx::IsNotNull( compressedExtension )) {
HXLINE(  41)			{
HXLINE(  41)				int v = ( (int)(compressedExtension->__Field(HX_("COMPRESSED_RGBA_S3TC_DXT1_EXT",b6,6f,45,f9),hx::paccDynamic)) );
HXDLIN(  41)				this->_hx___formatMap->set((int)0,v);
            			}
HXLINE(  42)			{
HXLINE(  42)				int v1 = ( (int)(compressedExtension->__Field(HX_("COMPRESSED_RGBA_S3TC_DXT5_EXT",ba,c1,df,46),hx::paccDynamic)) );
HXDLIN(  42)				this->_hx___formatMapAlpha->set((int)0,v1);
            			}
            		}
            	}
...
void GLCompressedTextureFormats_obj::checkETC1( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_STACKFRAME(&_hx_pos_0594741cd2107140_49_checkETC1)
HXLINE(  63)		 ::Dynamic compressedExtension = gl->getExtension(HX_("OES_compressed_ETC1_RGB8_texture",cd,f1,a0,b8));
HXLINE(  64)		if (hx::IsNotNull( compressedExtension )) {
HXLINE(  66)			{
HXLINE(  66)				int v = ( (int)(compressedExtension->__Field(HX_("ETC1_RGB8_OES",ab,04,61,eb),hx::paccDynamic)) );
HXDLIN(  66)				this->_hx___formatMap->set((int)2,v);
            			}
HXLINE(  67)			{
HXLINE(  67)				int v1 = ( (int)(compressedExtension->__Field(HX_("ETC1_RGB8_OES",ab,04,61,eb),hx::paccDynamic)) );
HXDLIN(  67)				this->_hx___formatMapAlpha->set((int)2,v1);
            			}
            		}
            	}
...
void GLCompressedTextureFormats_obj::checkPVRTC( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_STACKFRAME(&_hx_pos_0594741cd2107140_76_checkPVRTC)
HXLINE(  82)		 ::Dynamic compressedExtension = gl->getExtension(HX_("IMG_texture_compression_pvrtc",02,61,85,d1));
HXLINE(  85)		if (hx::IsNotNull( compressedExtension )) {
HXLINE(  87)			{
HXLINE(  87)				int v = ( (int)(compressedExtension->__Field(HX_("COMPRESSED_RGB_PVRTC_4BPPV1_IMG",a1,18,41,ce),hx::paccDynamic)) );
HXDLIN(  87)				this->_hx___formatMap->set((int)1,v);
            			}
HXLINE(  88)			{
HXLINE(  88)				int v1 = ( (int)(compressedExtension->__Field(HX_("COMPRESSED_RGBA_PVRTC_4BPPV1_IMG",be,45,75,bf),hx::paccDynamic)) );
HXDLIN(  88)				this->_hx___formatMapAlpha->set((int)1,v1);
            			}
            		}
            	}
...
int GLCompressedTextureFormats_obj::toTextureFormat(bool alpha,int gpuFormat){
            	HX_STACKFRAME(&_hx_pos_0594741cd2107140_97_toTextureFormat)
HXDLIN(  97)		if (alpha) {
HXLINE(  99)			return ( (int)(this->_hx___formatMapAlpha->get(gpuFormat)) );
            		}
            		else {
HXLINE( 103)			return ( (int)(this->_hx___formatMap->get(gpuFormat)) );
            		}
