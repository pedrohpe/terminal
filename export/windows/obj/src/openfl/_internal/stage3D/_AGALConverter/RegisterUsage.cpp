...
::openfl::_internal::stage3D::_AGALConverter::RegisterUsage RegisterUsage_obj::SAMPLER_CUBE_ALPHA;
...
static void RegisterUsage_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(RegisterUsage_obj::SAMPLER_CUBE_ALPHA,"SAMPLER_CUBE_ALPHA");
...
static void RegisterUsage_obj_sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(RegisterUsage_obj::SAMPLER_CUBE_ALPHA,"SAMPLER_CUBE_ALPHA");
...
SAMPLER_CUBE_ALPHA = hx::CreateEnum< RegisterUsage_obj >(HX_HCSTRING("SAMPLER_CUBE_ALPHA","\x6b","\x5e","\xfa","\x15"),6,0);
...
VECTOR_4_ARRAY = hx::CreateEnum< RegisterUsage_obj >(HX_HCSTRING("VECTOR_4_ARRAY","\x32","\xbd","\xf8","\xe4"),7,0);
}
