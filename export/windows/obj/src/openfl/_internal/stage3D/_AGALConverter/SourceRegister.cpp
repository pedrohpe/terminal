...
HX_DEFINE_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_1089_new,"openfl._internal.stage3D._AGALConverter.SourceRegister","new",0xf72124df,"openfl._internal.stage3D._AGALConverter.SourceRegister.new","openfl/_internal/stage3D/AGALConverter.hx",1089,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_1113_toGLSL,"openfl._internal.stage3D._AGALConverter.SourceRegister","toGLSL",0xdb399dda,"openfl._internal.stage3D._AGALConverter.SourceRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",1113,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_1096_parse,"openfl._internal.stage3D._AGALConverter.SourceRegister","parse",0x01804272,"openfl._internal.stage3D._AGALConverter.SourceRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",1096,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_1089_new)
            	}
...
int offset = __o_offset.Default(0);
            	HX_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_1113_toGLSL)
HXLINE(1115)		if ((this->type == (int)3)) {
HXLINE(1117)			if (hx::IsEq( this->programType,::openfl::_internal::stage3D::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE(1117)				return HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE(1117)				return HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
HXLINE(1121)		bool fullxyzw;
HXDLIN(1121)		if ((this->s == (int)228)) {
HXLINE(1121)			fullxyzw = (this->sourceMask == (int)15);
            		}
            		else {
HXLINE(1121)			fullxyzw = false;
            		}
HXLINE(1122)		::String swizzle = HX_("",00,00,00,00);
HXLINE(1124)		bool _hx_tmp;
HXDLIN(1124)		if ((this->type != (int)5)) {
HXLINE(1124)			_hx_tmp = !(fullxyzw);
            		}
            		else {
...
HXDLIN(1126)			while((_g < (int)4)){
HXLINE(1126)				_g = (_g + (int)1);
HXDLIN(1126)				int i = (_g - (int)1);
HXLINE(1129)				int _hx_tmp1 = this->sourceMask;
HXDLIN(1129)				if ((((int)_hx_tmp1 & (int)((int)(int)1 << (int)i)) != (int)0)) {
HXLINE(1131)					int _g1 = this->s;
HXDLIN(1131)					int _g11 = ((int)((int)_g1 >> (int)(i * (int)2)) & (int)(int)3);
HXDLIN(1131)					switch((int)(_g11)){
            						case (int)0: {
HXLINE(1133)							swizzle = (swizzle + HX_("x",78,00,00,00));
            						}
            						break;
            						case (int)1: {
HXLINE(1134)							swizzle = (swizzle + HX_("y",79,00,00,00));
            						}
            						break;
            						case (int)2: {
HXLINE(1135)							swizzle = (swizzle + HX_("z",7a,00,00,00));
            						}
            						break;
            						case (int)3: {
HXLINE(1136)							swizzle = (swizzle + HX_("w",77,00,00,00));
            						}
            						break;
            					}
            				}
...
HXLINE(1146)		::String str = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1148)		if ((this->d == (int)0)) {
HXLINE(1151)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1156)			str = (str + this->o);
HXLINE(1157)			 ::Dynamic indexComponent = HX_("x",78,00,00,00).charCodeAt((int)0);
HXDLIN(1157)			::String indexComponent1 = ::String::fromCharCode((indexComponent + this->q));
HXLINE(1158)			::String indexRegister = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->itype,this->programType);
HXDLIN(1158)			::String indexRegister1 = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent1);
HXLINE(1159)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + indexRegister1) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
HXLINE(1163)		bool _hx_tmp2;
HXDLIN(1163)		if (emitSwizzle) {
HXLINE(1163)			_hx_tmp2 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(1163)			_hx_tmp2 = false;
            		}
HXDLIN(1163)		if (_hx_tmp2) {
HXLINE(1165)			str = (str + (HX_(".",2e,00,00,00) + swizzle));
            		}
HXLINE(1169)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::SourceRegister SourceRegister_obj::parse( cpp::Int64Struct v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_1096_parse)
HXLINE(1098)		 ::openfl::_internal::stage3D::_AGALConverter::SourceRegister sr =  ::openfl::_internal::stage3D::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
HXLINE(1099)		sr->programType = programType;
HXLINE(1100)		 cpp::Int64Struct a = _hx_int64_shr(v,(int)63);
HXDLIN(1100)		sr->d = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)1))));
HXLINE(1101)		 cpp::Int64Struct a1 = _hx_int64_shr(v,(int)48);
HXDLIN(1101)		sr->q = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)3))));
HXLINE(1102)		 cpp::Int64Struct a2 = _hx_int64_shr(v,(int)40);
HXDLIN(1102)		sr->itype = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE(1103)		 cpp::Int64Struct a3 = _hx_int64_shr(v,(int)32);
HXDLIN(1103)		sr->type = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE(1104)		 cpp::Int64Struct a4 = _hx_int64_shr(v,(int)24);
HXDLIN(1104)		sr->s = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)255))));
HXLINE(1105)		 cpp::Int64Struct a5 = _hx_int64_shr(v,(int)16);
HXDLIN(1105)		sr->o = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)255))));
HXLINE(1106)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
HXLINE(1107)		sr->sourceMask = sourceMask;
HXLINE(1108)		return sr;
            	}
