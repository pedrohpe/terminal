...
HXLINE(  27)		 ::lime::_backend::native::NativeGLRenderContext gl = renderer->_hx___gl;
...
HXLINE(  44)		 ::lime::_backend::native::NativeGLRenderContext gl = renderer->_hx___gl;
...
HXDLIN(  59)		::openfl::_internal::stage3D::opengl::GLIndexBuffer3D_obj::uploadFromTypedArray(indexBuffer,renderer,this1);
            	}
...
HXLINE( 117)		::openfl::_internal::stage3D::opengl::GLIndexBuffer3D_obj::uploadFromTypedArray(indexBuffer,renderer,indexBuffer->_hx___tempInt16Array);
            	}
