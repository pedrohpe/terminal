...
HX_LOCAL_STACK_FRAME(_hx_pos_aa6154e001ea54c5_22_render,"openfl._internal.stage3D.opengl.GLStage3D","render",0x1308fc2a,"openfl._internal.stage3D.opengl.GLStage3D.render","openfl/_internal/stage3D/opengl/GLStage3D.hx",22,0x8ea52802)
namespace openfl{
namespace _internal{
namespace stage3D{
namespace opengl{
...
void GLStage3D_obj::render( ::openfl::display::Stage3D stage3D, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_aa6154e001ea54c5_22_render)
HXLINE(  24)		if (hx::IsNotNull( stage3D->context3D )) {
HXLINE(  26)			renderer->_hx___setBlendMode(null());
HXLINE(  28)			if (hx::IsNotNull( renderer->_hx___currentShader )) {
HXLINE(  30)				renderer->setShader(null());
HXLINE(  32)				if (hx::IsNotNull( stage3D->context3D->_hx___program )) {
HXLINE(  34)					stage3D->context3D->_hx___program->_hx___use();
            				}
            			}
            		}
HXLINE(  42)		if (::openfl::_internal::stage3D::GLUtils_obj::debug) {
HXLINE(  44)			renderer->gl->getError();
            		}
            	}
