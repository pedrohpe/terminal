...
HXLINE(  47)		::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadFromTypedArray(texture,renderer,null(),null());
            	}
...
HXLINE(  57)		 ::lime::_backend::native::NativeGLRenderContext gl = renderer->_hx___gl;
...
HXLINE( 149)		::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadFromTypedArray(texture,renderer,image->get_data(),miplevel);
            	}
...
HXDLIN( 165)		::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadFromTypedArray(texture,renderer,this1,miplevel);
            	}
...
HXLINE( 173)		 ::lime::_backend::native::NativeGLRenderContext gl = renderer->_hx___gl;
...
HXLINE( 222)		::openfl::_internal::stage3D::opengl::GLTextureBase_obj::setSamplerState(texture,renderer,state);
            	}
