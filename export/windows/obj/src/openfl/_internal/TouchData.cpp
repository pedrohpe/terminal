...
HX_DEFINE_STACK_FRAME(_hx_pos_aa6661caf6f12359_28_new,"openfl._internal.TouchData","new",0xcd4ddaab,"openfl._internal.TouchData.new","openfl/_internal/TouchData.hx",28,0x1860a967)
HX_LOCAL_STACK_FRAME(_hx_pos_aa6661caf6f12359_33_reset,"openfl._internal.TouchData","reset",0x6e11bcda,"openfl._internal.TouchData.reset","openfl/_internal/TouchData.hx",33,0x1860a967)
HX_LOCAL_STACK_FRAME(_hx_pos_aa6661caf6f12359_18_boot,"openfl._internal.TouchData","boot",0xceea7b87,"openfl._internal.TouchData.boot","openfl/_internal/TouchData.hx",18,0x1860a967)
namespace openfl{
namespace _internal{

void TouchData_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_aa6661caf6f12359_28_new)
HXDLIN(  28)		this->rollOutStack = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
void TouchData_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_aa6661caf6f12359_33_reset)
HXLINE(  35)		this->touch = null();
HXLINE(  36)		this->touchDownTarget = null();
HXLINE(  37)		this->touchOverTarget = null();
HXLINE(  39)		this->rollOutStack->removeRange((int)0,this->rollOutStack->length);
            	}
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::_internal::TouchData _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_aa6661caf6f12359_18_boot)
HXDLIN(  18)			return  ::openfl::_internal::TouchData_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::_internal::TouchData data){
            			HX_STACKFRAME(&_hx_pos_aa6661caf6f12359_18_boot)
HXDLIN(  18)			data->reset();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_aa6661caf6f12359_18_boot)
HXDLIN(  18)		_hx___pool =  ::lime::utils::ObjectPool_openfl__internal_TouchData_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
