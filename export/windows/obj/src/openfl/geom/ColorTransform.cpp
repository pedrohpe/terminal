...
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_125___invert,"openfl.geom.ColorTransform","__invert",0xf5ebeb87,"openfl.geom.ColorTransform.__invert","openfl/geom/ColorTransform.hx",125,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_141___equals,"openfl.geom.ColorTransform","__equals",0x1605f2b0,"openfl.geom.ColorTransform.__equals","openfl/geom/ColorTransform.hx",141,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_148___isDefault,"openfl.geom.ColorTransform","__isDefault",0x071aee26,"openfl.geom.ColorTransform.__isDefault","openfl/geom/ColorTransform.hx",148,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_153___setArrays,"openfl.geom.ColorTransform","__setArrays",0x7ef0862b,"openfl.geom.ColorTransform.__setArrays","openfl/geom/ColorTransform.hx",153,0x850de941)
...
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_181_set_color,"openfl.geom.ColorTransform","set_color",0xea994755,"openfl.geom.ColorTransform.set_color","openfl/geom/ColorTransform.hx",181,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_196___toLimeColorMatrix,"openfl.geom.ColorTransform","__toLimeColorMatrix",0x55c98ae3,"openfl.geom.ColorTransform.__toLimeColorMatrix","openfl/geom/ColorTransform.hx",196,0x850de941)
namespace openfl{
namespace geom{
...
HXLINE(  54)		this->redOffset = ((second->redOffset * this->redMultiplier) + this->redOffset);
HXLINE(  55)		this->greenOffset = ((second->greenOffset * this->greenMultiplier) + this->greenOffset);
HXLINE(  56)		this->blueOffset = ((second->blueOffset * this->blueMultiplier) + this->blueOffset);
HXLINE(  57)		this->alphaOffset = ((second->alphaOffset * this->alphaMultiplier) + this->alphaOffset);
HXLINE(  59)		 ::openfl::geom::ColorTransform _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  59)		_hx_tmp->redMultiplier = (_hx_tmp->redMultiplier * second->redMultiplier);
HXLINE(  60)		 ::openfl::geom::ColorTransform _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  60)		_hx_tmp1->greenMultiplier = (_hx_tmp1->greenMultiplier * second->greenMultiplier);
HXLINE(  61)		 ::openfl::geom::ColorTransform _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  61)		_hx_tmp2->blueMultiplier = (_hx_tmp2->blueMultiplier * second->blueMultiplier);
HXLINE(  62)		 ::openfl::geom::ColorTransform _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  62)		_hx_tmp3->alphaMultiplier = (_hx_tmp3->alphaMultiplier * second->alphaMultiplier);
            	}
...
void ColorTransform_obj::_hx___invert(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_125___invert)
HXLINE( 127)		this->redMultiplier = ((Float)(int)1 / (Float)this->redMultiplier);
HXLINE( 128)		this->greenMultiplier = ((Float)(int)1 / (Float)this->greenMultiplier);
HXLINE( 129)		this->blueMultiplier = ((Float)(int)1 / (Float)this->blueMultiplier);
HXLINE( 130)		this->alphaMultiplier = ((Float)(int)1 / (Float)this->alphaMultiplier);
HXLINE( 131)		this->redOffset = -(this->redOffset);
HXLINE( 132)		this->greenOffset = -(this->greenOffset);
HXLINE( 133)		this->blueOffset = -(this->blueOffset);
HXLINE( 134)		this->alphaOffset = -(this->alphaOffset);
            	}
...
bool ColorTransform_obj::_hx___equals( ::openfl::geom::ColorTransform ct, ::Dynamic __o_skipAlphaMultiplier){
 ::Dynamic skipAlphaMultiplier = __o_skipAlphaMultiplier.Default(false);
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_141___equals)
...
HXDLIN( 141)		if (hx::IsNotNull( ct )) {
HXDLIN( 141)			_hx_tmp6 = (this->redMultiplier == ct->redMultiplier);
            		}
            		else {
HXDLIN( 141)			_hx_tmp6 = false;
            		}
HXDLIN( 141)		if (_hx_tmp6) {
HXDLIN( 141)			_hx_tmp5 = (this->greenMultiplier == ct->greenMultiplier);
            		}
            		else {
HXDLIN( 141)			_hx_tmp5 = false;
            		}
HXDLIN( 141)		if (_hx_tmp5) {
HXDLIN( 141)			_hx_tmp4 = (this->blueMultiplier == ct->blueMultiplier);
            		}
            		else {
HXDLIN( 141)			_hx_tmp4 = false;
            		}
HXDLIN( 141)		if (_hx_tmp4) {
HXDLIN( 141)			if (!(skipAlphaMultiplier)) {
HXDLIN( 141)				_hx_tmp3 = (this->alphaMultiplier == ct->alphaMultiplier);
            			}
            			else {
HXDLIN( 141)				_hx_tmp3 = true;
            			}
            		}
            		else {
HXDLIN( 141)			_hx_tmp3 = false;
            		}
HXDLIN( 141)		if (_hx_tmp3) {
HXDLIN( 141)			_hx_tmp2 = (this->redOffset == ct->redOffset);
            		}
            		else {
HXDLIN( 141)			_hx_tmp2 = false;
            		}
HXDLIN( 141)		if (_hx_tmp2) {
HXDLIN( 141)			_hx_tmp1 = (this->greenOffset == ct->greenOffset);
            		}
            		else {
HXDLIN( 141)			_hx_tmp1 = false;
            		}
HXDLIN( 141)		if (_hx_tmp1) {
HXDLIN( 141)			_hx_tmp = (this->blueOffset == ct->blueOffset);
            		}
            		else {
HXDLIN( 141)			_hx_tmp = false;
            		}
HXDLIN( 141)		if (_hx_tmp) {
HXDLIN( 141)			return (this->alphaOffset == ct->alphaOffset);
            		}
            		else {
...
bool ColorTransform_obj::_hx___isDefault(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_148___isDefault)
...
HXDLIN( 148)		if ((this->redMultiplier == (int)1)) {
HXDLIN( 148)			_hx_tmp5 = (this->greenMultiplier == (int)1);
            		}
            		else {
HXDLIN( 148)			_hx_tmp5 = false;
            		}
HXDLIN( 148)		if (_hx_tmp5) {
HXDLIN( 148)			_hx_tmp4 = (this->blueMultiplier == (int)1);
            		}
            		else {
HXDLIN( 148)			_hx_tmp4 = false;
            		}
HXDLIN( 148)		if (_hx_tmp4) {
HXDLIN( 148)			_hx_tmp3 = (this->alphaMultiplier == (int)1);
            		}
            		else {
HXDLIN( 148)			_hx_tmp3 = false;
            		}
HXDLIN( 148)		if (_hx_tmp3) {
HXDLIN( 148)			_hx_tmp2 = (this->redOffset == (int)0);
            		}
            		else {
HXDLIN( 148)			_hx_tmp2 = false;
            		}
HXDLIN( 148)		if (_hx_tmp2) {
HXDLIN( 148)			_hx_tmp1 = (this->greenOffset == (int)0);
            		}
            		else {
HXDLIN( 148)			_hx_tmp1 = false;
            		}
HXDLIN( 148)		if (_hx_tmp1) {
HXDLIN( 148)			_hx_tmp = (this->blueOffset == (int)0);
            		}
            		else {
HXDLIN( 148)			_hx_tmp = false;
            		}
HXDLIN( 148)		if (_hx_tmp) {
HXDLIN( 148)			return (this->alphaOffset == (int)0);
            		}
            		else {
...
void ColorTransform_obj::_hx___setArrays(::Array< Float > colorMultipliers,::Array< Float > colorOffsets){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_153___setArrays)
HXLINE( 155)		colorMultipliers[(int)0] = this->redMultiplier;
HXLINE( 156)		colorMultipliers[(int)1] = this->greenMultiplier;
HXLINE( 157)		colorMultipliers[(int)2] = this->blueMultiplier;
HXLINE( 158)		colorMultipliers[(int)3] = this->alphaMultiplier;
HXLINE( 159)		colorOffsets[(int)0] = this->redOffset;
HXLINE( 160)		colorOffsets[(int)1] = this->greenOffset;
HXLINE( 161)		colorOffsets[(int)2] = this->blueOffset;
HXLINE( 162)		colorOffsets[(int)3] = this->alphaOffset;
            	}
...
HXDLIN( 176)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
HXDLIN( 176)		int _hx_tmp1 = ((int)_hx_tmp | (int)((int)::Std_obj::_hx_int(this->greenOffset) << (int)(int)8));
HXDLIN( 176)		return ((int)_hx_tmp1 | (int)::Std_obj::_hx_int(this->blueOffset));
            	}
...
int ColorTransform_obj::set_color(int value){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_181_set_color)
HXLINE( 183)		this->redOffset = ((int)((int)value >> (int)(int)16) & (int)(int)255);
HXLINE( 184)		this->greenOffset = ((int)((int)value >> (int)(int)8) & (int)(int)255);
HXLINE( 185)		this->blueOffset = ((int)value & (int)(int)255);
HXLINE( 187)		this->redMultiplier = (int)0;
HXLINE( 188)		this->greenMultiplier = (int)0;
HXLINE( 189)		this->blueMultiplier = (int)0;
HXLINE( 191)		return this->get_color();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ColorTransform_obj,set_color,return )
 ...
 ::lime::utils::ArrayBufferView ColorTransform_obj::_hx___toLimeColorMatrix(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_196___toLimeColorMatrix)
HXLINE( 198)		if (hx::IsNull( ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix )) {
HXLINE( 200)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)20,(int)8);
HXDLIN( 200)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix = this1;
            		}
HXLINE( 204)		{
HXLINE( 204)			 ::lime::utils::ArrayBufferView this2 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 204)			Float val = this->redMultiplier;
HXDLIN( 204)			::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            		}
HXLINE( 205)		{
HXLINE( 205)			 ::lime::utils::ArrayBufferView this3 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 205)			Float val1 = ((Float)this->redOffset / (Float)(int)255);
HXDLIN( 205)			::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)16),val1);
            		}
HXLINE( 206)		{
HXLINE( 206)			 ::lime::utils::ArrayBufferView this4 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 206)			Float val2 = this->greenMultiplier;
HXDLIN( 206)			::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)24),val2);
            		}
HXLINE( 207)		{
HXLINE( 207)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 207)			Float val3 = ((Float)this->greenOffset / (Float)(int)255);
HXDLIN( 207)			::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)36),val3);
            		}
HXLINE( 208)		{
HXLINE( 208)			 ::lime::utils::ArrayBufferView this6 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 208)			Float val4 = this->blueMultiplier;
HXDLIN( 208)			::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)48),val4);
            		}
HXLINE( 209)		{
HXLINE( 209)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 209)			Float val5 = ((Float)this->blueOffset / (Float)(int)255);
HXDLIN( 209)			::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)56),val5);
            		}
HXLINE( 210)		{
HXLINE( 210)			 ::lime::utils::ArrayBufferView this8 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 210)			Float val6 = this->alphaMultiplier;
HXDLIN( 210)			::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)72),val6);
            		}
HXLINE( 211)		{
HXLINE( 211)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 211)			Float val7 = ((Float)this->alphaOffset / (Float)(int)255);
HXDLIN( 211)			::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)76),val7);
            		}
HXLINE( 213)		return ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
            	}
