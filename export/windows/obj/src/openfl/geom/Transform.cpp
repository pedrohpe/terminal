...
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_85_get_concatenatedMatrix,"openfl.geom.Transform","get_concatenatedMatrix",0x352d276f,"openfl.geom.Transform.get_concatenatedMatrix","openfl/geom/Transform.hx",85,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_98_get_matrix,"openfl.geom.Transform","get_matrix",0x80c3ba80,"openfl.geom.Transform.get_matrix","openfl/geom/Transform.hx",98,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_111_set_matrix,"openfl.geom.Transform","set_matrix",0x844158f4,"openfl.geom.Transform.set_matrix","openfl/geom/Transform.hx",111,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_134_get_matrix3D,"openfl.geom.Transform","get_matrix3D",0x05078731,"openfl.geom.Transform.get_matrix3D","openfl/geom/Transform.hx",134,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_148_set_matrix3D,"openfl.geom.Transform","set_matrix3D",0x1a00aaa5,"openfl.geom.Transform.set_matrix3D","openfl/geom/Transform.hx",148,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_169___setTransform,"openfl.geom.Transform","__setTransform",0x9df9f800,"openfl.geom.Transform.__setTransform","openfl/geom/Transform.hx",169,0xf4f475e6)
namespace openfl{
namespace geom{
...
HXLINE(  76)			{
HXLINE(  76)				 ::openfl::display::DisplayObject _this = this->_hx___displayObject;
HXDLIN(  76)				if (!(_this->_hx___renderDirty)) {
HXLINE(  76)					_this->_hx___renderDirty = true;
HXDLIN(  76)					_this->_hx___setParentRenderDirty();
            				}
            			}
            		}
HXLINE(  80)		return this->_hx___colorTransform;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_colorTransform,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_concatenatedMatrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_85_get_concatenatedMatrix)
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_concatenatedMatrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_98_get_matrix)
HXLINE( 100)		if (this->_hx___hasMatrix) {
HXLINE( 102)			return this->_hx___displayObject->_hx___transform->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::set_matrix( ::openfl::geom::Matrix value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_111_set_matrix)
HXLINE( 113)		if (hx::IsNull( value )) {
HXLINE( 115)			this->_hx___hasMatrix = false;
HXLINE( 116)			return null();
            		}
HXLINE( 120)		this->_hx___hasMatrix = true;
HXLINE( 121)		this->_hx___hasMatrix3D = false;
HXLINE( 123)		if (hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 125)			this->_hx___setTransform(value->a,value->b,value->c,value->d,value->tx,value->ty);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_matrix,return )
 ...
 ::openfl::geom::Matrix3D Transform_obj::get_matrix3D(){
            	HX_GC_STACKFRAME(&_hx_pos_c4822148baac23ea_134_get_matrix3D)
HXLINE( 136)		if (this->_hx___hasMatrix3D) {
HXLINE( 138)			 ::openfl::geom::Matrix matrix = this->_hx___displayObject->_hx___transform;
HXLINE( 139)			::Array< Float > a = ::Array_obj< Float >::__new(16)->init(0,matrix->a)->init(1,matrix->b)->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,matrix->c)->init(5,matrix->d)->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,matrix->tx)->init(13,matrix->ty)->init(14,((Float)0.0))->init(15,((Float)1.0));
HXDLIN( 139)			int length = null();
HXDLIN( 139)			bool fixed = null();
HXDLIN( 139)			 ::openfl::_Vector::FloatVector vector =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null(),true);
HXDLIN( 139)			{
HXLINE( 139)				int _g1 = (int)0;
HXDLIN( 139)				int _g = a->length;
...
HXDLIN( 139)			return  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,vector);
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix3D,return )
 ...
 ::openfl::geom::Matrix3D Transform_obj::set_matrix3D( ::openfl::geom::Matrix3D value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_148_set_matrix3D)
...
HXLINE( 160)		Float _hx_tmp = value->rawData->get((int)0);
HXDLIN( 160)		Float _hx_tmp1 = value->rawData->get((int)1);
HXDLIN( 160)		Float _hx_tmp2 = value->rawData->get((int)5);
HXDLIN( 160)		Float _hx_tmp3 = value->rawData->get((int)6);
HXDLIN( 160)		Float _hx_tmp4 = value->rawData->get((int)12);
HXDLIN( 160)		this->_hx___setTransform(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,value->rawData->get((int)13));
...
void Transform_obj::_hx___setTransform(Float a,Float b,Float c,Float d,Float tx,Float ty){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_169___setTransform)
HXDLIN( 169)		if (hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 171)			Float scaleX = ((Float)0.0);
HXLINE( 172)			Float scaleY = ((Float)0.0);
HXLINE( 174)			if ((b == (int)0)) {
HXLINE( 176)				scaleX = a;
            			}
            			else {
HXLINE( 180)				scaleX = ::Math_obj::sqrt(((a * a) + (b * b)));
            			}
HXLINE( 184)			if ((c == (int)0)) {
HXLINE( 186)				scaleY = a;
            			}
            			else {
HXLINE( 190)				scaleY = ::Math_obj::sqrt(((c * c) + (d * d)));
            			}
HXLINE( 194)			this->_hx___displayObject->_hx___scaleX = scaleX;
HXLINE( 195)			this->_hx___displayObject->_hx___scaleY = scaleY;
HXLINE( 197)			Float rotation = ((Float)(int)180 / (Float)::Math_obj::PI);
HXDLIN( 197)			Float rotation1 = ((rotation * ::Math_obj::atan2(d,c)) - (int)90);
HXLINE( 199)			if ((rotation1 != this->_hx___displayObject->_hx___rotation)) {
HXLINE( 201)				this->_hx___displayObject->_hx___rotation = rotation1;
HXLINE( 202)				Float radians = (rotation1 * ((Float)::Math_obj::PI / (Float)(int)180));
HXLINE( 203)				this->_hx___displayObject->_hx___rotationSine = ::Math_obj::sin(radians);
HXLINE( 204)				this->_hx___displayObject->_hx___rotationCosine = ::Math_obj::cos(radians);
            			}
HXLINE( 208)			this->_hx___displayObject->_hx___transform->a = a;
HXLINE( 209)			this->_hx___displayObject->_hx___transform->b = b;
HXLINE( 210)			this->_hx___displayObject->_hx___transform->c = c;
HXLINE( 211)			this->_hx___displayObject->_hx___transform->d = d;
HXLINE( 212)			this->_hx___displayObject->_hx___transform->tx = tx;
HXLINE( 213)			this->_hx___displayObject->_hx___transform->ty = ty;
HXLINE( 215)			this->_hx___displayObject->_hx___setTransformDirty();
            		}
            	}
