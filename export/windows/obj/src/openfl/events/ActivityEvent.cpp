...
HX_DEFINE_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_18_new,"openfl.events.ActivityEvent","new",0x259c5826,"openfl.events.ActivityEvent.new","openfl/events/ActivityEvent.hx",18,0x98f9202a)
HX_LOCAL_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_27_clone,"openfl.events.ActivityEvent","clone",0xb6b198a3,"openfl.events.ActivityEvent.clone","openfl/events/ActivityEvent.hx",27,0x98f9202a)
HX_LOCAL_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_40_toString,"openfl.events.ActivityEvent","toString",0x46865b26,"openfl.events.ActivityEvent.toString","openfl/events/ActivityEvent.hx",40,0x98f9202a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_13_boot,"openfl.events.ActivityEvent","boot",0xbb49c9ac,"openfl.events.ActivityEvent.boot","openfl/events/ActivityEvent.hx",13,0x98f9202a)
namespace openfl{
namespace events{
...
bool activating = __o_activating.Default(false);
            	HX_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_18_new)
...
bool ActivityEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ActivityEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_27_clone)
HXLINE(  29)		 ::openfl::events::ActivityEvent event =  ::openfl::events::ActivityEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->activating);
...
::String ActivityEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_40_toString)
HXDLIN(  40)		return this->_hx___formatToString(HX_("ActivityEvent",ab,eb,0c,59),::Array_obj< ::String >::fromData( _hx_array_data_a0800d34_3,4));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_13_boot)
HXDLIN(  13)		ACTIVITY = HX_("activity",cf,2d,b2,e5);
            	}
}
