...
HX_DEFINE_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_44_new,"openfl.events.TouchEvent","new",0xe223a0c4,"openfl.events.TouchEvent.new","openfl/events/TouchEvent.hx",44,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_68_clone,"openfl.events.TouchEvent","clone",0x1a12c4c1,"openfl.events.TouchEvent.clone","openfl/events/TouchEvent.hx",68,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_81_toString,"openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",81,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_86_updateAfterEvent,"openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",86,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_93___create,"openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",93,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_20_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",20,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_21_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",21,0x2fe85d0c)
...
bool isTouchPointCanceled = __o_isTouchPointCanceled.Default(false);
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_44_new)
HXLINE(  46)		super::__construct(type,bubbles,cancelable);
HXLINE(  48)		this->touchPointID = touchPointID;
HXLINE(  49)		this->isPrimaryTouchPoint = isPrimaryTouchPoint;
HXLINE(  50)		this->localX = localX;
HXLINE(  51)		this->localY = localY;
HXLINE(  52)		this->sizeX = sizeX;
HXLINE(  53)		this->sizeY = sizeY;
HXLINE(  54)		this->pressure = pressure;
HXLINE(  55)		this->relatedObject = relatedObject;
HXLINE(  56)		this->ctrlKey = ctrlKey;
HXLINE(  57)		this->altKey = altKey;
HXLINE(  58)		this->shiftKey = shiftKey;
HXLINE(  59)		this->commandKey = commandKey;
HXLINE(  60)		this->controlKey = controlKey;
HXLINE(  62)		this->stageX = ::Math_obj::NaN;
HXLINE(  63)		this->stageY = ::Math_obj::NaN;
            	}
...
bool TouchEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_68_clone)
HXLINE(  70)		 ::openfl::events::TouchEvent event =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey,this->controlKey,null(),null(),null(),null());
...
::String TouchEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_81_toString)
HXDLIN(  81)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_e5132ed2_3,16));
            	}


void TouchEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_86_updateAfterEvent)
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_93___create)
HXLINE(  95)		 ::openfl::events::TouchEvent evt =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,(int)0,true,local->x,local->y,(int)1,(int)1,(int)1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  96)		evt->stageX = stageX;
HXLINE(  97)		evt->stageY = stageY;
HXLINE(  98)		evt->target = target;
HXLINE( 100)		return evt;
            	}
...
HXDLIN(  17)		TOUCH_BEGIN = HX_("touchBegin",ea,cd,e6,a9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_18_boot)
HXDLIN(  18)		TOUCH_END = HX_("touchEnd",5c,c5,09,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_19_boot)
HXDLIN(  19)		TOUCH_MOVE = HX_("touchMove",70,72,cd,0d);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_20_boot)
HXDLIN(  20)		TOUCH_OUT = HX_("touchOut",0f,62,11,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_21_boot)
HXDLIN(  21)		TOUCH_OVER = HX_("touchOver",b3,20,25,0f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_22_boot)
HXDLIN(  22)		TOUCH_ROLL_OUT = HX_("touchRollOut",12,0f,74,87);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_23_boot)
HXDLIN(  23)		TOUCH_ROLL_OVER = HX_("touchRollOver",50,d6,19,fe);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_24_boot)
HXDLIN(  24)		TOUCH_TAP = HX_("touchTap",e4,1b,15,00);
            	}
}
