...
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_25_new,"openfl.events.FocusEvent","new",0xf00a0d8b,"openfl.events.FocusEvent.new","openfl/events/FocusEvent.hx",25,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_36_clone,"openfl.events.FocusEvent","clone",0x40033148,"openfl.events.FocusEvent.clone","openfl/events/FocusEvent.hx",36,0xe559e625)
...
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_17_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",17,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_18_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",18,0xe559e625)
namespace openfl{
namespace events{
...
int keyCode = __o_keyCode.Default(0);
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_25_new)
HXLINE(  27)		super::__construct(type,bubbles,cancelable);
HXLINE(  29)		this->keyCode = keyCode;
HXLINE(  30)		this->shiftKey = shiftKey;
HXLINE(  31)		this->relatedObject = relatedObject;
            	}
...
bool FocusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FocusEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_36_clone)
HXLINE(  38)		 ::openfl::events::FocusEvent event =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->relatedObject,this->shiftKey,this->keyCode);
HXLINE(  39)		event->target = this->target;
HXLINE(  40)		event->currentTarget = this->currentTarget;
HXLINE(  41)		event->eventPhase = this->eventPhase;
HXLINE(  42)		return event;
            	}
...
HXDLIN(  15)		FOCUS_IN = HX_("focusIn",dd,45,83,41);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_16_boot)
HXDLIN(  16)		FOCUS_OUT = HX_("focusOut",96,6f,5e,11);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_17_boot)
HXDLIN(  17)		KEY_FOCUS_CHANGE = HX_("keyFocusChange",09,9c,8e,e5);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_18_boot)
HXDLIN(  18)		MOUSE_FOCUS_CHANGE = HX_("mouseFocusChange",43,f1,81,96);
            	}
}
