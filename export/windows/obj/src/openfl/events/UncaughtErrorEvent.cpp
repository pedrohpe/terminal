...
HX_DEFINE_STACK_FRAME(_hx_pos_c2f85669dc13e38b_18_new,"openfl.events.UncaughtErrorEvent","new",0x17652810,"openfl.events.UncaughtErrorEvent.new","openfl/events/UncaughtErrorEvent.hx",18,0x0dad2340)
HX_LOCAL_STACK_FRAME(_hx_pos_c2f85669dc13e38b_27_clone,"openfl.events.UncaughtErrorEvent","clone",0x483db70d,"openfl.events.UncaughtErrorEvent.clone","openfl/events/UncaughtErrorEvent.hx",27,0x0dad2340)
HX_LOCAL_STACK_FRAME(_hx_pos_c2f85669dc13e38b_40_toString,"openfl.events.UncaughtErrorEvent","toString",0x4ef19afc,"openfl.events.UncaughtErrorEvent.toString","openfl/events/UncaughtErrorEvent.hx",40,0x0dad2340)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c2f85669dc13e38b_13_boot,"openfl.events.UncaughtErrorEvent","boot",0x5936e682,"openfl.events.UncaughtErrorEvent.boot","openfl/events/UncaughtErrorEvent.hx",13,0x0dad2340)
namespace openfl{
namespace events{
...
bool cancelable = __o_cancelable.Default(true);
            	HX_STACKFRAME(&_hx_pos_c2f85669dc13e38b_18_new)
...
bool UncaughtErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event UncaughtErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c2f85669dc13e38b_27_clone)
HXLINE(  29)		 ::openfl::events::UncaughtErrorEvent event =  ::openfl::events::UncaughtErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->error);
HXLINE(  30)		event->target = this->target;
HXLINE(  31)		event->currentTarget = this->currentTarget;
HXLINE(  32)		event->eventPhase = this->eventPhase;
HXLINE(  33)		return event;
            	}


::String UncaughtErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c2f85669dc13e38b_40_toString)
HXDLIN(  40)		return this->_hx___formatToString(HX_("UncaughtErrorEvent",47,72,9a,e0),::Array_obj< ::String >::fromData( _hx_array_data_4614201e_3,4));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c2f85669dc13e38b_13_boot)
HXDLIN(  13)		UNCAUGHT_ERROR = HX_("uncaughtError",f3,98,8b,8b);
            	}
}
