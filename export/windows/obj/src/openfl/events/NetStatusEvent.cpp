...
HX_DEFINE_STACK_FRAME(_hx_pos_27135fd1b85393b6_18_new,"openfl.events.NetStatusEvent","new",0x7499fa94,"openfl.events.NetStatusEvent.new","openfl/events/NetStatusEvent.hx",18,0xf85a9d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_27_clone,"openfl.events.NetStatusEvent","clone",0xfa2f3291,"openfl.events.NetStatusEvent.clone","openfl/events/NetStatusEvent.hx",27,0xf85a9d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_40_toString,"openfl.events.NetStatusEvent","toString",0x4e1f29f8,"openfl.events.NetStatusEvent.toString","openfl/events/NetStatusEvent.hx",40,0xf85a9d3c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_13_boot,"openfl.events.NetStatusEvent","boot",0x8a3a477e,"openfl.events.NetStatusEvent.boot","openfl/events/NetStatusEvent.hx",13,0xf85a9d3c)
namespace openfl{
namespace events{
...
bool cancelable = __o_cancelable.Default(false);
            	HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_18_new)
HXLINE(  20)		this->info = info;
...
bool NetStatusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event NetStatusEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_27135fd1b85393b6_27_clone)
HXLINE(  29)		 ::openfl::events::NetStatusEvent event =  ::openfl::events::NetStatusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->info);
...
::String NetStatusEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_40_toString)
HXDLIN(  40)		return this->_hx___formatToString(HX_("NetStatusEvent",4b,2a,fa,67),::Array_obj< ::String >::fromData( _hx_array_data_a54460a2_3,4));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_13_boot)
HXDLIN(  13)		NET_STATUS = HX_("netStatus",6f,4f,ec,46);
            	}
}
