...
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_19_new,"openfl.events.TextEvent","new",0x29e58508,"openfl.events.TextEvent.new","openfl/events/TextEvent.hx",19,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_28_clone,"openfl.events.TextEvent","clone",0x41494205,"openfl.events.TextEvent.clone","openfl/events/TextEvent.hx",28,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_41_toString,"openfl.events.TextEvent","toString",0x2a253b04,"openfl.events.TextEvent.toString","openfl/events/TextEvent.hx",41,0x23b91588)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_13_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",13,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_14_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",14,0x23b91588)
namespace openfl{
namespace events{
...
::String text = __o_text.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_19_new)
...
bool TextEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TextEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a9542994cee360f6_28_clone)
HXLINE(  30)		 ::openfl::events::TextEvent event =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text);
...
::String TextEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_41_toString)
HXDLIN(  41)		return this->_hx___formatToString(HX_("TextEvent",0d,38,85,b0),::Array_obj< ::String >::fromData( _hx_array_data_52f4a116_3,4));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_13_boot)
HXDLIN(  13)		LINK = HX_("link",fa,17,b3,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_14_boot)
HXDLIN(  14)		TEXT_INPUT = HX_("textInput",1d,54,0b,57);
            	}
}
