...
HX_DEFINE_STACK_FRAME(_hx_pos_b09527e17bebd012_20_new,"openfl.events.ProgressEvent","new",0xeed66288,"openfl.events.ProgressEvent.new","openfl/events/ProgressEvent.hx",20,0xea3bf808)
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_30_clone,"openfl.events.ProgressEvent","clone",0xca4c7f85,"openfl.events.ProgressEvent.clone","openfl/events/ProgressEvent.hx",30,0xea3bf808)
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_43_toString,"openfl.events.ProgressEvent","toString",0x8ba16d84,"openfl.events.ProgressEvent.toString","openfl/events/ProgressEvent.hx",43,0xea3bf808)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_13_boot,"openfl.events.ProgressEvent","boot",0x04d8d50a,"openfl.events.ProgressEvent.boot","openfl/events/ProgressEvent.hx",13,0xea3bf808)
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_14_boot,"openfl.events.ProgressEvent","boot",0x04d8d50a,"openfl.events.ProgressEvent.boot","openfl/events/ProgressEvent.hx",14,0xea3bf808)
namespace openfl{
namespace events{
...
Float bytesTotal = __o_bytesTotal.Default(0);
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_20_new)
...
bool ProgressEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ProgressEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_b09527e17bebd012_30_clone)
HXLINE(  32)		 ::openfl::events::ProgressEvent event =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->bytesLoaded,this->bytesTotal);
HXLINE(  33)		event->target = this->target;
HXLINE(  34)		event->currentTarget = this->currentTarget;
HXLINE(  35)		event->eventPhase = this->eventPhase;
HXLINE(  36)		return event;
            	}


::String ProgressEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_43_toString)
HXDLIN(  43)		return this->_hx___formatToString(HX_("ProgressEvent",0d,9d,55,84),::Array_obj< ::String >::fromData( _hx_array_data_cbc8be96_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_13_boot)
HXDLIN(  13)		PROGRESS = HX_("progress",ad,f7,2a,86);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_14_boot)
HXDLIN(  14)		SOCKET_DATA = HX_("socketData",7d,63,de,b1);
            	}
}
