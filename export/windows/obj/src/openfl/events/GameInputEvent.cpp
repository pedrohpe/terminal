...
HX_DEFINE_STACK_FRAME(_hx_pos_a9944c00dfbe9396_22_new,"openfl.events.GameInputEvent","new",0x8065662b,"openfl.events.GameInputEvent.new","openfl/events/GameInputEvent.hx",22,0x5318f185)
HX_LOCAL_STACK_FRAME(_hx_pos_a9944c00dfbe9396_31_clone,"openfl.events.GameInputEvent","clone",0x205df1e8,"openfl.events.GameInputEvent.clone","openfl/events/GameInputEvent.hx",31,0x5318f185)
HX_LOCAL_STACK_FRAME(_hx_pos_a9944c00dfbe9396_44_toString,"openfl.events.GameInputEvent","toString",0x31f35b01,"openfl.events.GameInputEvent.toString","openfl/events/GameInputEvent.hx",44,0x5318f185)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a9944c00dfbe9396_16_boot,"openfl.events.GameInputEvent","boot",0xd06d0007,"openfl.events.GameInputEvent.boot","openfl/events/GameInputEvent.hx",16,0x5318f185)
HX_LOCAL_STACK_FRAME(_hx_pos_a9944c00dfbe9396_17_boot,"openfl.events.GameInputEvent","boot",0xd06d0007,"openfl.events.GameInputEvent.boot","openfl/events/GameInputEvent.hx",17,0x5318f185)
namespace openfl{
namespace events{
...
bool cancelable = __o_cancelable.Default(false);
            	HX_STACKFRAME(&_hx_pos_a9944c00dfbe9396_22_new)
...
bool GameInputEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event GameInputEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a9944c00dfbe9396_31_clone)
HXLINE(  33)		 ::openfl::events::GameInputEvent event =  ::openfl::events::GameInputEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->device);
...
::String GameInputEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a9944c00dfbe9396_44_toString)
HXDLIN(  44)		return this->_hx___formatToString(HX_("GameInputEvent",62,3e,f4,2c),::Array_obj< ::String >::fromData( _hx_array_data_6a3e74b9_3,4));
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_a9944c00dfbe9396_16_boot)
HXDLIN(  16)		DEVICE_REMOVED = HX_("deviceRemoved",aa,c9,5b,59);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9944c00dfbe9396_17_boot)
HXDLIN(  17)		DEVICE_UNUSABLE = HX_("deviceUnusable",c7,a8,5e,6b);
            	}
}
