...
HX_DEFINE_STACK_FRAME(_hx_pos_9acd580c71eb88b0_20_new,"openfl.events.FullScreenEvent","new",0x08c8725a,"openfl.events.FullScreenEvent.new","openfl/events/FullScreenEvent.hx",20,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_32_clone,"openfl.events.FullScreenEvent","clone",0xd0bfa7d7,"openfl.events.FullScreenEvent.clone","openfl/events/FullScreenEvent.hx",32,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_45_toString,"openfl.events.FullScreenEvent","toString",0x75cac472,"openfl.events.FullScreenEvent.toString","openfl/events/FullScreenEvent.hx",45,0x5d391076)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_13_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",13,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_14_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",14,0x5d391076)
namespace openfl{
namespace events{
...
bool interactive = __o_interactive.Default(false);
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_20_new)
HXLINE(  24)		super::__construct(type,bubbles,cancelable,null());
HXLINE(  26)		this->fullScreen = fullScreen;
HXLINE(  27)		this->interactive = interactive;
            	}
...
bool FullScreenEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FullScreenEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_9acd580c71eb88b0_32_clone)
HXLINE(  34)		 ::openfl::events::FullScreenEvent event =  ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->fullScreen,this->interactive);
HXLINE(  35)		event->target = this->target;
HXLINE(  36)		event->currentTarget = this->currentTarget;
HXLINE(  37)		event->eventPhase = this->eventPhase;
HXLINE(  38)		return event;
            	}


::String FullScreenEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_45_toString)
HXDLIN(  45)		return this->_hx___formatToString(HX_("FullscreenEvent",bf,0f,46,0d),::Array_obj< ::String >::fromData( _hx_array_data_551dfd68_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_13_boot)
HXDLIN(  13)		FULL_SCREEN = HX_("fullScreen",5b,ae,48,2e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_14_boot)
HXDLIN(  14)		FULL_SCREEN_INTERACTIVE_ACCEPTED = HX_("fullScreenInteractiveAccepted",ce,77,06,29);
            	}
}
