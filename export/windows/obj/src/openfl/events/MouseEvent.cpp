...
HX_DEFINE_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_55_new,"openfl.events.MouseEvent","new",0x5c6da59e,"openfl.events.MouseEvent.new","openfl/events/MouseEvent.hx",55,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_90_clone,"openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",90,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_103_toString,"openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",103,0xd3783172)
...
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_108_updateAfterEvent,"openfl.events.MouseEvent","updateAfterEvent",0xc76737c9,"openfl.events.MouseEvent.updateAfterEvent","openfl/events/MouseEvent.hx",108,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_78___create,"openfl.events.MouseEvent","__create",0x1b813c1e,"openfl.events.MouseEvent.__create","openfl/events/MouseEvent.hx",78,0xd3783172)
...
int clickCount = __o_clickCount.Default(0);
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_55_new)
HXLINE(  57)		super::__construct(type,bubbles,cancelable);
HXLINE(  59)		this->shiftKey = shiftKey;
HXLINE(  60)		this->altKey = altKey;
HXLINE(  61)		this->ctrlKey = ctrlKey;
HXLINE(  62)		this->bubbles = bubbles;
HXLINE(  63)		this->relatedObject = relatedObject;
HXLINE(  64)		this->delta = delta;
HXLINE(  65)		this->localX = localX;
HXLINE(  66)		this->localY = localY;
HXLINE(  67)		this->buttonDown = buttonDown;
HXLINE(  68)		this->commandKey = commandKey;
HXLINE(  69)		this->clickCount = clickCount;
HXLINE(  71)		this->isRelatedObjectInaccessible = false;
HXLINE(  72)		this->stageX = ::Math_obj::NaN;
HXLINE(  73)		this->stageY = ::Math_obj::NaN;
            	}
...
bool MouseEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event MouseEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_90_clone)
HXLINE(  92)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
HXLINE(  93)		event->target = this->target;
HXLINE(  94)		event->currentTarget = this->currentTarget;
HXLINE(  95)		event->eventPhase = this->eventPhase;
HXLINE(  96)		return event;
            	}


::String MouseEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_103_toString)
HXDLIN( 103)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_094f3eac_3,11));
            	}


void MouseEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_108_updateAfterEvent)
            	}
...
int delta = __o_delta.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_78___create)
HXLINE(  80)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,type,true,false,local->x,local->y,null(),::openfl::events::MouseEvent_obj::_hx___ctrlKey,::openfl::events::MouseEvent_obj::_hx___altKey,::openfl::events::MouseEvent_obj::_hx___shiftKey,::openfl::events::MouseEvent_obj::_hx___buttonDown,delta,::openfl::events::MouseEvent_obj::_hx___commandKey,null());
HXLINE(  81)		event->stageX = stageX;
HXLINE(  82)		event->stageY = stageY;
HXLINE(  83)		event->target = target;
HXLINE(  85)		return event;
            	}
...
HXDLIN(  16)		CLICK = HX_("click",48,7c,5e,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_17_boot)
HXDLIN(  17)		DOUBLE_CLICK = HX_("doubleClick",77,03,76,cd);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_18_boot)
HXDLIN(  18)		MIDDLE_CLICK = HX_("middleClick",b3,e4,e5,43);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_19_boot)
HXDLIN(  19)		MIDDLE_MOUSE_DOWN = HX_("middleMouseDown",12,2b,fe,01);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_20_boot)
HXDLIN(  20)		MIDDLE_MOUSE_UP = HX_("middleMouseUp",0b,8d,f5,3a);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_21_boot)
HXDLIN(  21)		MOUSE_DOWN = HX_("mouseDown",27,b1,c2,ee);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_22_boot)
HXDLIN(  22)		MOUSE_MOVE = HX_("mouseMove",d6,9b,b5,f4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_23_boot)
HXDLIN(  23)		MOUSE_OUT = HX_("mouseOut",69,e7,1d,a4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_24_boot)
HXDLIN(  24)		MOUSE_OVER = HX_("mouseOver",19,4a,0d,f6);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_25_boot)
HXDLIN(  25)		MOUSE_UP = HX_("mouseUp",e0,f3,72,c0);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_26_boot)
HXDLIN(  26)		MOUSE_WHEEL = HX_("mouseWheel",36,28,87,e7);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_27_boot)
HXDLIN(  27)		RELEASE_OUTSIDE = HX_("releaseOutside",1e,86,e3,ad);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_28_boot)
HXDLIN(  28)		RIGHT_CLICK = HX_("rightClick",cc,62,23,4b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_29_boot)
HXDLIN(  29)		RIGHT_MOUSE_DOWN = HX_("rightMouseDown",ab,29,d7,cd);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_30_boot)
HXDLIN(  30)		RIGHT_MOUSE_UP = HX_("rightMouseUp",64,83,21,ab);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_31_boot)
HXDLIN(  31)		ROLL_OUT = HX_("rollOut",11,f9,11,5d);
            	}
{
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_32_boot)
HXDLIN(  32)		ROLL_OVER = HX_("rollOver",71,ab,a8,12);
            	}
}
