...
HX_DEFINE_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_18_new,"openfl.events.ErrorEvent","new",0x1354a39b,"openfl.events.ErrorEvent.new","openfl/events/ErrorEvent.hx",18,0x9d2fc215)
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_26_clone,"openfl.events.ErrorEvent","clone",0xbbab6b58,"openfl.events.ErrorEvent.clone","openfl/events/ErrorEvent.hx",26,0x9d2fc215)
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_39_toString,"openfl.events.ErrorEvent","toString",0x299f6791,"openfl.events.ErrorEvent.toString","openfl/events/ErrorEvent.hx",39,0x9d2fc215)
...
int id = __o_id.Default(0);
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_18_new)
HXLINE(  20)		super::__construct(type,bubbles,cancelable,text);
HXLINE(  21)		this->errorID = id;
            	}
...
bool ErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_26_clone)
...
::String ErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_39_toString)
HXDLIN(  39)		return this->_hx___formatToString(HX_("ErrorEvent",52,bb,79,e1),::Array_obj< ::String >::fromData( _hx_array_data_60863a29_3,5));
            	}
