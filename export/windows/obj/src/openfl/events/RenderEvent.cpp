...
HX_DEFINE_STACK_FRAME(_hx_pos_6a559adcb74b53ca_32_new,"openfl.events.RenderEvent","new",0x8fc9357f,"openfl.events.RenderEvent.new","openfl/events/RenderEvent.hx",32,0xf57c28f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_43_clone,"openfl.events.RenderEvent","clone",0xabd33e3c,"openfl.events.RenderEvent.clone","openfl/events/RenderEvent.hx",43,0xf57c28f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_56_toString,"openfl.events.RenderEvent","toString",0xf15b7b2d,"openfl.events.RenderEvent.toString","openfl/events/RenderEvent.hx",56,0xf57c28f1)
static const ::String _hx_array_data_d18b0a0d_3[] = {
	HX_("type",ba,f2,08,4d),HX_("bubbles",67,bb,56,61),HX_("cancelable",14,a0,79,c4),
};
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_20_boot,"openfl.events.RenderEvent","boot",0x385e9a33,"openfl.events.RenderEvent.boot","openfl/events/RenderEvent.hx",20,0xf57c28f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_21_boot,"openfl.events.RenderEvent","boot",0x385e9a33,"openfl.events.RenderEvent.boot","openfl/events/RenderEvent.hx",21,0xf57c28f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_22_boot,"openfl.events.RenderEvent","boot",0x385e9a33,"openfl.events.RenderEvent.boot","openfl/events/RenderEvent.hx",22,0xf57c28f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_23_boot,"openfl.events.RenderEvent","boot",0x385e9a33,"openfl.events.RenderEvent.boot","openfl/events/RenderEvent.hx",23,0xf57c28f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_24_boot,"openfl.events.RenderEvent","boot",0x385e9a33,"openfl.events.RenderEvent.boot","openfl/events/RenderEvent.hx",24,0xf57c28f1)
namespace openfl{
namespace events{
...
bool allowSmoothing = __o_allowSmoothing.Default(true);
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_32_new)
HXLINE(  34)		super::__construct(type,bubbles,cancelable);
HXLINE(  36)		this->objectMatrix = objectMatrix;
HXLINE(  37)		this->objectColorTransform = objectColorTransform;
HXLINE(  38)		this->allowSmoothing = allowSmoothing;
            	}
...
bool RenderEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event RenderEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_6a559adcb74b53ca_43_clone)
HXLINE(  45)		::String event = this->type;
HXDLIN(  45)		bool event1 = this->bubbles;
HXDLIN(  45)		bool event2 = this->cancelable;
HXDLIN(  45)		 ::openfl::geom::Matrix event3 = this->objectMatrix->clone();
HXDLIN(  45)		 ::openfl::geom::ColorTransform event4 = this->objectColorTransform->_hx___clone();
HXDLIN(  45)		 ::openfl::events::RenderEvent event5 =  ::openfl::events::RenderEvent_obj::__alloc( HX_CTX ,event,event1,event2,event3,event4,this->allowSmoothing);
HXLINE(  46)		event5->target = this->target;
HXLINE(  47)		event5->currentTarget = this->currentTarget;
HXLINE(  48)		event5->eventPhase = this->eventPhase;
HXLINE(  49)		return event5;
            	}


::String RenderEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_56_toString)
HXDLIN(  56)		return this->_hx___formatToString(HX_("RenderEvent",c4,8c,a8,25),::Array_obj< ::String >::fromData( _hx_array_data_d18b0a0d_3,3));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_20_boot)
HXDLIN(  20)		CLEAR_DOM = HX_("clearDOM",f5,22,08,31);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_21_boot)
HXDLIN(  21)		RENDER_CAIRO = HX_("renderCairo",52,5d,ca,0c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_22_boot)
HXDLIN(  22)		RENDER_CANVAS = HX_("renderCanvas",ce,58,98,27);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_23_boot)
HXDLIN(  23)		RENDER_DOM = HX_("renderDOM",cc,ac,57,cd);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_24_boot)
HXDLIN(  24)		RENDER_OPENGL = HX_("renderOpenGL",65,4c,ea,90);
            	}
}
