...
HX_DEFINE_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_18_new,"openfl.events.SecurityErrorEvent","new",0x42af717b,"openfl.events.SecurityErrorEvent.new","openfl/events/SecurityErrorEvent.hx",18,0x4f4e3035)
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_23_clone,"openfl.events.SecurityErrorEvent","clone",0x91bd7138,"openfl.events.SecurityErrorEvent.clone","openfl/events/SecurityErrorEvent.hx",23,0x4f4e3035)
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_36_toString,"openfl.events.SecurityErrorEvent","toString",0xccee4db1,"openfl.events.SecurityErrorEvent.toString","openfl/events/SecurityErrorEvent.hx",36,0x4f4e3035)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_13_boot,"openfl.events.SecurityErrorEvent","boot",0x0eecdab7,"openfl.events.SecurityErrorEvent.boot","openfl/events/SecurityErrorEvent.hx",13,0x4f4e3035)
namespace openfl{
namespace events{
...
int id = __o_id.Default(0);
            	HX_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_18_new)
HXDLIN(  18)		super::__construct(type,bubbles,cancelable,text,id);
            	}
...
bool SecurityErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event SecurityErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_23_clone)
HXLINE(  25)		 ::openfl::events::SecurityErrorEvent event =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
HXLINE(  26)		event->target = this->target;
HXLINE(  27)		event->currentTarget = this->currentTarget;
HXLINE(  28)		event->eventPhase = this->eventPhase;
HXLINE(  29)		return event;
            	}


::String SecurityErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_36_toString)
HXDLIN(  36)		return this->_hx___formatToString(HX_("SecurityErrorEvent",32,ea,b2,a1),::Array_obj< ::String >::fromData( _hx_array_data_072c9809_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_13_boot)
HXDLIN(  13)		SECURITY_ERROR = HX_("securityError",e8,28,7c,a2);
            	}
}
