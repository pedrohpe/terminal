...
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_28_new,"openfl.events.KeyboardEvent","new",0xa9982e4e,"openfl.events.KeyboardEvent.new","openfl/events/KeyboardEvent.hx",28,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_44_clone,"openfl.events.KeyboardEvent","clone",0x11ed48cb,"openfl.events.KeyboardEvent.clone","openfl/events/KeyboardEvent.hx",44,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_57_toString,"openfl.events.KeyboardEvent","toString",0xd22933fe,"openfl.events.KeyboardEvent.toString","openfl/events/KeyboardEvent.hx",57,0xce5f4702)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_15_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",15,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_16_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",16,0xce5f4702)
namespace openfl{
namespace events{
...
bool commandKeyValue = __o_commandKeyValue.Default(false);
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_28_new)
HXLINE(  30)		super::__construct(type,bubbles,cancelable);
HXLINE(  32)		this->charCode = charCodeValue;
HXLINE(  33)		this->keyCode = keyCodeValue;
HXLINE(  34)		int _hx_tmp;
HXDLIN(  34)		if (hx::IsNotNull( keyLocationValue )) {
HXLINE(  34)			_hx_tmp = keyLocationValue;
            		}
            		else {
HXLINE(  34)			_hx_tmp = (int)0;
            		}
HXDLIN(  34)		this->keyLocation = _hx_tmp;
HXLINE(  35)		this->ctrlKey = ctrlKeyValue;
HXLINE(  36)		this->altKey = altKeyValue;
HXLINE(  37)		this->shiftKey = shiftKeyValue;
HXLINE(  38)		this->controlKey = controlKeyValue;
HXLINE(  39)		this->commandKey = commandKeyValue;
            	}
...
bool KeyboardEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event KeyboardEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c70c2341539e31f3_44_clone)
HXLINE(  46)		 ::openfl::events::KeyboardEvent event =  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
HXLINE(  47)		event->target = this->target;
HXLINE(  48)		event->currentTarget = this->currentTarget;
HXLINE(  49)		event->eventPhase = this->eventPhase;
HXLINE(  50)		return event;
            	}


::String KeyboardEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_57_toString)
HXDLIN(  57)		return this->_hx___formatToString(HX_("KeyboardEvent",d3,8d,88,91),::Array_obj< ::String >::fromData( _hx_array_data_d8fbaf5c_3,9));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_15_boot)
HXDLIN(  15)		KEY_DOWN = HX_("keyDown",a1,69,47,9c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_16_boot)
HXDLIN(  16)		KEY_UP = HX_("keyUp",da,b9,fe,de);
            	}
}
