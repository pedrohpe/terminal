...
HX_DEFINE_STACK_FRAME(_hx_pos_3e9f49414be9df9e_24_new,"openfl.events.HTTPStatusEvent","new",0x992d4c1b,"openfl.events.HTTPStatusEvent.new","openfl/events/HTTPStatusEvent.hx",24,0x9d0269d5)
HX_LOCAL_STACK_FRAME(_hx_pos_3e9f49414be9df9e_34_clone,"openfl.events.HTTPStatusEvent","clone",0xe75f33d8,"openfl.events.HTTPStatusEvent.clone","openfl/events/HTTPStatusEvent.hx",34,0x9d0269d5)
HX_LOCAL_STACK_FRAME(_hx_pos_3e9f49414be9df9e_47_toString,"openfl.events.HTTPStatusEvent","toString",0x9713ef11,"openfl.events.HTTPStatusEvent.toString","openfl/events/HTTPStatusEvent.hx",47,0x9d0269d5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3e9f49414be9df9e_15_boot,"openfl.events.HTTPStatusEvent","boot",0x668e4c17,"openfl.events.HTTPStatusEvent.boot","openfl/events/HTTPStatusEvent.hx",15,0x9d0269d5)
HX_LOCAL_STACK_FRAME(_hx_pos_3e9f49414be9df9e_16_boot,"openfl.events.HTTPStatusEvent","boot",0x668e4c17,"openfl.events.HTTPStatusEvent.boot","openfl/events/HTTPStatusEvent.hx",16,0x9d0269d5)
namespace openfl{
namespace events{
...
bool redirected = __o_redirected.Default(false);
            	HX_STACKFRAME(&_hx_pos_3e9f49414be9df9e_24_new)
HXLINE(  26)		this->status = status;
HXLINE(  27)		this->redirected = redirected;
HXLINE(  29)		super::__construct(type,bubbles,cancelable);
            	}
...
bool HTTPStatusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event HTTPStatusEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3e9f49414be9df9e_34_clone)
HXLINE(  36)		 ::openfl::events::HTTPStatusEvent event =  ::openfl::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->status,this->redirected);
HXLINE(  37)		event->target = this->target;
HXLINE(  38)		event->currentTarget = this->currentTarget;
HXLINE(  39)		event->eventPhase = this->eventPhase;
HXLINE(  40)		return event;
            	}


::String HTTPStatusEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_3e9f49414be9df9e_47_toString)
HXDLIN(  47)		return this->_hx___formatToString(HX_("HTTPStatusEvent",e0,4c,1b,fe),::Array_obj< ::String >::fromData( _hx_array_data_61c0a2a9_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_3e9f49414be9df9e_15_boot)
HXDLIN(  15)		HTTP_RESPONSE_STATUS = HX_("httpResponseStatus",3b,ae,f6,61);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3e9f49414be9df9e_16_boot)
HXDLIN(  16)		HTTP_STATUS = HX_("httpStatus",da,4c,74,0a);
            	}
}
