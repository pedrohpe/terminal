...
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_42_stopAll,"openfl.media.SoundMixer","stopAll",0x7ebb1d93,"openfl.media.SoundMixer.stopAll","openfl/media/SoundMixer.hx",42,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_53___registerSoundChannel,"openfl.media.SoundMixer","__registerSoundChannel",0x60ebf103,"openfl.media.SoundMixer.__registerSoundChannel","openfl/media/SoundMixer.hx",53,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_60___unregisterSoundChannel,"openfl.media.SoundMixer","__unregisterSoundChannel",0xb1bc24dc,"openfl.media.SoundMixer.__unregisterSoundChannel","openfl/media/SoundMixer.hx",60,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_74_get_soundTransform,"openfl.media.SoundMixer","get_soundTransform",0xc6a43892,"openfl.media.SoundMixer.get_soundTransform","openfl/media/SoundMixer.hx",74,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_79_set_soundTransform,"openfl.media.SoundMixer","set_soundTransform",0xa3536b06,"openfl.media.SoundMixer.set_soundTransform","openfl/media/SoundMixer.hx",79,0x17e3a43a)
...
void SoundMixer_obj::stopAll(){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_42_stopAll)
HXDLIN(  42)		int _g = (int)0;
HXDLIN(  42)		::Array< ::Dynamic> _g1 = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN(  42)		while((_g < _g1->length)){
HXDLIN(  42)			 ::openfl::media::SoundChannel channel = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
HXDLIN(  42)			_g = (_g + (int)1);
HXLINE(  44)			channel->stop();
            		}
            	}
...
void SoundMixer_obj::_hx___registerSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_53___registerSoundChannel)
HXDLIN(  53)		::openfl::media::SoundMixer_obj::_hx___soundChannels->push(soundChannel);
            	}
...
void SoundMixer_obj::_hx___unregisterSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_60___unregisterSoundChannel)
HXDLIN(  60)		::openfl::media::SoundMixer_obj::_hx___soundChannels->remove(soundChannel);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(SoundMixer_obj,_hx___unregisterSoundChannel,(void))
 ...
 ::openfl::media::SoundTransform SoundMixer_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_74_get_soundTransform)
HXDLIN(  74)		return ::openfl::media::SoundMixer_obj::_hx___soundTransform;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(SoundMixer_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundMixer_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_79_set_soundTransform)
HXLINE(  81)		::openfl::media::SoundMixer_obj::_hx___soundTransform = value->clone();
HXLINE(  83)		{
HXLINE(  83)			int _g = (int)0;
HXDLIN(  83)			::Array< ::Dynamic> _g1 = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN(  83)			while((_g < _g1->length)){
HXLINE(  83)				 ::openfl::media::SoundChannel channel = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
HXDLIN(  83)				_g = (_g + (int)1);
HXLINE(  85)				channel->_hx___updateTransform();
            			}
            		}
