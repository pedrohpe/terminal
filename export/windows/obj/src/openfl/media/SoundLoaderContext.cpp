...
HX_DEFINE_STACK_FRAME(_hx_pos_baeaab40d0a56ac0_17_new,"openfl.media.SoundLoaderContext","new",0xafd95147,"openfl.media.SoundLoaderContext.new","openfl/media/SoundLoaderContext.hx",17,0x79afda07)
namespace openfl{
namespace media{
...
bool checkPolicyFile = __o_checkPolicyFile.Default(false);
            	HX_STACKFRAME(&_hx_pos_baeaab40d0a56ac0_17_new)
HXLINE(  19)		this->bufferTime = bufferTime;
HXLINE(  20)		this->checkPolicyFile = checkPolicyFile;
            	}
