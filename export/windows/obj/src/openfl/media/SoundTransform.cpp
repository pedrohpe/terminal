...
HX_DEFINE_STACK_FRAME(_hx_pos_b69a1b3bd673fa32_21_new,"openfl.media.SoundTransform","new",0x75fea817,"openfl.media.SoundTransform.new","openfl/media/SoundTransform.hx",21,0xcbc8f637)
HX_LOCAL_STACK_FRAME(_hx_pos_b69a1b3bd673fa32_35_clone,"openfl.media.SoundTransform","clone",0xa03c86d4,"openfl.media.SoundTransform.clone","openfl/media/SoundTransform.hx",35,0xcbc8f637)
namespace openfl{
namespace media{
...
Float panning = __o_panning.Default(0);
            	HX_STACKFRAME(&_hx_pos_b69a1b3bd673fa32_21_new)
HXLINE(  23)		this->volume = vol;
HXLINE(  24)		this->pan = panning;
HXLINE(  25)		this->leftToLeft = (int)0;
HXLINE(  26)		this->leftToRight = (int)0;
HXLINE(  27)		this->rightToLeft = (int)0;
HXLINE(  28)		this->rightToRight = (int)0;
            	}
...
bool SoundTransform_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::media::SoundTransform SoundTransform_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_b69a1b3bd673fa32_35_clone)
HXDLIN(  35)		return  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,this->volume,this->pan);
            	}
