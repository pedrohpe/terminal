...
HX_DEFINE_STACK_FRAME(_hx_pos_93e4eccf60244a3a_22_new,"openfl.media.ID3Info","new",0xc3c5ad90,"openfl.media.ID3Info.new","openfl/media/ID3Info.hx",22,0xcebe7122)
namespace openfl{
namespace media{

void ID3Info_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_93e4eccf60244a3a_22_new)
            	}
