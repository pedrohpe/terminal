...
HX_DEFINE_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_42_new,"openfl.media.SoundChannel","new",0xfc94e2ae,"openfl.media.SoundChannel.new","openfl/media/SoundChannel.hx",42,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_74_stop,"openfl.media.SoundChannel","stop",0x090ae1f4,"openfl.media.SoundChannel.stop","openfl/media/SoundChannel.hx",74,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_86___dispose,"openfl.media.SoundChannel","__dispose",0x8d7f924d,"openfl.media.SoundChannel.__dispose","openfl/media/SoundChannel.hx",86,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_99___updateTransform,"openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",99,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_111_get_position,"openfl.media.SoundChannel","get_position",0x46d188a4,"openfl.media.SoundChannel.get_position","openfl/media/SoundChannel.hx",111,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_120_set_position,"openfl.media.SoundChannel","set_position",0x5bcaac18,"openfl.media.SoundChannel.set_position","openfl/media/SoundChannel.hx",120,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_132_get_soundTransform,"openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",132,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_137_set_soundTransform,"openfl.media.SoundChannel","set_soundTransform",0xa397b74c,"openfl.media.SoundChannel.set_soundTransform","openfl/media/SoundChannel.hx",137,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_178_source_onComplete,"openfl.media.SoundChannel","source_onComplete",0xb57ef7ea,"openfl.media.SoundChannel.source_onComplete","openfl/media/SoundChannel.hx",178,0xa4290000)
namespace openfl{
namespace media{

void SoundChannel_obj::__construct( ::lime::media::AudioSource source, ::openfl::media::SoundTransform soundTransform){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_42_new)
HXLINE(  44)		super::__construct(hx::ObjectPtr<OBJ_>(this));
HXLINE(  46)		this->leftPeak = (int)1;
HXLINE(  47)		this->rightPeak = (int)1;
HXLINE(  49)		if (hx::IsNotNull( soundTransform )) {
HXLINE(  51)			this->_hx___soundTransform = soundTransform;
            		}
            		else {
HXLINE(  55)			this->_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null());
            		}
HXLINE(  59)		if (hx::IsNotNull( source )) {
HXLINE(  61)			this->_hx___source = source;
HXLINE(  62)			this->_hx___source->onComplete->add(this->source_onComplete_dyn(),null(),null());
HXLINE(  63)			this->_hx___isValid = true;
HXLINE(  65)			this->_hx___source->play();
            		}
HXLINE(  69)		::openfl::media::SoundMixer_obj::_hx___registerSoundChannel(hx::ObjectPtr<OBJ_>(this));
            	}
...
void SoundChannel_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_74_stop)
HXLINE(  76)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE(  78)		if (!(this->_hx___isValid)) {
HXLINE(  78)			return;
            		}
HXLINE(  80)		this->_hx___source->stop();
HXLINE(  81)		this->_hx___dispose();
            	}
...
void SoundChannel_obj::_hx___dispose(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_86___dispose)
HXLINE(  88)		if (!(this->_hx___isValid)) {
HXLINE(  88)			return;
            		}
HXLINE(  90)		this->_hx___source->onComplete->remove(this->source_onComplete_dyn());
HXLINE(  91)		this->_hx___source->dispose();
HXLINE(  92)		this->_hx___isValid = false;
            	}
...
void SoundChannel_obj::_hx___updateTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_99___updateTransform)
HXDLIN(  99)		this->set_soundTransform(this->get_soundTransform());
            	}
...
Float SoundChannel_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_111_get_position)
HXLINE( 113)		if (!(this->_hx___isValid)) {
HXLINE( 113)			return (int)0;
            		}
HXLINE( 115)		int _hx_tmp = this->_hx___source->get_currentTime();
HXDLIN( 115)		return (_hx_tmp + this->_hx___source->offset);
            	}
...
Float SoundChannel_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_120_set_position)
HXLINE( 122)		if (!(this->_hx___isValid)) {
HXLINE( 122)			return (int)0;
            		}
HXLINE( 124)		 ::lime::media::AudioSource _hx_tmp = this->_hx___source;
HXDLIN( 124)		int _hx_tmp1 = ::Std_obj::_hx_int(value);
HXDLIN( 124)		_hx_tmp->set_currentTime((_hx_tmp1 - this->_hx___source->offset));
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_132_get_soundTransform)
HXDLIN( 132)		return this->_hx___soundTransform->clone();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_137_set_soundTransform)
HXLINE( 139)		if (hx::IsNotNull( value )) {
HXLINE( 141)			this->_hx___soundTransform->pan = value->pan;
HXLINE( 142)			this->_hx___soundTransform->volume = value->volume;
HXLINE( 144)			Float pan = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
HXLINE( 146)			if ((pan < (int)-1)) {
HXLINE( 146)				pan = (int)-1;
            			}
HXLINE( 147)			if ((pan > (int)1)) {
HXLINE( 147)				pan = (int)1;
            			}
HXLINE( 149)			Float volume = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 151)			if (this->_hx___isValid) {
HXLINE( 153)				this->_hx___source->set_gain(volume);
HXLINE( 155)				 ::lime::math::Vector4 position = this->_hx___source->get_position();
HXLINE( 156)				position->x = pan;
HXLINE( 157)				position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
HXLINE( 158)				this->_hx___source->set_position(position);
...
void SoundChannel_obj::source_onComplete(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_178_source_onComplete)
HXLINE( 180)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 182)		this->_hx___dispose();
HXLINE( 183)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("soundComplete",a8,30,e6,1c),null(),null()));
            	}
