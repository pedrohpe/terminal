...
HX_LOCAL_STACK_FRAME(_hx_pos_ce38ee0aefe74adb_20_fromString,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_","fromString",0xc71d5181,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_.fromString","openfl/display3D/Context3DTextureFormat.hx",20,0xa18085d1)
HX_LOCAL_STACK_FRAME(_hx_pos_ce38ee0aefe74adb_36_toString,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_","toString",0xc7ab9ed2,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_.toString","openfl/display3D/Context3DTextureFormat.hx",36,0xa18085d1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ce38ee0aefe74adb_13_boot,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_","boot",0x5fc0c758,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_.boot","openfl/display3D/Context3DTextureFormat.hx",13,0xa18085d1)
HX_LOCAL_STACK_FRAME(_hx_pos_ce38ee0aefe74adb_14_boot,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_","boot",0x5fc0c758,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_.boot","openfl/display3D/Context3DTextureFormat.hx",14,0xa18085d1)
HX_LOCAL_STACK_FRAME(_hx_pos_ce38ee0aefe74adb_15_boot,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_","boot",0x5fc0c758,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_.boot","openfl/display3D/Context3DTextureFormat.hx",15,0xa18085d1)
HX_LOCAL_STACK_FRAME(_hx_pos_ce38ee0aefe74adb_16_boot,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_","boot",0x5fc0c758,"openfl.display3D._Context3DTextureFormat.Context3DTextureFormat_Impl_.boot","openfl/display3D/Context3DTextureFormat.hx",16,0xa18085d1)
namespace openfl{
namespace display3D{
...
bool Context3DTextureFormat_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DTextureFormat_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_ce38ee0aefe74adb_20_fromString)
...
::String Context3DTextureFormat_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_ce38ee0aefe74adb_36_toString)
HXDLIN(  36)		switch((int)(value)){
            			case (int)0: {
HXLINE(  38)				return HX_("bgrPacked565",6f,69,33,84);
            			}
            			break;
            			case (int)1: {
HXLINE(  39)				return HX_("bgra",b4,74,15,41);
            			}
            			break;
            			case (int)2: {
HXLINE(  40)				return HX_("bgraPacked4444",4c,10,af,4f);
            			}
            			break;
            			case (int)3: {
HXLINE(  41)				return HX_("compressed",81,4c,da,67);
            			}
            			break;
            			case (int)4: {
HXLINE(  42)				return HX_("compressedAlpha",1d,d7,1f,4a);
            			}
            			break;
            			case (int)5: {
HXLINE(  43)				return HX_("rgbaHalfFloat",95,5b,55,9e);
            			}
            			break;
            			default:{
...
HXDLIN(  11)		BGR_PACKED = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ce38ee0aefe74adb_12_boot)
HXDLIN(  12)		BGRA = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ce38ee0aefe74adb_13_boot)
HXDLIN(  13)		BGRA_PACKED = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ce38ee0aefe74adb_14_boot)
HXDLIN(  14)		COMPRESSED = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ce38ee0aefe74adb_15_boot)
HXDLIN(  15)		COMPRESSED_ALPHA = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ce38ee0aefe74adb_16_boot)
HXDLIN(  16)		RGBA_HALF_FLOAT = (int)5;
            	}
}
