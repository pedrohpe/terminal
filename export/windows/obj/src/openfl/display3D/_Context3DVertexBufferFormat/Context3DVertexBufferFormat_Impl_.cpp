...
HX_LOCAL_STACK_FRAME(_hx_pos_512538a9b8c6e1ed_19_fromString,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","fromString",0x69b9a727,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.fromString","openfl/display3D/Context3DVertexBufferFormat.hx",19,0x4ab2835e)
HX_LOCAL_STACK_FRAME(_hx_pos_512538a9b8c6e1ed_34_toString,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","toString",0xa34b1ef8,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.toString","openfl/display3D/Context3DVertexBufferFormat.hx",34,0x4ab2835e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_512538a9b8c6e1ed_12_boot,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",12,0x4ab2835e)
HX_LOCAL_STACK_FRAME(_hx_pos_512538a9b8c6e1ed_13_boot,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",13,0x4ab2835e)
HX_LOCAL_STACK_FRAME(_hx_pos_512538a9b8c6e1ed_14_boot,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",14,0x4ab2835e)
...
bool Context3DVertexBufferFormat_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DVertexBufferFormat_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_19_fromString)
HXDLIN(  19)		::String _hx_switch_0 = value;
...
::String Context3DVertexBufferFormat_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_34_toString)
HXDLIN(  34)		switch((int)(value)){
            			case (int)0: {
HXLINE(  36)				return HX_("bytes4",69,55,6f,27);
            			}
            			break;
            			case (int)1: {
HXLINE(  37)				return HX_("float1",15,23,56,41);
            			}
            			break;
            			case (int)2: {
HXLINE(  38)				return HX_("float2",16,23,56,41);
            			}
            			break;
            			case (int)3: {
HXLINE(  39)				return HX_("float3",17,23,56,41);
            			}
            			break;
            			case (int)4: {
HXLINE(  40)				return HX_("float4",18,23,56,41);
            			}
            			break;
            			default:{
...
HXDLIN(  11)		BYTES_4 = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_12_boot)
HXDLIN(  12)		FLOAT_1 = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_13_boot)
HXDLIN(  13)		FLOAT_2 = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_14_boot)
HXDLIN(  14)		FLOAT_3 = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_15_boot)
HXDLIN(  15)		FLOAT_4 = (int)4;
            	}
}
