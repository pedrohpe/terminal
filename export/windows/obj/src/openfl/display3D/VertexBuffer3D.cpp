...
HXLINE(  41)		 ::openfl::display::OpenGLRenderer _hx_tmp = ( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) );
...
HXDLIN(  48)		::openfl::_internal::stage3D::opengl::GLVertexBuffer3D_obj::dispose(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ));
            	}
...
HXDLIN(  55)		::openfl::_internal::stage3D::opengl::GLVertexBuffer3D_obj::uploadFromByteArray(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),data,byteArrayOffset,startVertex,numVertices);
            	}
...
HXDLIN(  62)		::openfl::_internal::stage3D::opengl::GLVertexBuffer3D_obj::uploadFromTypedArray(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),data);
            	}
...
HXDLIN(  69)		::openfl::_internal::stage3D::opengl::GLVertexBuffer3D_obj::uploadFromVector(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),data,startVertex,numVertices);
            	}
