...
HX_LOCAL_STACK_FRAME(_hx_pos_02fecb2b926e493f_16_fromString,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_","fromString",0xbc8bc5e1,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_.fromString","openfl/display3D/Context3DBufferUsage.hx",16,0x57541062)
HX_LOCAL_STACK_FRAME(_hx_pos_02fecb2b926e493f_28_toString,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_","toString",0xe8f23b32,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_.toString","openfl/display3D/Context3DBufferUsage.hx",28,0x57541062)
HX_LOCAL_STACK_FRAME(_hx_pos_02fecb2b926e493f_11_boot,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_","boot",0x95a9b3b8,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_.boot","openfl/display3D/Context3DBufferUsage.hx",11,0x57541062)
HX_LOCAL_STACK_FRAME(_hx_pos_02fecb2b926e493f_12_boot,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_","boot",0x95a9b3b8,"openfl.display3D._Context3DBufferUsage.Context3DBufferUsage_Impl_.boot","openfl/display3D/Context3DBufferUsage.hx",12,0x57541062)
namespace openfl{
namespace display3D{
...
bool Context3DBufferUsage_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DBufferUsage_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_02fecb2b926e493f_16_fromString)
...
::String Context3DBufferUsage_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_02fecb2b926e493f_28_toString)
HXDLIN(  28)		switch((int)(value)){
            			case (int)0: {
HXLINE(  30)				return HX_("dynamicDraw",23,23,fe,67);
            			}
            			break;
            			case (int)1: {
HXLINE(  31)				return HX_("staticDraw",d2,23,1c,a4);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_02fecb2b926e493f_11_boot)
HXDLIN(  11)		DYNAMIC_DRAW = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_02fecb2b926e493f_12_boot)
HXDLIN(  12)		STATIC_DRAW = (int)1;
            	}
}
