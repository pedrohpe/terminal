...
HXLINE(  38)		::openfl::_internal::stage3D::opengl::GLTexture_obj::create(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ));
            	}
...
HXLINE(  45)		if (!(async)) {
HXLINE(  47)			::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadCompressedTextureFromByteArray(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),data,byteArrayOffset);
            		}
            		else {
...
HXLINE(  53)				::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadCompressedTextureFromByteArray(_gthis,( ( ::openfl::display::OpenGLRenderer)(_gthis->_hx___context->_hx___renderer) ),data,byteArrayOffset);
...
HXDLIN(  65)		::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadFromBitmapData(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),source,miplevel,generateMipmap);
            	}
...
HXDLIN(  72)		::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadFromByteArray(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),data,byteArrayOffset,miplevel);
            	}
...
HXDLIN(  79)		::openfl::_internal::stage3D::opengl::GLTexture_obj::uploadFromTypedArray(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),data,miplevel);
            	}
...
HXDLIN(  86)		::openfl::_internal::stage3D::opengl::GLTexture_obj::setSamplerState(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),state);
            	}
