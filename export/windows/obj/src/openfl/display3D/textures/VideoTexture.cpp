...
HX_DEFINE_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_29_new,"openfl.display3D.textures.VideoTexture","new",0x6f95260f,"openfl.display3D.textures.VideoTexture.new","openfl/display3D/textures/VideoTexture.hx",29,0x1fe25aa2)
HX_LOCAL_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_43_attachNetStream,"openfl.display3D.textures.VideoTexture","attachNetStream",0x7bd9e067,"openfl.display3D.textures.VideoTexture.attachNetStream","openfl/display3D/textures/VideoTexture.hx",43,0x1fe25aa2)
HX_LOCAL_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_72___getTexture,"openfl.display3D.textures.VideoTexture","__getTexture",0x7429c676,"openfl.display3D.textures.VideoTexture.__getTexture","openfl/display3D/textures/VideoTexture.hx",72,0x1fe25aa2)
HX_LOCAL_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_86___textureReady,"openfl.display3D.textures.VideoTexture","__textureReady",0x47bb8b59,"openfl.display3D.textures.VideoTexture.__textureReady","openfl/display3D/textures/VideoTexture.hx",86,0x1fe25aa2)
namespace openfl{
namespace display3D{
namespace textures{

void VideoTexture_obj::__construct( ::openfl::display3D::Context3D context){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_29_new)
HXLINE(  31)		super::__construct(context);
HXLINE(  33)		::openfl::_internal::stage3D::opengl::GLVideoTexture_obj::create(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ));
            	}
...
void VideoTexture_obj::attachNetStream( ::openfl::net::NetStream netStream){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_43_attachNetStream)
HXDLIN(  43)		this->_hx___netStream = netStream;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(VideoTexture_obj,attachNetStream,(void))
 ...
 ::lime::graphics::opengl::GLObject VideoTexture_obj::_hx___getTexture(){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_72___getTexture)
HXDLIN(  72)		return ::openfl::_internal::stage3D::opengl::GLVideoTexture_obj::getTexture(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ));
            	}


void VideoTexture_obj::_hx___textureReady(){
            	HX_GC_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_86___textureReady)
HXDLIN(  86)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("textureReady",88,4d,5a,df),null(),null()));
            	}
