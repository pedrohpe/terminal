...
HX_LOCAL_STACK_FRAME(_hx_pos_7ca6962f8d84f3d3_22_fromString,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_","fromString",0x85a5c581,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_.fromString","openfl/display3D/Context3DStencilAction.hx",22,0x92be5171)
HX_LOCAL_STACK_FRAME(_hx_pos_7ca6962f8d84f3d3_40_toString,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_","toString",0x776f12d2,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_.toString","openfl/display3D/Context3DStencilAction.hx",40,0x92be5171)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7ca6962f8d84f3d3_15_boot,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_","boot",0xa3ba3b58,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_.boot","openfl/display3D/Context3DStencilAction.hx",15,0x92be5171)
HX_LOCAL_STACK_FRAME(_hx_pos_7ca6962f8d84f3d3_16_boot,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_","boot",0xa3ba3b58,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_.boot","openfl/display3D/Context3DStencilAction.hx",16,0x92be5171)
HX_LOCAL_STACK_FRAME(_hx_pos_7ca6962f8d84f3d3_17_boot,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_","boot",0xa3ba3b58,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_.boot","openfl/display3D/Context3DStencilAction.hx",17,0x92be5171)
HX_LOCAL_STACK_FRAME(_hx_pos_7ca6962f8d84f3d3_18_boot,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_","boot",0xa3ba3b58,"openfl.display3D._Context3DStencilAction.Context3DStencilAction_Impl_.boot","openfl/display3D/Context3DStencilAction.hx",18,0x92be5171)
namespace openfl{
namespace display3D{
...
bool Context3DStencilAction_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DStencilAction_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_22_fromString)
...
::String Context3DStencilAction_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_40_toString)
HXDLIN(  40)		switch((int)(value)){
            			case (int)0: {
HXLINE(  42)				return HX_("decrementSaturate",22,cd,3b,f4);
            			}
            			break;
            			case (int)1: {
HXLINE(  43)				return HX_("decrementWrap",7d,61,2a,a2);
            			}
            			break;
            			case (int)2: {
HXLINE(  44)				return HX_("incrementSaturate",3e,59,b0,83);
            			}
            			break;
            			case (int)3: {
HXLINE(  45)				return HX_("incrementWrap",99,af,a7,4e);
            			}
            			break;
            			case (int)4: {
HXLINE(  46)				return HX_("invert",16,e7,d8,9f);
            			}
            			break;
            			case (int)5: {
HXLINE(  47)				return HX_("keep",85,d0,06,47);
            			}
            			break;
            			case (int)6: {
HXLINE(  48)				return HX_("set",a2,9b,57,00);
            			}
            			break;
            			case (int)7: {
HXLINE(  49)				return HX_("zero",28,0f,f1,50);
            			}
            			break;
            			default:{
...
HXDLIN(  11)		DECREMENT_SATURATE = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_12_boot)
HXDLIN(  12)		DECREMENT_WRAP = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_13_boot)
HXDLIN(  13)		INCREMENT_SATURATE = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_14_boot)
HXDLIN(  14)		INCREMENT_WRAP = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_15_boot)
HXDLIN(  15)		INVERT = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_16_boot)
HXDLIN(  16)		KEEP = (int)5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_17_boot)
HXDLIN(  17)		SET = (int)6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7ca6962f8d84f3d3_18_boot)
HXDLIN(  18)		ZERO = (int)7;
            	}
}
