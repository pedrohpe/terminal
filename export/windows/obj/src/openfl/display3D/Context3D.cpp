...
void Context3D_obj::__construct( ::openfl::display::Stage3D stage3D, ::openfl::display::DisplayObjectRenderer renderer){
...
HXLINE( 106)		this->_hx___renderer = renderer;
...
hx::ObjectPtr< Context3D_obj > Context3D_obj::__new( ::openfl::display::Stage3D stage3D, ::openfl::display::DisplayObjectRenderer renderer) {
	hx::ObjectPtr< Context3D_obj > __this = new Context3D_obj();
	__this->__construct(stage3D,renderer);
	return __this;
}

hx::ObjectPtr< Context3D_obj > Context3D_obj::__alloc(hx::Ctx *_hx_ctx, ::openfl::display::Stage3D stage3D, ::openfl::display::DisplayObjectRenderer renderer) {
...
static hx::StorageInfo Context3D_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::DisplayObjectRenderer*/ ,(int)offsetof(Context3D_obj,_hx___renderer),HX_HCSTRING("__renderer","\x63","\x38","\x14","\x56")},
