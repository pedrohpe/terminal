...
HX_DEFINE_STACK_FRAME(_hx_pos_2880df2f01d21cf0_155_new,"openfl.display3D.Uniform","new",0x27a38f2d,"openfl.display3D.Uniform.new","openfl/display3D/Program3D.hx",155,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_2880df2f01d21cf0_167_flush,"openfl.display3D.Uniform","flush",0x6c722ed1,"openfl.display3D.Uniform.flush","openfl/display3D/Program3D.hx",167,0x0a985b04)
namespace openfl{
namespace display3D{

void Uniform_obj::__construct( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_GC_STACKFRAME(&_hx_pos_2880df2f01d21cf0_155_new)
HXLINE( 157)		this->gl = gl;
HXLINE( 159)		this->isDirty = true;
HXLINE( 160)		 ::lime::utils::BytePointerData this1 =  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,null(),(int)0);
HXDLIN( 160)		this->regDataPointer = this1;
            	}
...
void Uniform_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_2880df2f01d21cf0_167_flush)
HXDLIN( 167)		::openfl::_internal::stage3D::opengl::GLProgram3D_obj::flushUniform(hx::ObjectPtr<OBJ_>(this),this->gl);
            	}
