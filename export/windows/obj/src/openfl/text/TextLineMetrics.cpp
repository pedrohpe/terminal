...
HX_DEFINE_STACK_FRAME(_hx_pos_769ce4a0cb4bebca_21_new,"openfl.text.TextLineMetrics","new",0x08194531,"openfl.text.TextLineMetrics.new","openfl/text/TextLineMetrics.hx",21,0x3c3b1fbf)
namespace openfl{
namespace text{
...
HXLINE(  26)		this->ascent = ascent;
HXLINE(  27)		this->descent = descent;
HXLINE(  28)		this->leading = leading;
            	}
