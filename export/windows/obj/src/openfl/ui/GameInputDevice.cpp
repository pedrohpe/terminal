...
HX_DEFINE_STACK_FRAME(_hx_pos_fafdee3291969395_15_new,"openfl.ui.GameInputDevice","new",0x66440344,"openfl.ui.GameInputDevice.new","openfl/ui/GameInputDevice.hx",15,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_71_getCachedSamples,"openfl.ui.GameInputDevice","getCachedSamples",0x0422a56d,"openfl.ui.GameInputDevice.getCachedSamples","openfl/ui/GameInputDevice.hx",71,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_76_getControlAt,"openfl.ui.GameInputDevice","getControlAt",0xc65be2d6,"openfl.ui.GameInputDevice.getControlAt","openfl/ui/GameInputDevice.hx",76,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_89_startCachingSamples,"openfl.ui.GameInputDevice","startCachingSamples",0xf3794db0,"openfl.ui.GameInputDevice.startCachingSamples","openfl/ui/GameInputDevice.hx",89,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_96_stopCachingSamples,"openfl.ui.GameInputDevice","stopCachingSamples",0xbbb05408,"openfl.ui.GameInputDevice.stopCachingSamples","openfl/ui/GameInputDevice.hx",96,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_112_get_numControls,"openfl.ui.GameInputDevice","get_numControls",0x2a978757,"openfl.ui.GameInputDevice.get_numControls","openfl/ui/GameInputDevice.hx",112,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_18_boot,"openfl.ui.GameInputDevice","boot",0x0d57d8ce,"openfl.ui.GameInputDevice.boot","openfl/ui/GameInputDevice.hx",18,0x744a6f4c)
namespace openfl{
namespace ui{

void GameInputDevice_obj::__construct(::String id,::String name){
            	HX_GC_STACKFRAME(&_hx_pos_fafdee3291969395_15_new)
HXLINE(  28)		this->_hx___controls = ::Array_obj< ::Dynamic>::__new();
HXLINE(  27)		this->_hx___button =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  26)		this->_hx___axis =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  45)		this->id = id;
HXLINE(  46)		this->name = name;
HXLINE(  48)		 ::openfl::ui::GameInputControl control;
HXLINE(  50)		{
HXLINE(  50)			int _g = (int)0;
HXDLIN(  50)			while((_g < (int)6)){
HXLINE(  50)				_g = (_g + (int)1);
HXDLIN(  50)				int i = (_g - (int)1);
HXLINE(  52)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("AXIS_",9e,28,6e,a7) + i),(int)-1,(int)1,null());
HXLINE(  53)				this->_hx___axis->set(i,control);
HXLINE(  54)				this->_hx___controls->push(control);
            			}
            		}
HXLINE(  58)		{
HXLINE(  58)			int _g1 = (int)0;
HXDLIN(  58)			while((_g1 < (int)15)){
HXLINE(  58)				_g1 = (_g1 + (int)1);
HXDLIN(  58)				int i1 = (_g1 - (int)1);
HXLINE(  60)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("BUTTON_",2d,26,49,4a) + i1),(int)0,(int)1,null());
HXLINE(  61)				this->_hx___button->set(i1,control);
HXLINE(  62)				this->_hx___controls->push(control);
            			}
            		}
            	}
...
bool append = __o_append.Default(false);
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_71_getCachedSamples)
...
HX_DEFINE_DYNAMIC_FUNC2(GameInputDevice_obj,getCachedSamples,return )
 ...
 ::openfl::ui::GameInputControl GameInputDevice_obj::getControlAt(int i){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_76_getControlAt)
HXLINE(  78)		bool _hx_tmp;
HXDLIN(  78)		if ((i >= (int)0)) {
HXLINE(  78)			_hx_tmp = (i < this->_hx___controls->length);
            		}
            		else {
HXLINE(  78)			_hx_tmp = false;
            		}
HXDLIN(  78)		if (_hx_tmp) {
HXLINE(  80)			return this->_hx___controls->__get(i).StaticCast<  ::openfl::ui::GameInputControl >();
            		}
...
void GameInputDevice_obj::startCachingSamples(int numSamples, ::openfl::_Vector::ObjectVector controls){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_89_startCachingSamples)
            	}
...
void GameInputDevice_obj::stopCachingSamples(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_96_stopCachingSamples)
            	}
...
int GameInputDevice_obj::get_numControls(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_112_get_numControls)
HXDLIN( 112)		return this->_hx___controls->length;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_18_boot)
HXDLIN(  18)		MAX_BUFFER_SIZE = (int)32000;
            	}
}
