...
HX_DEFINE_STACK_FRAME(_hx_pos_ea5bdb6538331ec9_22_new,"openfl.ui.GameInputControl","new",0xeccd6093,"openfl.ui.GameInputControl.new","openfl/ui/GameInputControl.hx",22,0xb3fe7f9d)
namespace openfl{
namespace ui{
...
Float value = __o_value.Default(0);
            	HX_STACKFRAME(&_hx_pos_ea5bdb6538331ec9_22_new)
HXLINE(  24)		super::__construct(null());
HXLINE(  26)		this->device = device;
HXLINE(  27)		this->id = id;
HXLINE(  28)		this->minValue = minValue;
HXLINE(  29)		this->maxValue = maxValue;
