...
::openfl::display::GraphicsDataType GraphicsDataType_obj::QUAD_PATH;

::openfl::display::GraphicsDataType GraphicsDataType_obj::SHADER;
...
static void GraphicsDataType_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(GraphicsDataType_obj::QUAD_PATH,"QUAD_PATH");
	HX_MARK_MEMBER_NAME(GraphicsDataType_obj::SHADER,"SHADER");
...
static void GraphicsDataType_obj_sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(GraphicsDataType_obj::QUAD_PATH,"QUAD_PATH");
	HX_VISIT_MEMBER_NAME(GraphicsDataType_obj::SHADER,"SHADER");
...
QUAD_PATH = hx::CreateEnum< GraphicsDataType_obj >(HX_HCSTRING("QUAD_PATH","\x5d","\x97","\x7d","\x63"),6,0);
SHADER = hx::CreateEnum< GraphicsDataType_obj >(HX_HCSTRING("SHADER","\x25","\x6b","\xa3","\xcf"),8,0);
...
TRIANGLE_PATH = hx::CreateEnum< GraphicsDataType_obj >(HX_HCSTRING("TRIANGLE_PATH","\xbc","\xe5","\x7d","\x7e"),7,0);
}
