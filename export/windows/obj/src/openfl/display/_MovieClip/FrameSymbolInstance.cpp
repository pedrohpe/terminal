...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_1043_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",1043,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_1043_new)
HXLINE(1045)		this->initFrame = initFrame;
HXLINE(1046)		this->initFrameObjectID = initFrameObjectID;
HXLINE(1047)		this->characterID = characterID;
HXLINE(1048)		this->depth = depth;
HXLINE(1049)		this->displayObject = displayObject;
HXLINE(1050)		this->clipDepth = clipDepth;
            	}
