...
HX_DEFINE_STACK_FRAME(_hx_pos_e7eaf41fa1350495_23_new,"openfl.display.GraphicsSolidFill","new",0x800a4bcb,"openfl.display.GraphicsSolidFill.new","openfl/display/GraphicsSolidFill.hx",23,0x9b142c07)
namespace openfl{
namespace display{
...
Float alpha = __o_alpha.Default(1);
            	HX_STACKFRAME(&_hx_pos_e7eaf41fa1350495_23_new)
HXLINE(  25)		this->alpha = alpha;
HXLINE(  26)		this->color = color;
HXLINE(  27)		this->_hx___graphicsDataType = ::openfl::display::GraphicsDataType_obj::SOLID_dyn();
HXLINE(  28)		this->_hx___graphicsFillType = ::openfl::display::GraphicsFillType_obj::SOLID_FILL_dyn();
            	}
