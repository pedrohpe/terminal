...
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_182_getBackgroundColor,"openfl.display.DefaultPreloader","getBackgroundColor",0xe99da5ce,"openfl.display.DefaultPreloader.getBackgroundColor","openfl/display/Preloader.hx",182,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_199_getHeight,"openfl.display.DefaultPreloader","getHeight",0xf2617bce,"openfl.display.DefaultPreloader.getHeight","openfl/display/Preloader.hx",199,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_216_getWidth,"openfl.display.DefaultPreloader","getWidth",0x7b1a7bff,"openfl.display.DefaultPreloader.getWidth","openfl/display/Preloader.hx",216,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_235_onInit,"openfl.display.DefaultPreloader","onInit",0x238e307e,"openfl.display.DefaultPreloader.onInit","openfl/display/Preloader.hx",235,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_240_onLoaded,"openfl.display.DefaultPreloader","onLoaded",0x88fcf4f3,"openfl.display.DefaultPreloader.onLoaded","openfl/display/Preloader.hx",240,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_249_onUpdate,"openfl.display.DefaultPreloader","onUpdate",0xb79332f7,"openfl.display.DefaultPreloader.onUpdate","openfl/display/Preloader.hx",249,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_277_this_onAddedToStage,"openfl.display.DefaultPreloader","this_onAddedToStage",0xa7de3014,"openfl.display.DefaultPreloader.this_onAddedToStage","openfl/display/Preloader.hx",277,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_290_this_onComplete,"openfl.display.DefaultPreloader","this_onComplete",0x228a21ea,"openfl.display.DefaultPreloader.this_onComplete","openfl/display/Preloader.hx",290,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_302_this_onEnterFrame,"openfl.display.DefaultPreloader","this_onEnterFrame",0x72c19366,"openfl.display.DefaultPreloader.this_onEnterFrame","openfl/display/Preloader.hx",302,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_a3b7e47404dab77a_320_this_onProgress,"openfl.display.DefaultPreloader","this_onProgress",0x28ed18de,"openfl.display.DefaultPreloader.this_onProgress","openfl/display/Preloader.hx",320,0xc399db74)
namespace openfl{
namespace display{
...
int DefaultPreloader_obj::getBackgroundColor(){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_182_getBackgroundColor)
HXLINE( 184)		 ::Dynamic config = ::openfl::Lib_obj::get_current()->stage->window->config;
HXLINE( 186)		bool _hx_tmp;
HXDLIN( 186)		if (::Reflect_obj::hasField(config,HX_("background",ee,93,1d,26))) {
HXLINE( 186)			_hx_tmp = hx::IsNotNull( config->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic) );
            		}
            		else {
HXLINE( 186)			_hx_tmp = false;
            		}
HXDLIN( 186)		if (_hx_tmp) {
HXLINE( 188)			return ( (int)(config->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic)) );
            		}
            		else {
...
Float DefaultPreloader_obj::getHeight(){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_199_getHeight)
HXLINE( 201)		 ::Dynamic height = ::openfl::Lib_obj::get_current()->stage->window->config->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic);
HXLINE( 203)		if (hx::IsGreater( height,(int)0 )) {
HXLINE( 205)			return height;
            		}
            		else {
HXLINE( 209)			return ::openfl::Lib_obj::get_current()->stage->stageHeight;
            		}
...
Float DefaultPreloader_obj::getWidth(){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_216_getWidth)
HXLINE( 218)		 ::Dynamic width = ::openfl::Lib_obj::get_current()->stage->window->config->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic);
HXLINE( 220)		if (hx::IsGreater( width,(int)0 )) {
HXLINE( 222)			return width;
            		}
            		else {
HXLINE( 226)			return ::openfl::Lib_obj::get_current()->stage->stageWidth;
            		}
...
void DefaultPreloader_obj::onInit(){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_235_onInit)
HXDLIN( 235)		this->addEventListener(HX_("enterFrame",f5,03,50,02),this->this_onEnterFrame_dyn(),null(),null(),null());
            	}
...
void DefaultPreloader_obj::onLoaded(){
            	HX_GC_STACKFRAME(&_hx_pos_a3b7e47404dab77a_240_onLoaded)
HXLINE( 242)		this->removeEventListener(HX_("enterFrame",f5,03,50,02),this->this_onEnterFrame_dyn(),null());
HXLINE( 244)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("unload",ff,a0,8c,65),null(),null()));
            	}
...
void DefaultPreloader_obj::onUpdate(int bytesLoaded,int bytesTotal){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_249_onUpdate)
HXLINE( 251)		Float percentLoaded = ((Float)0.0);
HXLINE( 253)		if ((bytesTotal > (int)0)) {
HXLINE( 255)			percentLoaded = ((Float)bytesLoaded / (Float)bytesTotal);
HXLINE( 257)			if ((percentLoaded > (int)1)) {
HXLINE( 259)				percentLoaded = (int)1;
            			}
            		}
HXLINE( 265)		this->progress->set_scaleX(percentLoaded);
            	}
...
void DefaultPreloader_obj::this_onAddedToStage( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_277_this_onAddedToStage)
HXLINE( 279)		this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->this_onAddedToStage_dyn(),null());
HXLINE( 281)		this->onInit();
HXLINE( 282)		int _hx_tmp = this->get_loaderInfo()->bytesLoaded;
HXDLIN( 282)		this->onUpdate(_hx_tmp,this->get_loaderInfo()->bytesTotal);
HXLINE( 284)		this->addEventListener(HX_("progress",ad,f7,2a,86),this->this_onProgress_dyn(),null(),null(),null());
HXLINE( 285)		this->addEventListener(HX_("complete",b9,00,c8,7f),this->this_onComplete_dyn(),null(),null(),null());
            	}
...
void DefaultPreloader_obj::this_onComplete( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_290_this_onComplete)
HXLINE( 292)		event->preventDefault();
HXLINE( 294)		this->removeEventListener(HX_("progress",ad,f7,2a,86),this->this_onProgress_dyn(),null());
HXLINE( 295)		this->removeEventListener(HX_("complete",b9,00,c8,7f),this->this_onComplete_dyn(),null());
HXLINE( 297)		this->onLoaded();
            	}
...
void DefaultPreloader_obj::this_onEnterFrame( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_302_this_onEnterFrame)
HXLINE( 304)		int elapsed = ::openfl::Lib_obj::getTimer();
HXDLIN( 304)		int elapsed1 = (elapsed - this->startAnimation);
HXLINE( 305)		int total = (this->endAnimation - this->startAnimation);
HXLINE( 307)		Float percent = ((Float)elapsed1 / (Float)total);
HXLINE( 309)		if ((percent < (int)0)) {
HXLINE( 309)			percent = (int)0;
            		}
HXLINE( 310)		if ((percent > (int)1)) {
HXLINE( 310)			percent = (int)1;
            		}
HXLINE( 312)		this->outline->set_alpha(percent);
HXLINE( 313)		this->progress->set_alpha(percent);
            	}
...
void DefaultPreloader_obj::this_onProgress( ::openfl::events::ProgressEvent event){
            	HX_STACKFRAME(&_hx_pos_a3b7e47404dab77a_320_this_onProgress)
HXDLIN( 320)		int _hx_tmp = ::Std_obj::_hx_int(event->bytesLoaded);
HXDLIN( 320)		this->onUpdate(_hx_tmp,::Std_obj::_hx_int(event->bytesTotal));
            	}
