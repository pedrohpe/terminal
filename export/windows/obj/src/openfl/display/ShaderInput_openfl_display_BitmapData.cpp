...
HX_DEFINE_STACK_FRAME(_hx_pos_e18280422777664c_33_new,"openfl.display.ShaderInput_openfl_display_BitmapData","new",0x3cac89f3,"openfl.display.ShaderInput_openfl_display_BitmapData.new","openfl/display/ShaderInput.hx",33,0xcc724ba5)
HX_LOCAL_STACK_FRAME(_hx_pos_e18280422777664c_46___updateGL,"openfl.display.ShaderInput_openfl_display_BitmapData","__updateGL",0xe64a7a5b,"openfl.display.ShaderInput_openfl_display_BitmapData.__updateGL","openfl/display/ShaderInput.hx",46,0xcc724ba5)
namespace openfl{
namespace display{

void ShaderInput_openfl_display_BitmapData_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e18280422777664c_33_new)
...
void ShaderInput_openfl_display_BitmapData_obj::_hx___updateGL( ::lime::_backend::native::NativeGLRenderContext gl,int id, ::openfl::display::BitmapData overrideInput, ::Dynamic overrideFilter, ::Dynamic overrideMipFilter, ::Dynamic overrideWrap){
            	HX_STACKFRAME(&_hx_pos_e18280422777664c_46___updateGL)
HXLINE(  48)		 ::openfl::display::BitmapData input;
...
HXLINE(  57)			 ::openfl::display::BitmapData bitmapData = input;
