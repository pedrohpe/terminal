...
HX_DEFINE_STACK_FRAME(_hx_pos_60eb5008390fcdf2_20_new,"openfl.display.GraphicsEndFill","new",0x1f8242bb,"openfl.display.GraphicsEndFill.new","openfl/display/GraphicsEndFill.hx",20,0x45937e97)
namespace openfl{
namespace display{

void GraphicsEndFill_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_60eb5008390fcdf2_20_new)
HXLINE(  22)		this->_hx___graphicsDataType = ::openfl::display::GraphicsDataType_obj::END_dyn();
HXLINE(  23)		this->_hx___graphicsFillType = ::openfl::display::GraphicsFillType_obj::END_FILL_dyn();
            	}
