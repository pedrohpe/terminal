...
void Shader_obj::__construct( ::openfl::utils::ByteArrayData code){
            	HX_GC_STACKFRAME(&_hx_pos_4b006e5218f2daf8_75_new)
...
HXLINE(  82)		this->_hx___data =  ::openfl::display::ShaderData_obj::__alloc( HX_CTX ,code);
            	}
...
HXLINE( 290)				if (hx::IsNotNull( input->input )) {
...
void Shader_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_4b006e5218f2daf8_308___init)
HXLINE( 310)		if (hx::IsNull( this->_hx___data )) {
HXLINE( 312)			this->_hx___data =  ::openfl::display::ShaderData_obj::__alloc( HX_CTX ,null());
            		}
...
HXLINE( 634)				if (hx::IsNotNull( input->input )) {
