...
HX_DEFINE_STACK_FRAME(_hx_pos_e4c1d0f133e7c9cd_30_new,"openfl.display.GraphicsGradientFill","new",0xc9ac905a,"openfl.display.GraphicsGradientFill.new","openfl/display/GraphicsGradientFill.hx",30,0x0dfeaf94)
namespace openfl{
namespace display{
...
Float focalPointRatio = __o_focalPointRatio.Default(0);
            	HX_STACKFRAME(&_hx_pos_e4c1d0f133e7c9cd_30_new)
HXLINE(  32)		if (hx::IsNull( type )) {
HXLINE(  34)			type = (int)0;
            		}
HXLINE(  38)		if (hx::IsNull( spreadMethod )) {
HXLINE(  40)			spreadMethod = (int)0;
            		}
HXLINE(  44)		if (hx::IsNull( interpolationMethod )) {
HXLINE(  46)			interpolationMethod = (int)1;
            		}
HXLINE(  50)		this->type = type;
HXLINE(  51)		this->colors = colors;
HXLINE(  52)		this->alphas = alphas;
HXLINE(  53)		this->ratios = ratios;
HXLINE(  54)		this->matrix = matrix;
HXLINE(  55)		this->spreadMethod = spreadMethod;
HXLINE(  56)		this->interpolationMethod = interpolationMethod;
HXLINE(  57)		this->focalPointRatio = focalPointRatio;
HXLINE(  58)		this->_hx___graphicsDataType = ::openfl::display::GraphicsDataType_obj::GRADIENT_dyn();
HXLINE(  59)		this->_hx___graphicsFillType = ::openfl::display::GraphicsFillType_obj::GRADIENT_FILL_dyn();
            	}
