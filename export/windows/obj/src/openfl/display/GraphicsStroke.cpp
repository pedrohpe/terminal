...
HX_DEFINE_STACK_FRAME(_hx_pos_55614d7317440053_26_new,"openfl.display.GraphicsStroke","new",0x5684f03f,"openfl.display.GraphicsStroke.new","openfl/display/GraphicsStroke.hx",26,0x5e4870cf)
namespace openfl{
namespace display{
...
Float miterLimit = __o_miterLimit.Default(3);
            	HX_STACKFRAME(&_hx_pos_55614d7317440053_26_new)
HXLINE(  28)		if (hx::IsNull( thickness )) {
HXLINE(  28)			thickness = ::Math_obj::NaN;
            		}
HXLINE(  30)		this->caps = caps;
HXLINE(  31)		this->fill = fill;
HXLINE(  32)		this->joints = joints;
HXLINE(  33)		this->miterLimit = miterLimit;
HXLINE(  34)		this->pixelHinting = pixelHinting;
HXLINE(  35)		this->scaleMode = scaleMode;
HXLINE(  36)		this->thickness = thickness;
HXLINE(  37)		this->_hx___graphicsDataType = ::openfl::display::GraphicsDataType_obj::STROKE_dyn();
            	}
