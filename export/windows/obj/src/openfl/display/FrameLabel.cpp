...
HX_DEFINE_STACK_FRAME(_hx_pos_4f7a9456505745c4_32_new,"openfl.display.FrameLabel","new",0x6d144ce3,"openfl.display.FrameLabel.new","openfl/display/FrameLabel.hx",32,0x7487bdab)
HX_LOCAL_STACK_FRAME(_hx_pos_4f7a9456505745c4_49_get_frame,"openfl.display.FrameLabel","get_frame",0x73ee1547,"openfl.display.FrameLabel.get_frame","openfl/display/FrameLabel.hx",49,0x7487bdab)
HX_LOCAL_STACK_FRAME(_hx_pos_4f7a9456505745c4_50_get_name,"openfl.display.FrameLabel","get_name",0xc5787671,"openfl.display.FrameLabel.get_name","openfl/display/FrameLabel.hx",50,0x7487bdab)
namespace openfl{
namespace display{

void FrameLabel_obj::__construct(::String name,int frame){
            	HX_STACKFRAME(&_hx_pos_4f7a9456505745c4_32_new)
HXLINE(  34)		super::__construct(null());
HXLINE(  36)		this->_hx___name = name;
HXLINE(  37)		this->_hx___frame = frame;
            	}
...
int FrameLabel_obj::get_frame(){
            	HX_STACKFRAME(&_hx_pos_4f7a9456505745c4_49_get_frame)
HXDLIN(  49)		return this->_hx___frame;
            	}
...
::String FrameLabel_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_4f7a9456505745c4_50_get_name)
HXDLIN(  50)		return this->_hx___name;
            	}
