...
HX_DEFINE_STACK_FRAME(_hx_pos_05e3536633e8ac7b_18_new,"openfl.display.JPEGEncoderOptions","new",0xdec807a6,"openfl.display.JPEGEncoderOptions.new","openfl/display/JPEGEncoderOptions.hx",18,0xc451ba48)
namespace openfl{
namespace display{

void JPEGEncoderOptions_obj::__construct(hx::Null< int >  __o_quality){
int quality = __o_quality.Default(80);
            	HX_STACKFRAME(&_hx_pos_05e3536633e8ac7b_18_new)
HXDLIN(  18)		this->quality = quality;
            	}
