...
HX_DEFINE_STACK_FRAME(_hx_pos_a26b1fc0d062e909_24_new,"openfl.display.GraphicsTrianglePath","new",0x6d94fd54,"openfl.display.GraphicsTrianglePath.new","openfl/display/GraphicsTrianglePath.hx",24,0x122c7fda)
namespace openfl{
namespace display{
...
void GraphicsTrianglePath_obj::__construct( ::openfl::_Vector::FloatVector vertices, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector uvtData, ::Dynamic __o_culling){
 ::Dynamic culling = __o_culling.Default(1);
            	HX_STACKFRAME(&_hx_pos_a26b1fc0d062e909_24_new)
HXLINE(  26)		this->vertices = vertices;
HXLINE(  27)		this->indices = indices;
HXLINE(  28)		this->uvtData = uvtData;
HXLINE(  29)		this->culling = culling;
HXLINE(  30)		this->_hx___graphicsDataType = ::openfl::display::GraphicsDataType_obj::TRIANGLE_PATH_dyn();
            	}
