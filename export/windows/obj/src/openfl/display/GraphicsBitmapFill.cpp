...
HX_DEFINE_STACK_FRAME(_hx_pos_1aabeebe910bc323_27_new,"openfl.display.GraphicsBitmapFill","new",0x9f0e8e19,"openfl.display.GraphicsBitmapFill.new","openfl/display/GraphicsBitmapFill.hx",27,0x222b0335)
namespace openfl{
namespace display{
...
bool smooth = __o_smooth.Default(false);
            	HX_STACKFRAME(&_hx_pos_1aabeebe910bc323_27_new)
HXLINE(  29)		this->bitmapData = bitmapData;
HXLINE(  30)		this->matrix = matrix;
HXLINE(  31)		this->repeat = repeat;
HXLINE(  32)		this->smooth = smooth;
HXLINE(  34)		this->_hx___graphicsDataType = ::openfl::display::GraphicsDataType_obj::BITMAP_dyn();
HXLINE(  35)		this->_hx___graphicsFillType = ::openfl::display::GraphicsFillType_obj::BITMAP_FILL_dyn();
            	}
