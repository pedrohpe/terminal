...
HX_DEFINE_STACK_FRAME(_hx_pos_246a905352da221e_70_new,"__ASSET__flixel_sounds_beep_ogg","new",0x0aaf31f8,"__ASSET__flixel_sounds_beep_ogg.new","lime/_macros/AssetsMacro.hx",70,0xfe246b98)
...
void __ASSET__flixel_sounds_beep_ogg_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_246a905352da221e_70_new)
HXLINE(  75)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_sounds_beep_ogg_obj::resourceName);
