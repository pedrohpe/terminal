...
HXLINE(  51)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf >());
HXLINE(  52)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_monsterrat_ttf >());
HXLINE(  56)		 ::Dynamic data;
HXDLIN(  56)		 ::Dynamic manifest;
HXDLIN(  56)		 ::lime::utils::AssetLibrary library;
HXLINE(  58)		{
HXLINE(  58)			::String v = (rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  58)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  61)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  62)		if (hx::IsNotNull( library )) {
HXLINE(  62)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  63)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
