...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_f78860393d87b7db_39_new)
...
HXLINE(  40)		__this->super::__construct();
HXLINE(  41)		( ( ::lime::text::unifill::InvalidCodeUnitSequence)(__this) )->index = index;
            	}
