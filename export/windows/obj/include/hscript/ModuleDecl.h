...
class ModuleDecl_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("hscript.ModuleDecl","\x71","\xf3","\x29","\x25"); }
		::String __ToString() const { return HX_HCSTRING("ModuleDecl.","\x18","\x70","\xf2","\x04") + _hx_tag; }
