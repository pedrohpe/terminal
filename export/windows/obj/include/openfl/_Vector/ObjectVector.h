...
class HXCPP_CLASS_ATTRIBUTES ObjectVector_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::Dynamic length, ::Dynamic fixed,::cpp::VirtualArray array,hx::Null< bool >  __o_forceCopy);
		...
		static hx::ObjectPtr< ObjectVector_obj > __new( ::Dynamic length, ::Dynamic fixed,::cpp::VirtualArray array,hx::Null< bool >  __o_forceCopy);
		static hx::ObjectPtr< ObjectVector_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic length, ::Dynamic fixed,::cpp::VirtualArray array,hx::Null< bool >  __o_forceCopy);
