...
HX_DECLARE_STACK_FRAME(_hx_pos_8cde7e51a6201b8b_17_new)
...
HXLINE(  19)		( ( ::openfl::net::URLRequestHeader)(__this) )->name = name;
HXLINE(  20)		( ( ::openfl::net::URLRequestHeader)(__this) )->value = value;
            	}
