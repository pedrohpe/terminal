...
HX_DECLARE_STACK_FRAME(_hx_pos_769ce4a0cb4bebca_21_new)
...
{
            	HX_STACKFRAME(&_hx_pos_769ce4a0cb4bebca_21_new)
HXLINE(  23)		( ( ::openfl::text::TextLineMetrics)(__this) )->x = x;
HXLINE(  24)		( ( ::openfl::text::TextLineMetrics)(__this) )->width = width;
HXLINE(  25)		( ( ::openfl::text::TextLineMetrics)(__this) )->height = height;
HXLINE(  26)		( ( ::openfl::text::TextLineMetrics)(__this) )->ascent = ascent;
HXLINE(  27)		( ( ::openfl::text::TextLineMetrics)(__this) )->descent = descent;
HXLINE(  28)		( ( ::openfl::text::TextLineMetrics)(__this) )->leading = leading;
            	}
