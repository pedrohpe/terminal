...
class HXCPP_CLASS_ATTRIBUTES ShaderInput_openfl_display_BitmapData_obj : public hx::Object
{
	...
	public:
		...
		void _hx___updateGL( ::lime::_backend::native::NativeGLRenderContext gl,int id, ::openfl::display::BitmapData overrideInput, ::Dynamic overrideFilter, ::Dynamic overrideMipFilter, ::Dynamic overrideWrap);
