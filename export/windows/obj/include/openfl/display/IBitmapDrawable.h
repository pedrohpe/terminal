...
class HXCPP_CLASS_ATTRIBUTES IBitmapDrawable_obj {
	public:
		...
		static inline void _hx___renderCairo( ::Dynamic _hx_, ::openfl::display::CairoRenderer renderer) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___renderCairo)(renderer);
		}
		...
		static inline void _hx___renderCairoMask( ::Dynamic _hx_, ::openfl::display::CairoRenderer renderer) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___renderCairoMask)(renderer);
		}
		...
		static inline void _hx___renderCanvas( ::Dynamic _hx_, ::openfl::display::CanvasRenderer renderer) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___renderCanvas)(renderer);
		}
		...
		static inline void _hx___renderCanvasMask( ::Dynamic _hx_, ::openfl::display::CanvasRenderer renderer) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___renderCanvasMask)(renderer);
		}
		...
		static inline void _hx___renderDOM( ::Dynamic _hx_, ::openfl::display::DOMRenderer renderer) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___renderDOM)(renderer);
		}
		...
		static inline void _hx___renderGL( ::Dynamic _hx_, ::openfl::display::OpenGLRenderer renderer) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___renderGL)(renderer);
		}
		...
		static inline void _hx___renderGLMask( ::Dynamic _hx_, ::openfl::display::OpenGLRenderer renderer) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___renderGLMask)(renderer);
		}
		...
		static inline void _hx___update( ::Dynamic _hx_,bool transformOnly,bool updateChildren) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::IBitmapDrawable_obj *>(_hx_.mPtr->_hx_getInterface(0xc1c6fbe4)))->_hx__hx___update)(transformOnly,updateChildren);
		}
