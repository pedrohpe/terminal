...
class HXCPP_CLASS_ATTRIBUTES Stage3D_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		void _hx___createContext( ::openfl::display::Stage stage, ::openfl::display::DisplayObjectRenderer renderer);
		...
		void _hx___renderCairo( ::openfl::display::Stage stage, ::openfl::display::CairoRenderer renderer);
		::Dynamic _hx___renderCairo_dyn();

		void _hx___renderCanvas( ::openfl::display::Stage stage, ::openfl::display::CanvasRenderer renderer);
		::Dynamic _hx___renderCanvas_dyn();

		void _hx___renderDOM( ::openfl::display::Stage stage, ::openfl::display::DOMRenderer renderer);
		::Dynamic _hx___renderDOM_dyn();

		void _hx___renderGL( ::openfl::display::Stage stage, ::openfl::display::OpenGLRenderer renderer);
