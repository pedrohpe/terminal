...
class GraphicsDataType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		static ::openfl::display::GraphicsDataType QUAD_PATH;
		static inline ::openfl::display::GraphicsDataType QUAD_PATH_dyn() { return QUAD_PATH; }
		static ::openfl::display::GraphicsDataType SHADER;
		static inline ::openfl::display::GraphicsDataType SHADER_dyn() { return SHADER; }
