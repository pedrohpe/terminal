...
class HXCPP_CLASS_ATTRIBUTES GLVertexBuffer3D_obj : public hx::Object
{
	...
	public:
		...
		static void create( ::openfl::display3D::VertexBuffer3D vertexBuffer, ::openfl::display::OpenGLRenderer renderer, ::Dynamic bufferUsage);
		static ::Dynamic create_dyn();

		static void dispose( ::openfl::display3D::VertexBuffer3D vertexBuffer, ::openfl::display::OpenGLRenderer renderer);
		static ::Dynamic dispose_dyn();

		static void uploadFromByteArray( ::openfl::display3D::VertexBuffer3D vertexBuffer, ::openfl::display::OpenGLRenderer renderer, ::openfl::utils::ByteArrayData data,int byteArrayOffset,int startVertex,int numVertices);
		static ::Dynamic uploadFromByteArray_dyn();

		static void uploadFromTypedArray( ::openfl::display3D::VertexBuffer3D vertexBuffer, ::openfl::display::OpenGLRenderer renderer, ::lime::utils::ArrayBufferView data);
		static ::Dynamic uploadFromTypedArray_dyn();

		static void uploadFromVector( ::openfl::display3D::VertexBuffer3D vertexBuffer, ::openfl::display::OpenGLRenderer renderer, ::openfl::_Vector::FloatVector data,int startVertex,int numVertices);
