...
class HXCPP_CLASS_ATTRIBUTES GLCubeTexture_obj : public hx::Object
{
	...
	public:
		...
		static void create( ::openfl::display3D::textures::CubeTexture cubeTexture, ::openfl::display::OpenGLRenderer renderer);
		static ::Dynamic create_dyn();

		static void uploadCompressedTextureFromByteArray( ::openfl::display3D::textures::CubeTexture cubeTexture, ::openfl::display::OpenGLRenderer renderer, ::openfl::utils::ByteArrayData data,int byteArrayOffset);
		static ::Dynamic uploadCompressedTextureFromByteArray_dyn();

		static void uploadFromBitmapData( ::openfl::display3D::textures::CubeTexture cubeTexture, ::openfl::display::OpenGLRenderer renderer, ::openfl::display::BitmapData source,int side,hx::Null< int >  miplevel,hx::Null< bool >  generateMipmap);
		static ::Dynamic uploadFromBitmapData_dyn();

		static void uploadFromByteArray( ::openfl::display3D::textures::CubeTexture cubeTexture, ::openfl::display::OpenGLRenderer renderer, ::openfl::utils::ByteArrayData data,int byteArrayOffset,int side,int miplevel);
		static ::Dynamic uploadFromByteArray_dyn();

		static void uploadFromTypedArray( ::openfl::display3D::textures::CubeTexture cubeTexture, ::openfl::display::OpenGLRenderer renderer, ::lime::utils::ArrayBufferView data,int side,int miplevel);
		static ::Dynamic uploadFromTypedArray_dyn();

		static void setSamplerState( ::openfl::display3D::textures::CubeTexture cubeTexture, ::openfl::display::OpenGLRenderer renderer, ::openfl::_internal::stage3D::SamplerState state);
