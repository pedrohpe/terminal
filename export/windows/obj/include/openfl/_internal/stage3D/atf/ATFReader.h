...
#define INCLUDED_openfl__internal_stage3D_atf_ATFReader
...
HX_DECLARE_CLASS4(openfl,_internal,stage3D,atf,ATFReader)
...
class HXCPP_CLASS_ATTRIBUTES ATFReader_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x687242c6 };

		void __construct( ::openfl::utils::ByteArrayData data,int byteArrayOffset);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="openfl._internal.stage3D.atf.ATFReader")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.stage3D.atf.ATFReader"); }
...
#endif /* INCLUDED_openfl__internal_stage3D_atf_ATFReader */ 
