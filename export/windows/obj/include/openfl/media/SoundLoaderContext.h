...
HX_DECLARE_STACK_FRAME(_hx_pos_baeaab40d0a56ac0_17_new)
...
HXLINE(  19)		( ( ::openfl::media::SoundLoaderContext)(__this) )->bufferTime = bufferTime;
HXLINE(  20)		( ( ::openfl::media::SoundLoaderContext)(__this) )->checkPolicyFile = checkPolicyFile;
            	}
