...
HX_DECLARE_STACK_FRAME(_hx_pos_b69a1b3bd673fa32_21_new)
...
HXLINE(  23)		( ( ::openfl::media::SoundTransform)(__this) )->volume = vol;
HXLINE(  24)		( ( ::openfl::media::SoundTransform)(__this) )->pan = panning;
HXLINE(  25)		( ( ::openfl::media::SoundTransform)(__this) )->leftToLeft = (int)0;
HXLINE(  26)		( ( ::openfl::media::SoundTransform)(__this) )->leftToRight = (int)0;
HXLINE(  27)		( ( ::openfl::media::SoundTransform)(__this) )->rightToLeft = (int)0;
HXLINE(  28)		( ( ::openfl::media::SoundTransform)(__this) )->rightToRight = (int)0;
            	}
