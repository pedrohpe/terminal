...
class HXCPP_CLASS_ATTRIBUTES Tooltip_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Tooltip_obj > __new() {
		...
		::String __ToString() const { return HX_HCSTRING("Tooltip","\xe3","\xd4","\xdd","\x37"); }
		...
		static void add( ::openfl::display::Sprite element,::String text);
